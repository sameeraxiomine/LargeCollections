...
import com.axiomine.largecollections.turboutil.KryoKIntegerMap;
...
public class KryoKIntegerMapSample {
    ...
    public static void main(String[] args) {
        ...
        createKryoKIntegerMapOveridePathAndNameWhileDSer(System.getProperty("java.io.tmpdir"),"KVMAP",50,1000);
    }
    ...
    public static void workOnKVMap(KryoKIntegerMap<Integer> map){
        try {
            for (int i = 0; i < 10; i++) {
                int r = map.put(i, i);
            }
            ...
            map = (KryoKIntegerMap<Integer>) FileSerDeUtils.deserializeFromFile(serFile);
    ...
    public static void createKryoKIntegerMap(){
        KryoKIntegerMap<Integer> map = new KryoKIntegerMap<Integer>();
        printMapCharacteristics(map);
        workOnKVMap(map);
    }

    public static void createKryoKIntegerMap(String dbName){
        KryoKIntegerMap<Integer> map = new KryoKIntegerMap<Integer>(dbName);
        printMapCharacteristics(map);
        workOnKVMap(map);
    }

    public static void createKryoKIntegerMap(String dbPath,String dbName){
        KryoKIntegerMap<Integer> map = new KryoKIntegerMap<Integer>(dbPath,dbName);
        printMapCharacteristics(map);
        workOnKVMap(map);
    }

    public static void createKryoKIntegerMap(String dbPath,String dbName,int cacheSize){
        KryoKIntegerMap<Integer> map = new KryoKIntegerMap<Integer>(dbPath,dbName,cacheSize);
        printMapCharacteristics(map);
        workOnKVMap(map);
    }

    public static void createKryoKIntegerMap(String dbPath,String dbName,int cacheSize,int bloomfilterSize){
        KryoKIntegerMap<Integer> map = new KryoKIntegerMap<Integer>(dbPath,dbName,cacheSize,bloomfilterSize);
        printMapCharacteristics(map);
        workOnKVMap(map);
    }

    public static void createKryoKIntegerMapOveridePathAndNameWhileDSer(String dbPath,String dbName,int cacheSize,int bloomfilterSize){
