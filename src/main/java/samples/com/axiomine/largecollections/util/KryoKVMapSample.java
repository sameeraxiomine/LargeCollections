...
public class KryoKVMapSample {
    ...
    public static void main(String[] args) {
        ...
        createKryoKVMapOveridePathAndNameWhileDSer(System.getProperty("java.io.tmpdir"),"KVMAP",50,1000);
    }
    ...
    public static void createKryoKVMap(){
        KryoKVMap<Integer,Integer> map = new KryoKVMap<Integer,Integer>();
        printMapCharacteristics(map);
        workOnKVMap(map);
    }

    public static void createKryoKVMap(String dbName){
        KryoKVMap<Integer,Integer> map = new KryoKVMap<Integer,Integer>(dbName);
        printMapCharacteristics(map);
        workOnKVMap(map);
    }

    public static void createKryoKVMap(String dbPath,String dbName){
        KryoKVMap<Integer,Integer> map = new KryoKVMap<Integer,Integer>(dbPath,dbName);
        printMapCharacteristics(map);
        workOnKVMap(map);
    }

    public static void createKryoKVMap(String dbPath,String dbName,int cacheSize){
        KryoKVMap<Integer,Integer> map = new KryoKVMap<Integer,Integer>(dbPath,dbName,cacheSize);
        printMapCharacteristics(map);
        workOnKVMap(map);
    }

    public static void createKryoKVMap(String dbPath,String dbName,int cacheSize,int bloomfilterSize){
        KryoKVMap<Integer,Integer> map = new KryoKVMap<Integer,Integer>(dbPath,dbName,cacheSize,bloomfilterSize);
        printMapCharacteristics(map);
        workOnKVMap(map);
    }

    public static void createKryoKVMapOveridePathAndNameWhileDSer(String dbPath,String dbName,int cacheSize,int bloomfilterSize){
