...
public class TurboListSample {
    ...
    public static void createTurboList(){        
        TurboList<Integer> lst = new TurboList<Integer>(TSERIALIZER,TDESERIALIZER);
        printListCharacteristics(lst);
        workOnTurboList(lst);
    }

    public static void createTurboList(String dbName){
        TurboList<Integer> lst = new TurboList<Integer>(dbName,TSERIALIZER,TDESERIALIZER);
        printListCharacteristics(lst);
        workOnTurboList(lst);
    }

    public static void createTurboList(String dbPath,String dbName){
        TurboList<Integer> lst = new TurboList<Integer>(dbPath,dbName,TSERIALIZER,TDESERIALIZER);
        printListCharacteristics(lst);
        workOnTurboList(lst);
    }

    public static void createTurboList(String dbPath,String dbName,int cacheSize){
        TurboList<Integer> lst = new TurboList<Integer>(dbPath,dbName,cacheSize,TSERIALIZER,TDESERIALIZER);
        printListCharacteristics(lst);
        workOnTurboList(lst);
    }

    public static void createTurboList(String dbPath,String dbName,int cacheSize,int bloomfilterSize){
        TurboList<Integer> lst = new TurboList<Integer>(dbPath,dbName,cacheSize,bloomfilterSize,TSERIALIZER,TDESERIALIZER);
        printListCharacteristics(lst);
        workOnTurboList(lst);
    }
