...
public class KryoKVMapSample {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("-----");
        createKryoKVMap("c:/tmp","KVMAP2");
        System.out.println("-----");
        createKryoKVMap("c:/tmp","KVMAP3",50);
        System.out.println("-----");
        createKryoKVMap("c:/tmp","KVMAP4",50,1000);
        System.out.println("-----");
        createKryoKVMapOveridePathAndNameWhileDSer("c:/tmp","KVMAP",50,1000);
    }
