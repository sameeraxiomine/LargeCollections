...
public class IntegerLongMap extends LargeCollection implements   Map<Integer,Long>, Serializable{
    ...
    public IntegerLongMap() {
        super();
    }
    
    public IntegerLongMap(String dbName) {
        super(dbName);
    }
    
    public IntegerLongMap(String dbPath, String dbName) {
        super(dbPath, dbName);
    }
    
    public IntegerLongMap(String dbPath, String dbName, int cacheSize) {
    ...
    public void putAll(Map<? extends Integer, ? extends Long> m) {
        try {
            ...
            int counter = 0;
            for (Map.Entry<? extends Integer, ? extends Long> e : m
                    .entrySet()) {
    ...
    @Override
    public Set<java.util.Map.Entry<Integer, Long>> entrySet() {
        return new MapEntrySet<Integer, Long>(this, this.keyDeSerFunc,
                this.valDeSerFunc);
    }
