...
public class KLongMap<K> extends LargeCollection implements   Map<K,Long>, Serializable{
    ...
    public KLongMap(String dbName) {
        super(dbName);
    }
    
    public KLongMap(String dbPath, String dbName) {
        super(dbPath, dbName);
    }
    
    public KLongMap(String dbPath, String dbName, int cacheSize) {
    ...
    private void readObject(java.io.ObjectInputStream in) throws IOException,
        ...
        valSerFunc       = new KryoSerDe.KryoSerFunction<Long>();
        keyDeSerFunc     = new KryoSerDe.KryoDeSerFunction<K>();
        valDeSerFunc     = new KryoSerDe.KryoDeSerFunction<Long>();
        this.deserialize(in);
    }
