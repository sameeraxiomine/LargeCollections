...
public class GeneratorPrimitivePrimitive {
    ...
    public static void main(String[] args) throws Exception{
        ...
        }
        {
            ...
            String program = FileUtils.readFileToString(new File(root.getAbsolutePath()+"/src/main/resources/JavaLangBasedMapTemplate.java"));
