...
public class StringDoubleMap extends LargeCollection implements   Map<String,Double>, Serializable{
    ...
    public StringDoubleMap(String dbName) {
        super(dbName);
    }
    
    public StringDoubleMap(String dbPath, String dbName) {
        super(dbPath, dbName);
    }
    
    public StringDoubleMap(String dbPath, String dbName, int cacheSize) {
    ...
    public void putAll(Map<? extends String, ? extends Double> m) {
        try {
            ...
            int counter = 0;
            for (Map.Entry<? extends String, ? extends Double> e : m
                    .entrySet()) {
    ...
    public Set<java.util.Map.Entry<String, Double>> entrySet() {
        return new MapEntrySet<String, Double>(this, this.keyDeSerFunc,
                this.valDeSerFunc);
    }
