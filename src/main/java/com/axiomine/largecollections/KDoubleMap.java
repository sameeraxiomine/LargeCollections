...
public class KDoubleMap<K> extends LargeCollection implements   Map<K,Double>, Serializable{
    ...
    public KDoubleMap(String dbName) {
        super(dbName);
    }
    
    public KDoubleMap(String dbPath, String dbName) {
        super(dbPath, dbName);
    }
    
    public KDoubleMap(String dbPath, String dbName, int cacheSize) {
    ...
    public void putAll(Map<? extends K, ? extends Double> m) {
        try {
            ...
            int counter = 0;
            for (Map.Entry<? extends K, ? extends Double> e : m
                    .entrySet()) {
    ...
    public Set<java.util.Map.Entry<K, Double>> entrySet() {
        return new MapEntrySet<K, Double>(this, this.keyDeSerFunc,
                this.valDeSerFunc);
    }
    ...
    private void readObject(java.io.ObjectInputStream in) throws IOException,
        ...
        valSerFunc       = new KryoSerDe.KryoSerFunction<Double>();
        keyDeSerFunc     = new KryoSerDe.KryoDeSerFunction<K>();
        valDeSerFunc     = new KryoSerDe.KryoDeSerFunction<Double>();
        this.deserialize(in);
    }
