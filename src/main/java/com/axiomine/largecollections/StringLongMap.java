...
public class StringLongMap extends LargeCollection implements   Map<String,Long>, Serializable{
    ...
    public StringLongMap(String dbName) {
        super(dbName);
    }
    
    public StringLongMap(String dbPath, String dbName) {
        super(dbPath, dbName);
    }
    
    public StringLongMap(String dbPath, String dbName, int cacheSize) {
    ...
    public void putAll(Map<? extends String, ? extends Long> m) {
        try {
            ...
            int counter = 0;
            for (Map.Entry<? extends String, ? extends Long> e : m
                    .entrySet()) {
    ...
    public Set<java.util.Map.Entry<String, Long>> entrySet() {
        return new MapEntrySet<String, Long>(this, this.keyDeSerFunc,
                this.valDeSerFunc);
    }
