...
public class GeneratorPrimitiveList {
    ...
    public static void main(String[] args) throws Exception{
        ...
        }
        {
            ...
            String program = FileUtils.readFileToString(new File(root.getAbsolutePath()+"/src/main/resources/PrimitiveListTemplate.java"));
