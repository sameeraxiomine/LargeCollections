...
public class LongLongMap extends LargeCollection implements   Map<Long,Long>, Serializable{
    ...
    public LongLongMap(String dbName) {
        super(dbName);
    }
    
    public LongLongMap(String dbPath, String dbName) {
        super(dbPath, dbName);
    }
    
    public LongLongMap(String dbPath, String dbName, int cacheSize) {
    ...
    public void putAll(Map<? extends Long, ? extends Long> m) {
        try {
            ...
            int counter = 0;
            for (Map.Entry<? extends Long, ? extends Long> e : m
                    .entrySet()) {
    ...
    public Set<java.util.Map.Entry<Long, Long>> entrySet() {
        return new MapEntrySet<Long, Long>(this, this.keyDeSerFunc,
                this.valDeSerFunc);
    }
