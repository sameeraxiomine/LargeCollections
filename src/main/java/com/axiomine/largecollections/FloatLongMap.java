...
public class FloatLongMap extends LargeCollection implements   Map<Float,Long>, Serializable{
    ...
    public FloatLongMap(String dbName) {
        super(dbName);
    }
    
    public FloatLongMap(String dbPath, String dbName) {
        super(dbPath, dbName);
    }
    
    public FloatLongMap(String dbPath, String dbName, int cacheSize) {
    ...
    public void optimize() {
        try {
            ...
            for (Entry<Float, Long> entry : this.entrySet()) {
    ...
    public void putAll(Map<? extends Float, ? extends Long> m) {
        try {
            ...
            int counter = 0;
            for (Map.Entry<? extends Float, ? extends Long> e : m
                    .entrySet()) {
    ...
    @Override
    public Set<java.util.Map.Entry<Float, Long>> entrySet() {
        return new MapEntrySet<Float, Long>(this, this.keyDeSerFunc,
                this.valDeSerFunc);
    }
