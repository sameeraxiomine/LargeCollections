...
public class DoubleIntWritableMap extends LargeCollection implements   Map<Double,IntWritable>, Serializable{
    ...
    public DoubleIntWritableMap() {
        super();
    }
    
    public DoubleIntWritableMap(String dbName) {
        super(dbName);
    }
    
    public DoubleIntWritableMap(String dbPath, String dbName) {
        super(dbPath, dbName);
    }
    
    public DoubleIntWritableMap(String dbPath, String dbName, int cacheSize) {
    ...
    public void optimize() {
        try {
            ...
            for (Entry<Double, IntWritable> entry : this.entrySet()) {
    ...
    @Override
    public IntWritable put(Double key, IntWritable value) {
        if (key == null)
            return null;
    ...
    @Override
    public void putAll(Map<? extends Double, ? extends IntWritable> m) {
        try {
            WriteBatch batch = db.createWriteBatch();
            int counter = 0;
            for (Map.Entry<? extends Double, ? extends IntWritable> e : m
                    .entrySet()) {
    ...
    @Override
    public Set<java.util.Map.Entry<Double, IntWritable>> entrySet() {
        return new MapEntrySet<Double, IntWritable>(this, this.keyDeSerFunc,
                this.valDeSerFunc);
    }
