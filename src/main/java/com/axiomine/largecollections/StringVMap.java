...
public class StringVMap<V> extends LargeCollection implements   Map<String,V>, Serializable{
    ...
    public StringVMap(String dbName) {
        super(dbName);
    }
    
    public StringVMap(String dbPath, String dbName) {
        super(dbPath, dbName);
    }
    
    public StringVMap(String dbPath, String dbName, int cacheSize) {
    ...
    public Set<java.util.Map.Entry<String, V>> entrySet() {
        return new MapEntrySet<String, V>(this, this.keyDeSerFunc,
                this.valDeSerFunc);
    }
