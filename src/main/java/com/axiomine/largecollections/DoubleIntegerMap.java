...
public class DoubleIntegerMap extends LargeCollection implements   Map<Double,Integer>, Serializable{
    ...
    public DoubleIntegerMap() {
        super();
    }
    
    public DoubleIntegerMap(String dbName) {
        super(dbName);
    }
    
    public DoubleIntegerMap(String dbPath, String dbName) {
        super(dbPath, dbName);
    }
    
    public DoubleIntegerMap(String dbPath, String dbName, int cacheSize) {
    ...
    public void optimize() {
        try {
            ...
            for (Entry<Double, Integer> entry : this.entrySet()) {
    ...
    public void putAll(Map<? extends Double, ? extends Integer> m) {
        try {
            ...
            int counter = 0;
            for (Map.Entry<? extends Double, ? extends Integer> e : m
                    .entrySet()) {
    ...
    public Set<java.util.Map.Entry<Double, Integer>> entrySet() {
        return new MapEntrySet<Double, Integer>(this, this.keyDeSerFunc,
                this.valDeSerFunc);
    }
