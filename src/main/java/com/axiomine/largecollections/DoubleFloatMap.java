...
public class DoubleFloatMap extends LargeCollection implements   Map<Double,Float>, Serializable{
    ...
    public DoubleFloatMap() {
        super();
    }
    
    public DoubleFloatMap(String dbName) {
        super(dbName);
    }
    
    public DoubleFloatMap(String dbPath, String dbName) {
        super(dbPath, dbName);
    }
    
    public DoubleFloatMap(String dbPath, String dbName, int cacheSize) {
    ...
    public void optimize() {
        try {
            ...
            for (Entry<Double, Float> entry : this.entrySet()) {
    ...
    public void putAll(Map<? extends Double, ? extends Float> m) {
        try {
            ...
            int counter = 0;
            for (Map.Entry<? extends Double, ? extends Float> e : m
                    .entrySet()) {
    ...
    @Override
    public Set<java.util.Map.Entry<Double, Float>> entrySet() {
        return new MapEntrySet<Double, Float>(this, this.keyDeSerFunc,
                this.valDeSerFunc);
    }
