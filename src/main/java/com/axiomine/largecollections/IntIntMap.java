...
public class IntIntMap extends LargeCollection implements
        Map<Integer, Integer>, Serializable {
    ...
    public IntIntMap(String dbName) {
        super(dbName);
    }
    
    public IntIntMap(String dbPath, String dbName) {
        super(dbPath, dbName);
    }
    
    public IntIntMap(String dbPath, String dbName, int cacheSize) {
