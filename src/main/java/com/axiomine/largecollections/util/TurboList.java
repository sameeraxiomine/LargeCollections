...
public class TurboList<T> extends LargeCollection implements List<T>, Serializable {
    public static final long               serialVersionUID = 2l;
    private TurboSerializer<T> tSerFunc       =  null;
    private TurboDeSerializer<T> tDeSerFunc       = null;
    
    
    public TurboList(TurboSerializer<T> tSerializer,TurboDeSerializer<T> tDeSerializer) {
        super();
        this.tSerFunc = tSerializer;
        this.tDeSerFunc = tDeSerializer;
    }
    
    public TurboList(String dbName,TurboSerializer<T> tSerializer,TurboDeSerializer<T> tDeSerializer) {
        super(dbName);
        this.tSerFunc = tSerializer;
        this.tDeSerFunc = tDeSerializer;
    }
    
    public TurboList(String dbPath,String dbName,
    ...
    public TurboList(String dbPath,String dbName,int cacheSize,
            TurboSerializer<T> tSerializer,TurboDeSerializer<T> tDeSerializer) {
    ...
    public TurboList(String dbPath,String dbName,int cacheSize,int bloomFilterSize, 
                     TurboSerializer<T> tSerializer,TurboDeSerializer<T> tDeSerializer) {
