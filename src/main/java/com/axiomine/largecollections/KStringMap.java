...
public class KStringMap<K> extends LargeCollection implements   Map<K,String>, Serializable{
    ...
    public KStringMap(String dbName) {
        super(dbName);
    }
    
    public KStringMap(String dbPath, String dbName) {
        super(dbPath, dbName);
    }
    
    public KStringMap(String dbPath, String dbName, int cacheSize) {
    ...
    private void readObject(java.io.ObjectInputStream in) throws IOException,
        ...
        valSerFunc       = new KryoSerDe.KryoSerFunction<String>();
        keyDeSerFunc     = new KryoSerDe.KryoDeSerFunction<K>();
        valDeSerFunc     = new KryoSerDe.KryoDeSerFunction<String>();
        this.deserialize(in);
    }
