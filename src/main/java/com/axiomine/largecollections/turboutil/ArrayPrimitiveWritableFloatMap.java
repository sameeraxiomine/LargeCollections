...
public class ArrayPrimitiveWritableFloatMap extends LargeCollection implements   Map<ArrayPrimitiveWritable,Float>, Serializable{
    ...
    public ArrayPrimitiveWritableFloatMap() {
        super();
    }
    
    public ArrayPrimitiveWritableFloatMap(String dbName) {
        super(dbName);
    }
    
    public ArrayPrimitiveWritableFloatMap(String dbPath, String dbName) {
        super(dbPath, dbName);
    }
    
    public ArrayPrimitiveWritableFloatMap(String dbPath, String dbName, int cacheSize) {
    ...
    public void optimize() {
        try {
            ...
            for (Entry<ArrayPrimitiveWritable, Float> entry : this.entrySet()) {
    ...
    @Override
    public Float put(ArrayPrimitiveWritable key, Float value) {
        if (key == null)
            return null;
    ...
    @Override
    public void putAll(Map<? extends ArrayPrimitiveWritable, ? extends Float> m) {
        try {
            WriteBatch batch = db.createWriteBatch();
            int counter = 0;
            for (Map.Entry<? extends ArrayPrimitiveWritable, ? extends Float> e : m
                    .entrySet()) {
    ...
    @Override
    public Set<java.util.Map.Entry<ArrayPrimitiveWritable, Float>> entrySet() {
        return new MapEntrySet<ArrayPrimitiveWritable, Float>(this, this.keyDeSerFunc,
                this.valDeSerFunc);
    }
