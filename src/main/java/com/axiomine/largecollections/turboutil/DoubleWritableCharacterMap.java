...
public class DoubleWritableCharacterMap extends LargeCollection implements   Map<DoubleWritable,Character>, Serializable{
    ...
    public DoubleWritableCharacterMap() {
        super();
    }
    
    public DoubleWritableCharacterMap(String dbName) {
        super(dbName);
    }
    
    public DoubleWritableCharacterMap(String dbPath, String dbName) {
        super(dbPath, dbName);
    }
    
    public DoubleWritableCharacterMap(String dbPath, String dbName, int cacheSize) {
    ...
    public void optimize() {
        try {
            ...
            for (Entry<DoubleWritable, Character> entry : this.entrySet()) {
    ...
    @Override
    public Character put(DoubleWritable key, Character value) {
        if (key == null)
            return null;
    ...
    @Override
    public void putAll(Map<? extends DoubleWritable, ? extends Character> m) {
        try {
            WriteBatch batch = db.createWriteBatch();
            int counter = 0;
            for (Map.Entry<? extends DoubleWritable, ? extends Character> e : m
                    .entrySet()) {
    ...
    @Override
    public Set<java.util.Map.Entry<DoubleWritable, Character>> entrySet() {
        return new MapEntrySet<DoubleWritable, Character>(this, this.keyDeSerFunc,
                this.valDeSerFunc);
    }
