...
public class BytesArrayVMap<V> extends LargeCollection implements   Map<byte[],V>, Serializable{
    ...
    public BytesArrayVMap() {
        super();
    }
    
    public BytesArrayVMap(String dbName) {
        super(dbName);
    }
    
    public BytesArrayVMap(String dbPath, String dbName) {
        super(dbPath, dbName);
    }
    
    public BytesArrayVMap(String dbPath, String dbName, int cacheSize) {
