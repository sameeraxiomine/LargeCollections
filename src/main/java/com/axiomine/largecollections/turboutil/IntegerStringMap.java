...
public class IntegerStringMap extends LargeCollection implements   Map<Integer,String>, Serializable{
    ...
    public IntegerStringMap() {
        super();
    }
    
    public IntegerStringMap(String dbName) {
        super(dbName);
    }
    
    public IntegerStringMap(String dbPath, String dbName) {
        super(dbPath, dbName);
    }
    
    public IntegerStringMap(String dbPath, String dbName, int cacheSize) {
    ...
    public void putAll(Map<? extends Integer, ? extends String> m) {
        try {
            ...
            int counter = 0;
            for (Map.Entry<? extends Integer, ? extends String> e : m
                    .entrySet()) {
    ...
    public Set<java.util.Map.Entry<Integer, String>> entrySet() {
        return new MapEntrySet<Integer, String>(this, this.keyDeSerFunc,
                this.valDeSerFunc);
    }
