...
public class MapWritableShortWritableMap extends LargeCollection implements   Map<MapWritable,ShortWritable>, Serializable{
    ...
    public MapWritableShortWritableMap() {
        super();
    }
    
    public MapWritableShortWritableMap(String dbName) {
        super(dbName);
    }
    
    public MapWritableShortWritableMap(String dbPath, String dbName) {
        super(dbPath, dbName);
    }
    
    public MapWritableShortWritableMap(String dbPath, String dbName, int cacheSize) {
    ...
    public void optimize() {
        try {
            ...
            for (Entry<MapWritable, ShortWritable> entry : this.entrySet()) {
    ...
    @Override
    public ShortWritable put(MapWritable key, ShortWritable value) {
        if (key == null)
            return null;
    ...
    @Override
    public void putAll(Map<? extends MapWritable, ? extends ShortWritable> m) {
        try {
            WriteBatch batch = db.createWriteBatch();
            int counter = 0;
            for (Map.Entry<? extends MapWritable, ? extends ShortWritable> e : m
                    .entrySet()) {
    ...
    @Override
    public Set<java.util.Map.Entry<MapWritable, ShortWritable>> entrySet() {
        return new MapEntrySet<MapWritable, ShortWritable>(this, this.keyDeSerFunc,
                this.valDeSerFunc);
    }
