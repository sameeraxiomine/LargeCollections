...
public class KryoKIntegerMap<K> extends LargeCollection implements   Map<K,Integer>, Serializable{
    ...
    public KryoKIntegerMap() {
        super();
    }
    
    public KryoKIntegerMap(String dbName) {
        super(dbName);
    }
    
    public KryoKIntegerMap(String dbPath, String dbName) {
        super(dbPath, dbName);
    }
    
    public KryoKIntegerMap(String dbPath, String dbName, int cacheSize) {
    ...
    public void putAll(Map<? extends K, ? extends Integer> m) {
        try {
            ...
            int counter = 0;
            for (Map.Entry<? extends K, ? extends Integer> e : m
                    .entrySet()) {
    ...
    public Set<java.util.Map.Entry<K, Integer>> entrySet() {
        return new MapEntrySet<K, Integer>(this, this.keyDeSerFunc,
                this.valDeSerFunc);
    }
