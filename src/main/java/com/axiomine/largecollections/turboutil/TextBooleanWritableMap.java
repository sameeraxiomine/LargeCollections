...
public class TextBooleanWritableMap extends LargeCollection implements   Map<Text,BooleanWritable>, Serializable{
    ...
    public TextBooleanWritableMap() {
        super();
    }
    
    public TextBooleanWritableMap(String dbName) {
        super(dbName);
    }
    
    public TextBooleanWritableMap(String dbPath, String dbName) {
        super(dbPath, dbName);
    }
    
    public TextBooleanWritableMap(String dbPath, String dbName, int cacheSize) {
    ...
    public void optimize() {
        try {
            ...
            for (Entry<Text, BooleanWritable> entry : this.entrySet()) {
    ...
    @Override
    public BooleanWritable put(Text key, BooleanWritable value) {
        if (key == null)
            return null;
    ...
    @Override
    public void putAll(Map<? extends Text, ? extends BooleanWritable> m) {
        try {
            WriteBatch batch = db.createWriteBatch();
            int counter = 0;
            for (Map.Entry<? extends Text, ? extends BooleanWritable> e : m
                    .entrySet()) {
    ...
    @Override
    public Set<java.util.Map.Entry<Text, BooleanWritable>> entrySet() {
        return new MapEntrySet<Text, BooleanWritable>(this, this.keyDeSerFunc,
                this.valDeSerFunc);
    }
