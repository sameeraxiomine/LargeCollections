...
public class ShortWritableLongMap extends LargeCollection implements   Map<ShortWritable,Long>, Serializable{
    ...
    public ShortWritableLongMap() {
        super();
    }
    
    public ShortWritableLongMap(String dbName) {
        super(dbName);
    }
    
    public ShortWritableLongMap(String dbPath, String dbName) {
        super(dbPath, dbName);
    }
    
    public ShortWritableLongMap(String dbPath, String dbName, int cacheSize) {
    ...
    public void optimize() {
        try {
            ...
            for (Entry<ShortWritable, Long> entry : this.entrySet()) {
    ...
    @Override
    public Long put(ShortWritable key, Long value) {
        if (key == null)
            return null;
    ...
    @Override
    public void putAll(Map<? extends ShortWritable, ? extends Long> m) {
        try {
            WriteBatch batch = db.createWriteBatch();
            int counter = 0;
            for (Map.Entry<? extends ShortWritable, ? extends Long> e : m
                    .entrySet()) {
    ...
    @Override
    public Set<java.util.Map.Entry<ShortWritable, Long>> entrySet() {
        return new MapEntrySet<ShortWritable, Long>(this, this.keyDeSerFunc,
                this.valDeSerFunc);
    }
