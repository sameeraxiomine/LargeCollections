...
public class ByteByteWritableMap extends LargeCollection implements   Map<Byte,ByteWritable>, Serializable{
    ...
    public ByteByteWritableMap() {
        super();
    }
    
    public ByteByteWritableMap(String dbName) {
        super(dbName);
    }
    
    public ByteByteWritableMap(String dbPath, String dbName) {
        super(dbPath, dbName);
    }
    
    public ByteByteWritableMap(String dbPath, String dbName, int cacheSize) {
