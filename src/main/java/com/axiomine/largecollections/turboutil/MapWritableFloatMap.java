...
public class MapWritableFloatMap extends LargeCollection implements   Map<MapWritable,Float>, Serializable{
    ...
    public MapWritableFloatMap() {
        super();
    }
    
    public MapWritableFloatMap(String dbName) {
        super(dbName);
    }
    
    public MapWritableFloatMap(String dbPath, String dbName) {
        super(dbPath, dbName);
    }
    
    public MapWritableFloatMap(String dbPath, String dbName, int cacheSize) {
    ...
    public void optimize() {
        try {
            ...
            for (Entry<MapWritable, Float> entry : this.entrySet()) {
    ...
    @Override
    public Float put(MapWritable key, Float value) {
        if (key == null)
            return null;
    ...
    @Override
    public void putAll(Map<? extends MapWritable, ? extends Float> m) {
        try {
            WriteBatch batch = db.createWriteBatch();
            int counter = 0;
            for (Map.Entry<? extends MapWritable, ? extends Float> e : m
                    .entrySet()) {
    ...
    @Override
    public Set<java.util.Map.Entry<MapWritable, Float>> entrySet() {
        return new MapEntrySet<MapWritable, Float>(this, this.keyDeSerFunc,
                this.valDeSerFunc);
    }
