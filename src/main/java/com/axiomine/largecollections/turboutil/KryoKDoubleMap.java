...
public class KryoKDoubleMap<K> extends LargeCollection implements   Map<K,Double>, Serializable{
    ...
    public KryoKDoubleMap() {
        super();
    }
    
    public KryoKDoubleMap(String dbName) {
        super(dbName);
    }
    
    public KryoKDoubleMap(String dbPath, String dbName) {
        super(dbPath, dbName);
    }
    
    public KryoKDoubleMap(String dbPath, String dbName, int cacheSize) {
