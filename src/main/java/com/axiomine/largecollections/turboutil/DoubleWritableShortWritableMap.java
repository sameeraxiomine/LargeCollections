...
public class DoubleWritableShortWritableMap extends LargeCollection implements   Map<DoubleWritable,ShortWritable>, Serializable{
    ...
    public DoubleWritableShortWritableMap() {
        super();
    }
    
    public DoubleWritableShortWritableMap(String dbName) {
        super(dbName);
    }
    
    public DoubleWritableShortWritableMap(String dbPath, String dbName) {
        super(dbPath, dbName);
    }
    
    public DoubleWritableShortWritableMap(String dbPath, String dbName, int cacheSize) {
    ...
    public void optimize() {
        try {
            ...
            for (Entry<DoubleWritable, ShortWritable> entry : this.entrySet()) {
    ...
    @Override
    public ShortWritable put(DoubleWritable key, ShortWritable value) {
        if (key == null)
            return null;
    ...
    @Override
    public void putAll(Map<? extends DoubleWritable, ? extends ShortWritable> m) {
        try {
            WriteBatch batch = db.createWriteBatch();
            int counter = 0;
            for (Map.Entry<? extends DoubleWritable, ? extends ShortWritable> e : m
                    .entrySet()) {
    ...
    @Override
    public Set<java.util.Map.Entry<DoubleWritable, ShortWritable>> entrySet() {
        return new MapEntrySet<DoubleWritable, ShortWritable>(this, this.keyDeSerFunc,
                this.valDeSerFunc);
    }
