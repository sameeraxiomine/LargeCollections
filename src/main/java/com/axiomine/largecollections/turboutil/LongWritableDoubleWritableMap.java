...
public class LongWritableDoubleWritableMap extends LargeCollection implements   Map<LongWritable,DoubleWritable>, Serializable{
    ...
    public LongWritableDoubleWritableMap() {
        super();
    }
    
    public LongWritableDoubleWritableMap(String dbName) {
        super(dbName);
    }
    
    public LongWritableDoubleWritableMap(String dbPath, String dbName) {
        super(dbPath, dbName);
    }
    
    public LongWritableDoubleWritableMap(String dbPath, String dbName, int cacheSize) {
    ...
    public void optimize() {
        try {
            ...
            for (Entry<LongWritable, DoubleWritable> entry : this.entrySet()) {
    ...
    @Override
    public DoubleWritable put(LongWritable key, DoubleWritable value) {
        if (key == null)
            return null;
    ...
    @Override
    public void putAll(Map<? extends LongWritable, ? extends DoubleWritable> m) {
        try {
            WriteBatch batch = db.createWriteBatch();
            int counter = 0;
            for (Map.Entry<? extends LongWritable, ? extends DoubleWritable> e : m
                    .entrySet()) {
    ...
    @Override
    public Set<java.util.Map.Entry<LongWritable, DoubleWritable>> entrySet() {
        return new MapEntrySet<LongWritable, DoubleWritable>(this, this.keyDeSerFunc,
                this.valDeSerFunc);
    }
