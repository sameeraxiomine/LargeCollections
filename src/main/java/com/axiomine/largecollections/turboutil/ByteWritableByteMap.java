...
public class ByteWritableByteMap extends LargeCollection implements   Map<ByteWritable,Byte>, Serializable{
    ...
    public ByteWritableByteMap() {
        super();
    }
    
    public ByteWritableByteMap(String dbName) {
        super(dbName);
    }
    
    public ByteWritableByteMap(String dbPath, String dbName) {
        super(dbPath, dbName);
    }
    
    public ByteWritableByteMap(String dbPath, String dbName, int cacheSize) {
