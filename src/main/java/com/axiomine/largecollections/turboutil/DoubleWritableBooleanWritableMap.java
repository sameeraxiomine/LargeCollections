...
public class DoubleWritableBooleanWritableMap extends LargeCollection implements   Map<DoubleWritable,BooleanWritable>, Serializable{
    ...
    public DoubleWritableBooleanWritableMap(String dbName) {
        super(dbName);
    }
    
    public DoubleWritableBooleanWritableMap(String dbPath, String dbName) {
        super(dbPath, dbName);
    }
    
    public DoubleWritableBooleanWritableMap(String dbPath, String dbName, int cacheSize) {
    ...
    public void optimize() {
        try {
            ...
            for (Entry<DoubleWritable, BooleanWritable> entry : this.entrySet()) {
    ...
    @Override
    public BooleanWritable put(DoubleWritable key, BooleanWritable value) {
        if (key == null)
            return null;
    ...
    @Override
    public void putAll(Map<? extends DoubleWritable, ? extends BooleanWritable> m) {
        try {
            WriteBatch batch = db.createWriteBatch();
            int counter = 0;
            for (Map.Entry<? extends DoubleWritable, ? extends BooleanWritable> e : m
                    .entrySet()) {
    ...
    @Override
    public Set<java.util.Map.Entry<DoubleWritable, BooleanWritable>> entrySet() {
        return new MapEntrySet<DoubleWritable, BooleanWritable>(this, this.keyDeSerFunc,
                this.valDeSerFunc);
    }
