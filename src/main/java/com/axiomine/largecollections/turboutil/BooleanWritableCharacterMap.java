...
public class BooleanWritableCharacterMap extends LargeCollection implements   Map<BooleanWritable,Character>, Serializable{
    ...
    public BooleanWritableCharacterMap() {
        super();
    }
    
    public BooleanWritableCharacterMap(String dbName) {
        super(dbName);
    }
    
    public BooleanWritableCharacterMap(String dbPath, String dbName) {
        super(dbPath, dbName);
    }
    
    public BooleanWritableCharacterMap(String dbPath, String dbName, int cacheSize) {
    ...
    public void optimize() {
        try {
            ...
            for (Entry<BooleanWritable, Character> entry : this.entrySet()) {
    ...
    @Override
    public Character put(BooleanWritable key, Character value) {
        if (key == null)
            return null;
    ...
    @Override
    public void putAll(Map<? extends BooleanWritable, ? extends Character> m) {
        try {
            WriteBatch batch = db.createWriteBatch();
            int counter = 0;
            for (Map.Entry<? extends BooleanWritable, ? extends Character> e : m
                    .entrySet()) {
    ...
    @Override
    public Set<java.util.Map.Entry<BooleanWritable, Character>> entrySet() {
        return new MapEntrySet<BooleanWritable, Character>(this, this.keyDeSerFunc,
                this.valDeSerFunc);
    }
