...
public class StringBytesWritableMap extends LargeCollection implements   Map<String,BytesWritable>, Serializable{
    ...
    public StringBytesWritableMap(String dbName) {
        super(dbName);
    }
    
    public StringBytesWritableMap(String dbPath, String dbName) {
        super(dbPath, dbName);
    }
    
    public StringBytesWritableMap(String dbPath, String dbName, int cacheSize) {
    ...
    public void optimize() {
        try {
            ...
            for (Entry<String, BytesWritable> entry : this.entrySet()) {
    ...
    @Override
    public BytesWritable put(String key, BytesWritable value) {
        if (key == null)
            return null;
    ...
    @Override
    public void putAll(Map<? extends String, ? extends BytesWritable> m) {
        try {
            WriteBatch batch = db.createWriteBatch();
            int counter = 0;
            for (Map.Entry<? extends String, ? extends BytesWritable> e : m
                    .entrySet()) {
    ...
    @Override
    public Set<java.util.Map.Entry<String, BytesWritable>> entrySet() {
        return new MapEntrySet<String, BytesWritable>(this, this.keyDeSerFunc,
                this.valDeSerFunc);
    }
