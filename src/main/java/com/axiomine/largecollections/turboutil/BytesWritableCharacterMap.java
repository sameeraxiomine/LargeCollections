...
public class BytesWritableCharacterMap extends LargeCollection implements   Map<BytesWritable,Character>, Serializable{
    ...
    public BytesWritableCharacterMap() {
        super();
    }
    
    public BytesWritableCharacterMap(String dbName) {
        super(dbName);
    }
    
    public BytesWritableCharacterMap(String dbPath, String dbName) {
        super(dbPath, dbName);
    }
    
    public BytesWritableCharacterMap(String dbPath, String dbName, int cacheSize) {
    ...
    @Override
    public Character put(BytesWritable key, Character value) {
        if (key == null)
            return null;
    ...
    @Override
    public void putAll(Map<? extends BytesWritable, ? extends Character> m) {
        try {
            WriteBatch batch = db.createWriteBatch();
            int counter = 0;
            for (Map.Entry<? extends BytesWritable, ? extends Character> e : m
                    .entrySet()) {
    ...
    @Override
    public Set<java.util.Map.Entry<BytesWritable, Character>> entrySet() {
        return new MapEntrySet<BytesWritable, Character>(this, this.keyDeSerFunc,
                this.valDeSerFunc);
    }
