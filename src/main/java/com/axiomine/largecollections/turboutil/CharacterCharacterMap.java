...
public class CharacterCharacterMap extends LargeCollection implements   Map<Character,Character>, Serializable{
    ...
    public CharacterCharacterMap() {
        super();
    }
    
    public CharacterCharacterMap(String dbName) {
        super(dbName);
    }
    
    public CharacterCharacterMap(String dbPath, String dbName) {
        super(dbPath, dbName);
    }
    
    public CharacterCharacterMap(String dbPath, String dbName, int cacheSize) {
    ...
    public void optimize() {
        try {
            ...
            for (Entry<Character, Character> entry : this.entrySet()) {
    ...
    public void putAll(Map<? extends Character, ? extends Character> m) {
        try {
            ...
            int counter = 0;
            for (Map.Entry<? extends Character, ? extends Character> e : m
                    .entrySet()) {
    ...
    @Override
    public Set<java.util.Map.Entry<Character, Character>> entrySet() {
        return new MapEntrySet<Character, Character>(this, this.keyDeSerFunc,
                this.valDeSerFunc);
    }
