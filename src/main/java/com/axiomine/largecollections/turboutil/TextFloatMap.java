...
public class TextFloatMap extends LargeCollection implements   Map<Text,Float>, Serializable{
    ...
    public TextFloatMap(String dbName) {
        super(dbName);
    }
    
    public TextFloatMap(String dbPath, String dbName) {
        super(dbPath, dbName);
    }
    
    public TextFloatMap(String dbPath, String dbName, int cacheSize) {
    ...
    @Override
    public Float put(Text key, Float value) {
        if (key == null)
            return null;
    ...
    @Override
    public void putAll(Map<? extends Text, ? extends Float> m) {
        try {
            WriteBatch batch = db.createWriteBatch();
            int counter = 0;
            for (Map.Entry<? extends Text, ? extends Float> e : m
                    .entrySet()) {
    ...
    @Override
    public Set<java.util.Map.Entry<Text, Float>> entrySet() {
        return new MapEntrySet<Text, Float>(this, this.keyDeSerFunc,
                this.valDeSerFunc);
    }
