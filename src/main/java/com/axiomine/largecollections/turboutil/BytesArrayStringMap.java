...
public class BytesArrayStringMap extends LargeCollection implements   Map<byte[],String>, Serializable{
    ...
    public BytesArrayStringMap() {
        super();
    }
    
    public BytesArrayStringMap(String dbName) {
        super(dbName);
    }
    
    public BytesArrayStringMap(String dbPath, String dbName) {
        super(dbPath, dbName);
    }
    
    public BytesArrayStringMap(String dbPath, String dbName, int cacheSize) {
