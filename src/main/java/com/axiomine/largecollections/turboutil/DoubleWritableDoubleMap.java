...
public class DoubleWritableDoubleMap extends LargeCollection implements   Map<DoubleWritable,Double>, Serializable{
    ...
    public DoubleWritableDoubleMap(String dbName) {
        super(dbName);
    }
    
    public DoubleWritableDoubleMap(String dbPath, String dbName) {
        super(dbPath, dbName);
    }
    
    public DoubleWritableDoubleMap(String dbPath, String dbName, int cacheSize) {
    ...
    public void optimize() {
        try {
            ...
            for (Entry<DoubleWritable, Double> entry : this.entrySet()) {
    ...
    @Override
    public Double put(DoubleWritable key, Double value) {
        if (key == null)
            return null;
    ...
    @Override
    public void putAll(Map<? extends DoubleWritable, ? extends Double> m) {
        try {
            WriteBatch batch = db.createWriteBatch();
            int counter = 0;
            for (Map.Entry<? extends DoubleWritable, ? extends Double> e : m
                    .entrySet()) {
    ...
    @Override
    public Set<java.util.Map.Entry<DoubleWritable, Double>> entrySet() {
        return new MapEntrySet<DoubleWritable, Double>(this, this.keyDeSerFunc,
                this.valDeSerFunc);
    }
