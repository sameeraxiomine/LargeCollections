...
public class FloatWritableBooleanWritableMap extends LargeCollection implements   Map<FloatWritable,BooleanWritable>, Serializable{
    ...
    public FloatWritableBooleanWritableMap() {
        super();
    }
    
    public FloatWritableBooleanWritableMap(String dbName) {
        super(dbName);
    }
    
    public FloatWritableBooleanWritableMap(String dbPath, String dbName) {
        super(dbPath, dbName);
    }
    
    public FloatWritableBooleanWritableMap(String dbPath, String dbName, int cacheSize) {
    ...
    public void optimize() {
        try {
            ...
            for (Entry<FloatWritable, BooleanWritable> entry : this.entrySet()) {
    ...
    @Override
    public BooleanWritable put(FloatWritable key, BooleanWritable value) {
        if (key == null)
            return null;
    ...
    @Override
    public void putAll(Map<? extends FloatWritable, ? extends BooleanWritable> m) {
        try {
            WriteBatch batch = db.createWriteBatch();
            int counter = 0;
            for (Map.Entry<? extends FloatWritable, ? extends BooleanWritable> e : m
                    .entrySet()) {
    ...
    @Override
    public Set<java.util.Map.Entry<FloatWritable, BooleanWritable>> entrySet() {
        return new MapEntrySet<FloatWritable, BooleanWritable>(this, this.keyDeSerFunc,
                this.valDeSerFunc);
    }
