...
public class FloatCharacterMap extends LargeCollection implements   Map<Float,Character>, Serializable{
    ...
    public FloatCharacterMap() {
        super();
    }
    
    public FloatCharacterMap(String dbName) {
        super(dbName);
    }
    
    public FloatCharacterMap(String dbPath, String dbName) {
        super(dbPath, dbName);
    }
    
    public FloatCharacterMap(String dbPath, String dbName, int cacheSize) {
    ...
    public void optimize() {
        try {
            ...
            for (Entry<Float, Character> entry : this.entrySet()) {
    ...
    public void putAll(Map<? extends Float, ? extends Character> m) {
        try {
            ...
            int counter = 0;
            for (Map.Entry<? extends Float, ? extends Character> e : m
                    .entrySet()) {
    ...
    @Override
    public Set<java.util.Map.Entry<Float, Character>> entrySet() {
        return new MapEntrySet<Float, Character>(this, this.keyDeSerFunc,
                this.valDeSerFunc);
    }
