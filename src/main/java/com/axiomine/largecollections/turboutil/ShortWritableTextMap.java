...
public class ShortWritableTextMap extends LargeCollection implements   Map<ShortWritable,Text>, Serializable{
    ...
    public ShortWritableTextMap() {
        super();
    }
    
    public ShortWritableTextMap(String dbName) {
        super(dbName);
    }
    
    public ShortWritableTextMap(String dbPath, String dbName) {
        super(dbPath, dbName);
    }
    
    public ShortWritableTextMap(String dbPath, String dbName, int cacheSize) {
    ...
    public void optimize() {
        try {
            ...
            for (Entry<ShortWritable, Text> entry : this.entrySet()) {
    ...
    @Override
    public Text put(ShortWritable key, Text value) {
        if (key == null)
            return null;
    ...
    @Override
    public void putAll(Map<? extends ShortWritable, ? extends Text> m) {
        try {
            WriteBatch batch = db.createWriteBatch();
            int counter = 0;
            for (Map.Entry<? extends ShortWritable, ? extends Text> e : m
                    .entrySet()) {
    ...
    @Override
    public Set<java.util.Map.Entry<ShortWritable, Text>> entrySet() {
        return new MapEntrySet<ShortWritable, Text>(this, this.keyDeSerFunc,
                this.valDeSerFunc);
    }
