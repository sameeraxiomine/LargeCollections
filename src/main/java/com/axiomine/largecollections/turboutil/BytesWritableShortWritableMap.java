...
public class BytesWritableShortWritableMap extends LargeCollection implements   Map<BytesWritable,ShortWritable>, Serializable{
    ...
    public BytesWritableShortWritableMap() {
        super();
    }
    
    public BytesWritableShortWritableMap(String dbName) {
        super(dbName);
    }
    
    public BytesWritableShortWritableMap(String dbPath, String dbName) {
        super(dbPath, dbName);
    }
    
    public BytesWritableShortWritableMap(String dbPath, String dbName, int cacheSize) {
    ...
    public void optimize() {
        try {
            ...
            for (Entry<BytesWritable, ShortWritable> entry : this.entrySet()) {
    ...
    @Override
    public ShortWritable put(BytesWritable key, ShortWritable value) {
        if (key == null)
            return null;
    ...
    @Override
    public void putAll(Map<? extends BytesWritable, ? extends ShortWritable> m) {
        try {
            WriteBatch batch = db.createWriteBatch();
            int counter = 0;
            for (Map.Entry<? extends BytesWritable, ? extends ShortWritable> e : m
                    .entrySet()) {
    ...
    @Override
    public Set<java.util.Map.Entry<BytesWritable, ShortWritable>> entrySet() {
        return new MapEntrySet<BytesWritable, ShortWritable>(this, this.keyDeSerFunc,
                this.valDeSerFunc);
    }
