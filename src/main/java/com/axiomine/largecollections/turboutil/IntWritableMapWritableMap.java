...
public class IntWritableMapWritableMap extends LargeCollection implements   Map<IntWritable,MapWritable>, Serializable{
    ...
    public IntWritableMapWritableMap() {
        super();
    }
    
    public IntWritableMapWritableMap(String dbName) {
        super(dbName);
    }
    
    public IntWritableMapWritableMap(String dbPath, String dbName) {
        super(dbPath, dbName);
    }
    
    public IntWritableMapWritableMap(String dbPath, String dbName, int cacheSize) {
    ...
    public void optimize() {
        try {
            ...
            for (Entry<IntWritable, MapWritable> entry : this.entrySet()) {
    ...
    @Override
    public MapWritable put(IntWritable key, MapWritable value) {
        if (key == null)
            return null;
    ...
    @Override
    public void putAll(Map<? extends IntWritable, ? extends MapWritable> m) {
        try {
            WriteBatch batch = db.createWriteBatch();
            int counter = 0;
            for (Map.Entry<? extends IntWritable, ? extends MapWritable> e : m
                    .entrySet()) {
    ...
    @Override
    public Set<java.util.Map.Entry<IntWritable, MapWritable>> entrySet() {
        return new MapEntrySet<IntWritable, MapWritable>(this, this.keyDeSerFunc,
                this.valDeSerFunc);
    }
