...
public class FloatWritableLongMap extends LargeCollection implements   Map<FloatWritable,Long>, Serializable{
    ...
    public FloatWritableLongMap() {
        super();
    }
    
    public FloatWritableLongMap(String dbName) {
        super(dbName);
    }
    
    public FloatWritableLongMap(String dbPath, String dbName) {
        super(dbPath, dbName);
    }
    
    public FloatWritableLongMap(String dbPath, String dbName, int cacheSize) {
    ...
    public void optimize() {
        try {
            ...
            for (Entry<FloatWritable, Long> entry : this.entrySet()) {
    ...
    @Override
    public Long put(FloatWritable key, Long value) {
        if (key == null)
            return null;
    ...
    @Override
    public void putAll(Map<? extends FloatWritable, ? extends Long> m) {
        try {
            WriteBatch batch = db.createWriteBatch();
            int counter = 0;
            for (Map.Entry<? extends FloatWritable, ? extends Long> e : m
                    .entrySet()) {
    ...
    @Override
    public Set<java.util.Map.Entry<FloatWritable, Long>> entrySet() {
        return new MapEntrySet<FloatWritable, Long>(this, this.keyDeSerFunc,
                this.valDeSerFunc);
    }
