...
public class ByteWritableBooleanWritableMap extends LargeCollection implements   Map<ByteWritable,BooleanWritable>, Serializable{
    ...
    public ByteWritableBooleanWritableMap() {
        super();
    }
    
    public ByteWritableBooleanWritableMap(String dbName) {
        super(dbName);
    }
    
    public ByteWritableBooleanWritableMap(String dbPath, String dbName) {
        super(dbPath, dbName);
    }
    
    public ByteWritableBooleanWritableMap(String dbPath, String dbName, int cacheSize) {
    ...
    public void optimize() {
        try {
            ...
            for (Entry<ByteWritable, BooleanWritable> entry : this.entrySet()) {
    ...
    @Override
    public BooleanWritable put(ByteWritable key, BooleanWritable value) {
        if (key == null)
            return null;
    ...
    @Override
    public void putAll(Map<? extends ByteWritable, ? extends BooleanWritable> m) {
        try {
            WriteBatch batch = db.createWriteBatch();
            int counter = 0;
            for (Map.Entry<? extends ByteWritable, ? extends BooleanWritable> e : m
                    .entrySet()) {
    ...
    @Override
    public Set<java.util.Map.Entry<ByteWritable, BooleanWritable>> entrySet() {
        return new MapEntrySet<ByteWritable, BooleanWritable>(this, this.keyDeSerFunc,
                this.valDeSerFunc);
    }
