...
public class DoubleWritableTextMap extends LargeCollection implements   Map<DoubleWritable,Text>, Serializable{
    ...
    public DoubleWritableTextMap() {
        super();
    }
    
    public DoubleWritableTextMap(String dbName) {
        super(dbName);
    }
    
    public DoubleWritableTextMap(String dbPath, String dbName) {
        super(dbPath, dbName);
    }
    
    public DoubleWritableTextMap(String dbPath, String dbName, int cacheSize) {
    ...
    public void optimize() {
        try {
            ...
            for (Entry<DoubleWritable, Text> entry : this.entrySet()) {
    ...
    @Override
    public Text put(DoubleWritable key, Text value) {
        if (key == null)
            return null;
    ...
    @Override
    public void putAll(Map<? extends DoubleWritable, ? extends Text> m) {
        try {
            WriteBatch batch = db.createWriteBatch();
            int counter = 0;
            for (Map.Entry<? extends DoubleWritable, ? extends Text> e : m
                    .entrySet()) {
    ...
    @Override
    public Set<java.util.Map.Entry<DoubleWritable, Text>> entrySet() {
        return new MapEntrySet<DoubleWritable, Text>(this, this.keyDeSerFunc,
                this.valDeSerFunc);
    }
