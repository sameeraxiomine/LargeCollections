...
public class ByteArrayPrimitiveWritableMap extends LargeCollection implements   Map<Byte,ArrayPrimitiveWritable>, Serializable{
    ...
    public ByteArrayPrimitiveWritableMap() {
        super();
    }
    
    public ByteArrayPrimitiveWritableMap(String dbName) {
        super(dbName);
    }
    
    public ByteArrayPrimitiveWritableMap(String dbPath, String dbName) {
        super(dbPath, dbName);
    }
    
    public ByteArrayPrimitiveWritableMap(String dbPath, String dbName, int cacheSize) {
