...
public class LongWritableLongMap extends LargeCollection implements   Map<LongWritable,Long>, Serializable{
    ...
    public LongWritableLongMap() {
        super();
    }
    
    public LongWritableLongMap(String dbName) {
        super(dbName);
    }
    
    public LongWritableLongMap(String dbPath, String dbName) {
        super(dbPath, dbName);
    }
    
    public LongWritableLongMap(String dbPath, String dbName, int cacheSize) {
    ...
    public void optimize() {
        try {
            ...
            for (Entry<LongWritable, Long> entry : this.entrySet()) {
    ...
    @Override
    public Long put(LongWritable key, Long value) {
        if (key == null)
            return null;
    ...
    @Override
    public void putAll(Map<? extends LongWritable, ? extends Long> m) {
        try {
            WriteBatch batch = db.createWriteBatch();
            int counter = 0;
            for (Map.Entry<? extends LongWritable, ? extends Long> e : m
                    .entrySet()) {
    ...
    @Override
    public Set<java.util.Map.Entry<LongWritable, Long>> entrySet() {
        return new MapEntrySet<LongWritable, Long>(this, this.keyDeSerFunc,
                this.valDeSerFunc);
    }
