...
public class BooleanWritableIntWritableMap extends LargeCollection implements   Map<BooleanWritable,IntWritable>, Serializable{
    ...
    public BooleanWritableIntWritableMap(String dbName) {
        super(dbName);
    }
    
    public BooleanWritableIntWritableMap(String dbPath, String dbName) {
        super(dbPath, dbName);
    }
    
    public BooleanWritableIntWritableMap(String dbPath, String dbName, int cacheSize) {
    ...
    public void optimize() {
        try {
            ...
            for (Entry<BooleanWritable, IntWritable> entry : this.entrySet()) {
    ...
    @Override
    public IntWritable put(BooleanWritable key, IntWritable value) {
        if (key == null)
            return null;
    ...
    @Override
    public void putAll(Map<? extends BooleanWritable, ? extends IntWritable> m) {
        try {
            WriteBatch batch = db.createWriteBatch();
            int counter = 0;
            for (Map.Entry<? extends BooleanWritable, ? extends IntWritable> e : m
                    .entrySet()) {
    ...
    @Override
    public Set<java.util.Map.Entry<BooleanWritable, IntWritable>> entrySet() {
        return new MapEntrySet<BooleanWritable, IntWritable>(this, this.keyDeSerFunc,
                this.valDeSerFunc);
    }
