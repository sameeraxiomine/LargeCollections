...
public class ByteWritableBytesArrayMap extends LargeCollection implements   Map<ByteWritable,byte[]>, Serializable{
    ...
    public ByteWritableBytesArrayMap() {
        super();
    }
    
    public ByteWritableBytesArrayMap(String dbName) {
        super(dbName);
    }
    
    public ByteWritableBytesArrayMap(String dbPath, String dbName) {
        super(dbPath, dbName);
    }
    
    public ByteWritableBytesArrayMap(String dbPath, String dbName, int cacheSize) {
    ...
    public void optimize() {
        try {
            ...
            for (Entry<ByteWritable, byte[]> entry : this.entrySet()) {
    ...
    @Override
    public byte[] put(ByteWritable key, byte[] value) {
        if (key == null)
            return null;
    ...
    @Override
    public void putAll(Map<? extends ByteWritable, ? extends byte[]> m) {
        try {
            WriteBatch batch = db.createWriteBatch();
            int counter = 0;
            for (Map.Entry<? extends ByteWritable, ? extends byte[]> e : m
                    .entrySet()) {
    ...
    @Override
    public Set<java.util.Map.Entry<ByteWritable, byte[]>> entrySet() {
        return new MapEntrySet<ByteWritable, byte[]>(this, this.keyDeSerFunc,
                this.valDeSerFunc);
    }
