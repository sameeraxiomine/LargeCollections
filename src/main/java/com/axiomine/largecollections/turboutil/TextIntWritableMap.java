...
public class TextIntWritableMap extends LargeCollection implements   Map<Text,IntWritable>, Serializable{
    ...
    public TextIntWritableMap() {
        super();
    }
    
    public TextIntWritableMap(String dbName) {
        super(dbName);
    }
    
    public TextIntWritableMap(String dbPath, String dbName) {
        super(dbPath, dbName);
    }
    
    public TextIntWritableMap(String dbPath, String dbName, int cacheSize) {
    ...
    public void optimize() {
        try {
            ...
            for (Entry<Text, IntWritable> entry : this.entrySet()) {
    ...
    @Override
    public void putAll(Map<? extends Text, ? extends IntWritable> m) {
        try {
            WriteBatch batch = db.createWriteBatch();
            int counter = 0;
            for (Map.Entry<? extends Text, ? extends IntWritable> e : m
                    .entrySet()) {
    ...
    public Set<java.util.Map.Entry<Text, IntWritable>> entrySet() {
        return new MapEntrySet<Text, IntWritable>(this, this.keyDeSerFunc,
                this.valDeSerFunc);
    }
