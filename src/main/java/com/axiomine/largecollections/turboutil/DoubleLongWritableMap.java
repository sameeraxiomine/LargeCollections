...
public class DoubleLongWritableMap extends LargeCollection implements   Map<Double,LongWritable>, Serializable{
    ...
    public DoubleLongWritableMap() {
        super();
    }
    
    public DoubleLongWritableMap(String dbName) {
        super(dbName);
    }
    
    public DoubleLongWritableMap(String dbPath, String dbName) {
        super(dbPath, dbName);
    }
    
    public DoubleLongWritableMap(String dbPath, String dbName, int cacheSize) {
    ...
    public void optimize() {
        try {
            ...
            for (Entry<Double, LongWritable> entry : this.entrySet()) {
    ...
    @Override
    public LongWritable put(Double key, LongWritable value) {
        if (key == null)
            return null;
    ...
    @Override
    public void putAll(Map<? extends Double, ? extends LongWritable> m) {
        try {
            WriteBatch batch = db.createWriteBatch();
            int counter = 0;
            for (Map.Entry<? extends Double, ? extends LongWritable> e : m
                    .entrySet()) {
    ...
    @Override
    public Set<java.util.Map.Entry<Double, LongWritable>> entrySet() {
        return new MapEntrySet<Double, LongWritable>(this, this.keyDeSerFunc,
                this.valDeSerFunc);
    }
