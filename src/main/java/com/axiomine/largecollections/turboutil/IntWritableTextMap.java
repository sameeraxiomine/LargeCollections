...
public class IntWritableTextMap extends LargeCollection implements   Map<IntWritable,Text>, Serializable{
    ...
    public IntWritableTextMap() {
        super();
    }
    
    public IntWritableTextMap(String dbName) {
        super(dbName);
    }
    
    public IntWritableTextMap(String dbPath, String dbName) {
        super(dbPath, dbName);
    }
    
    public IntWritableTextMap(String dbPath, String dbName, int cacheSize) {
    ...
    public void optimize() {
        try {
            ...
            for (Entry<IntWritable, Text> entry : this.entrySet()) {
    ...
    @Override
    public Text put(IntWritable key, Text value) {
        if (key == null)
            return null;
    ...
    @Override
    public void putAll(Map<? extends IntWritable, ? extends Text> m) {
        try {
            WriteBatch batch = db.createWriteBatch();
            int counter = 0;
            for (Map.Entry<? extends IntWritable, ? extends Text> e : m
                    .entrySet()) {
    ...
    @Override
    public Set<java.util.Map.Entry<IntWritable, Text>> entrySet() {
        return new MapEntrySet<IntWritable, Text>(this, this.keyDeSerFunc,
                this.valDeSerFunc);
    }
