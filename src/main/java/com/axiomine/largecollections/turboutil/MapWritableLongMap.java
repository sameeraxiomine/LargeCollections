...
public class MapWritableLongMap extends LargeCollection implements   Map<MapWritable,Long>, Serializable{
    ...
    public MapWritableLongMap() {
        super();
    }
    
    public MapWritableLongMap(String dbName) {
        super(dbName);
    }
    
    public MapWritableLongMap(String dbPath, String dbName) {
        super(dbPath, dbName);
    }
    
    public MapWritableLongMap(String dbPath, String dbName, int cacheSize) {
    ...
    public void optimize() {
        try {
            ...
            for (Entry<MapWritable, Long> entry : this.entrySet()) {
    ...
    @Override
    public Long put(MapWritable key, Long value) {
        if (key == null)
            return null;
    ...
    @Override
    public void putAll(Map<? extends MapWritable, ? extends Long> m) {
        try {
            WriteBatch batch = db.createWriteBatch();
            int counter = 0;
            for (Map.Entry<? extends MapWritable, ? extends Long> e : m
                    .entrySet()) {
    ...
    @Override
    public Set<java.util.Map.Entry<MapWritable, Long>> entrySet() {
        return new MapEntrySet<MapWritable, Long>(this, this.keyDeSerFunc,
                this.valDeSerFunc);
    }
