...
public class DoubleWritableMapWritableMap extends LargeCollection implements   Map<DoubleWritable,MapWritable>, Serializable{
    ...
    public DoubleWritableMapWritableMap() {
        super();
    }
    
    public DoubleWritableMapWritableMap(String dbName) {
        super(dbName);
    }
    
    public DoubleWritableMapWritableMap(String dbPath, String dbName) {
        super(dbPath, dbName);
    }
    
    public DoubleWritableMapWritableMap(String dbPath, String dbName, int cacheSize) {
    ...
    @Override
    public MapWritable put(DoubleWritable key, MapWritable value) {
        if (key == null)
            return null;
    ...
    @Override
    public void putAll(Map<? extends DoubleWritable, ? extends MapWritable> m) {
        try {
            WriteBatch batch = db.createWriteBatch();
            int counter = 0;
            for (Map.Entry<? extends DoubleWritable, ? extends MapWritable> e : m
                    .entrySet()) {
    ...
    @Override
    public Set<java.util.Map.Entry<DoubleWritable, MapWritable>> entrySet() {
        return new MapEntrySet<DoubleWritable, MapWritable>(this, this.keyDeSerFunc,
                this.valDeSerFunc);
    }
