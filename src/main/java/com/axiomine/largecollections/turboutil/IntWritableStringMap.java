...
public class IntWritableStringMap extends LargeCollection implements   Map<IntWritable,String>, Serializable{
    ...
    public IntWritableStringMap() {
        super();
    }
    
    public IntWritableStringMap(String dbName) {
        super(dbName);
    }
    
    public IntWritableStringMap(String dbPath, String dbName) {
        super(dbPath, dbName);
    }
    
    public IntWritableStringMap(String dbPath, String dbName, int cacheSize) {
    ...
    public void optimize() {
        try {
            ...
            for (Entry<IntWritable, String> entry : this.entrySet()) {
    ...
    @Override
    public String put(IntWritable key, String value) {
        if (key == null)
            return null;
    ...
    @Override
    public void putAll(Map<? extends IntWritable, ? extends String> m) {
        try {
            WriteBatch batch = db.createWriteBatch();
            int counter = 0;
            for (Map.Entry<? extends IntWritable, ? extends String> e : m
                    .entrySet()) {
    ...
    @Override
    public Set<java.util.Map.Entry<IntWritable, String>> entrySet() {
        return new MapEntrySet<IntWritable, String>(this, this.keyDeSerFunc,
                this.valDeSerFunc);
    }
