...
public class MapWritableBooleanWritableMap extends LargeCollection implements   Map<MapWritable,BooleanWritable>, Serializable{
    ...
    public MapWritableBooleanWritableMap() {
        super();
    }
    
    public MapWritableBooleanWritableMap(String dbName) {
        super(dbName);
    }
    
    public MapWritableBooleanWritableMap(String dbPath, String dbName) {
        super(dbPath, dbName);
    }
    
    public MapWritableBooleanWritableMap(String dbPath, String dbName, int cacheSize) {
    ...
    public void optimize() {
        try {
            ...
            for (Entry<MapWritable, BooleanWritable> entry : this.entrySet()) {
    ...
    @Override
    public BooleanWritable put(MapWritable key, BooleanWritable value) {
        if (key == null)
            return null;
    ...
    @Override
    public void putAll(Map<? extends MapWritable, ? extends BooleanWritable> m) {
        try {
            WriteBatch batch = db.createWriteBatch();
            int counter = 0;
            for (Map.Entry<? extends MapWritable, ? extends BooleanWritable> e : m
                    .entrySet()) {
    ...
    @Override
    public Set<java.util.Map.Entry<MapWritable, BooleanWritable>> entrySet() {
        return new MapEntrySet<MapWritable, BooleanWritable>(this, this.keyDeSerFunc,
                this.valDeSerFunc);
    }
