...
public class KryoKStringMap<K> extends LargeCollection implements   Map<K,String>, Serializable{
    ...
    public KryoKStringMap() {
        super();
    }
    
    public KryoKStringMap(String dbName) {
        super(dbName);
    }
    
    public KryoKStringMap(String dbPath, String dbName) {
        super(dbPath, dbName);
    }
    
    public KryoKStringMap(String dbPath, String dbName, int cacheSize) {
    ...
    public void optimize() {
        try {
            ...
            for (Entry<K, String> entry : this.entrySet()) {
    ...
    public void putAll(Map<? extends K, ? extends String> m) {
        try {
            ...
            int counter = 0;
            for (Map.Entry<? extends K, ? extends String> e : m
                    .entrySet()) {
    ...
    public Set<java.util.Map.Entry<K, String>> entrySet() {
        return new MapEntrySet<K, String>(this, this.keyDeSerFunc,
                this.valDeSerFunc);
    }
