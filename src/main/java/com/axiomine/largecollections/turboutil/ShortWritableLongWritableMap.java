...
public class ShortWritableLongWritableMap extends LargeCollection implements   Map<ShortWritable,LongWritable>, Serializable{
    ...
    public ShortWritableLongWritableMap() {
        super();
    }
    
    public ShortWritableLongWritableMap(String dbName) {
        super(dbName);
    }
    
    public ShortWritableLongWritableMap(String dbPath, String dbName) {
        super(dbPath, dbName);
    }
    
    public ShortWritableLongWritableMap(String dbPath, String dbName, int cacheSize) {
    ...
    @Override
    public LongWritable put(ShortWritable key, LongWritable value) {
        if (key == null)
            return null;
    ...
    @Override
    public void putAll(Map<? extends ShortWritable, ? extends LongWritable> m) {
        try {
            WriteBatch batch = db.createWriteBatch();
            int counter = 0;
            for (Map.Entry<? extends ShortWritable, ? extends LongWritable> e : m
                    .entrySet()) {
    ...
    @Override
    public Set<java.util.Map.Entry<ShortWritable, LongWritable>> entrySet() {
        return new MapEntrySet<ShortWritable, LongWritable>(this, this.keyDeSerFunc,
                this.valDeSerFunc);
    }
