...
public class FloatWritableCharacterMap extends LargeCollection implements   Map<FloatWritable,Character>, Serializable{
    ...
    public FloatWritableCharacterMap() {
        super();
    }
    
    public FloatWritableCharacterMap(String dbName) {
        super(dbName);
    }
    
    public FloatWritableCharacterMap(String dbPath, String dbName) {
        super(dbPath, dbName);
    }
    
    public FloatWritableCharacterMap(String dbPath, String dbName, int cacheSize) {
    ...
    public void optimize() {
        try {
            ...
            for (Entry<FloatWritable, Character> entry : this.entrySet()) {
    ...
    @Override
    public Character put(FloatWritable key, Character value) {
        if (key == null)
            return null;
    ...
    @Override
    public void putAll(Map<? extends FloatWritable, ? extends Character> m) {
        try {
            WriteBatch batch = db.createWriteBatch();
            int counter = 0;
            for (Map.Entry<? extends FloatWritable, ? extends Character> e : m
                    .entrySet()) {
    ...
    @Override
    public Set<java.util.Map.Entry<FloatWritable, Character>> entrySet() {
        return new MapEntrySet<FloatWritable, Character>(this, this.keyDeSerFunc,
                this.valDeSerFunc);
    }
