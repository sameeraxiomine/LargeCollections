...
public class CharacterTextMap extends LargeCollection implements   Map<Character,Text>, Serializable{
    ...
    public CharacterTextMap() {
        super();
    }
    
    public CharacterTextMap(String dbName) {
        super(dbName);
    }
    
    public CharacterTextMap(String dbPath, String dbName) {
        super(dbPath, dbName);
    }
    
    public CharacterTextMap(String dbPath, String dbName, int cacheSize) {
    ...
    public void optimize() {
        try {
            ...
            for (Entry<Character, Text> entry : this.entrySet()) {
    ...
    @Override
    public Text put(Character key, Text value) {
        if (key == null)
            return null;
    ...
    @Override
    public void putAll(Map<? extends Character, ? extends Text> m) {
        try {
            WriteBatch batch = db.createWriteBatch();
            int counter = 0;
            for (Map.Entry<? extends Character, ? extends Text> e : m
                    .entrySet()) {
    ...
    @Override
    public Set<java.util.Map.Entry<Character, Text>> entrySet() {
        return new MapEntrySet<Character, Text>(this, this.keyDeSerFunc,
                this.valDeSerFunc);
    }
