...
public class BooleanWritableStringMap extends LargeCollection implements   Map<BooleanWritable,String>, Serializable{
    ...
    public BooleanWritableStringMap() {
        super();
    }
    
    public BooleanWritableStringMap(String dbName) {
        super(dbName);
    }
    
    public BooleanWritableStringMap(String dbPath, String dbName) {
        super(dbPath, dbName);
    }
    
    public BooleanWritableStringMap(String dbPath, String dbName, int cacheSize) {
    ...
    @Override
    public String put(BooleanWritable key, String value) {
        if (key == null)
            return null;
    ...
    @Override
    public void putAll(Map<? extends BooleanWritable, ? extends String> m) {
        try {
            WriteBatch batch = db.createWriteBatch();
            int counter = 0;
            for (Map.Entry<? extends BooleanWritable, ? extends String> e : m
                    .entrySet()) {
    ...
    @Override
    public Set<java.util.Map.Entry<BooleanWritable, String>> entrySet() {
        return new MapEntrySet<BooleanWritable, String>(this, this.keyDeSerFunc,
                this.valDeSerFunc);
    }
