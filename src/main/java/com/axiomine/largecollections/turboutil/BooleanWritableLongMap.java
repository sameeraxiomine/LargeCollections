...
public class BooleanWritableLongMap extends LargeCollection implements   Map<BooleanWritable,Long>, Serializable{
    ...
    public BooleanWritableLongMap() {
        super();
    }
    
    public BooleanWritableLongMap(String dbName) {
        super(dbName);
    }
    
    public BooleanWritableLongMap(String dbPath, String dbName) {
        super(dbPath, dbName);
    }
    
    public BooleanWritableLongMap(String dbPath, String dbName, int cacheSize) {
    ...
    public void optimize() {
        try {
            ...
            for (Entry<BooleanWritable, Long> entry : this.entrySet()) {
    ...
    @Override
    public Long put(BooleanWritable key, Long value) {
        if (key == null)
            return null;
    ...
    @Override
    public void putAll(Map<? extends BooleanWritable, ? extends Long> m) {
        try {
            WriteBatch batch = db.createWriteBatch();
            int counter = 0;
            for (Map.Entry<? extends BooleanWritable, ? extends Long> e : m
                    .entrySet()) {
    ...
    @Override
    public Set<java.util.Map.Entry<BooleanWritable, Long>> entrySet() {
        return new MapEntrySet<BooleanWritable, Long>(this, this.keyDeSerFunc,
                this.valDeSerFunc);
    }
