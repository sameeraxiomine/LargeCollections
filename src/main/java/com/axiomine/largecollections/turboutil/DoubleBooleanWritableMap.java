...
public class DoubleBooleanWritableMap extends LargeCollection implements   Map<Double,BooleanWritable>, Serializable{
    ...
    public DoubleBooleanWritableMap() {
        super();
    }
    
    public DoubleBooleanWritableMap(String dbName) {
        super(dbName);
    }
    
    public DoubleBooleanWritableMap(String dbPath, String dbName) {
        super(dbPath, dbName);
    }
    
    public DoubleBooleanWritableMap(String dbPath, String dbName, int cacheSize) {
    ...
    public void optimize() {
        try {
            ...
            for (Entry<Double, BooleanWritable> entry : this.entrySet()) {
    ...
    @Override
    public BooleanWritable put(Double key, BooleanWritable value) {
        if (key == null)
            return null;
    ...
    @Override
    public void putAll(Map<? extends Double, ? extends BooleanWritable> m) {
        try {
            WriteBatch batch = db.createWriteBatch();
            int counter = 0;
            for (Map.Entry<? extends Double, ? extends BooleanWritable> e : m
                    .entrySet()) {
    ...
    @Override
    public Set<java.util.Map.Entry<Double, BooleanWritable>> entrySet() {
        return new MapEntrySet<Double, BooleanWritable>(this, this.keyDeSerFunc,
                this.valDeSerFunc);
    }
