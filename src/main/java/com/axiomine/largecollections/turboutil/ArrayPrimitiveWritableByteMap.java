...
public class ArrayPrimitiveWritableByteMap extends LargeCollection implements   Map<ArrayPrimitiveWritable,Byte>, Serializable{
    ...
    public ArrayPrimitiveWritableByteMap(String dbName) {
        super(dbName);
    }
    
    public ArrayPrimitiveWritableByteMap(String dbPath, String dbName) {
        super(dbPath, dbName);
    }
    
    public ArrayPrimitiveWritableByteMap(String dbPath, String dbName, int cacheSize) {
