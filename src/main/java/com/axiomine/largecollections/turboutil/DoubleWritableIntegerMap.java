...
public class DoubleWritableIntegerMap extends LargeCollection implements   Map<DoubleWritable,Integer>, Serializable{
    ...
    public DoubleWritableIntegerMap() {
        super();
    }
    
    public DoubleWritableIntegerMap(String dbName) {
        super(dbName);
    }
    
    public DoubleWritableIntegerMap(String dbPath, String dbName) {
        super(dbPath, dbName);
    }
    
    public DoubleWritableIntegerMap(String dbPath, String dbName, int cacheSize) {
    ...
    public void optimize() {
        try {
            ...
            for (Entry<DoubleWritable, Integer> entry : this.entrySet()) {
    ...
    @Override
    public Integer put(DoubleWritable key, Integer value) {
        if (key == null)
            return null;
    ...
    @Override
    public void putAll(Map<? extends DoubleWritable, ? extends Integer> m) {
        try {
            WriteBatch batch = db.createWriteBatch();
            int counter = 0;
            for (Map.Entry<? extends DoubleWritable, ? extends Integer> e : m
                    .entrySet()) {
    ...
    @Override
    public Set<java.util.Map.Entry<DoubleWritable, Integer>> entrySet() {
        return new MapEntrySet<DoubleWritable, Integer>(this, this.keyDeSerFunc,
                this.valDeSerFunc);
    }
