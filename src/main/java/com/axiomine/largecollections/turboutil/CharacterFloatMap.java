...
public class CharacterFloatMap extends LargeCollection implements   Map<Character,Float>, Serializable{
    ...
    public CharacterFloatMap() {
        super();
    }
    
    public CharacterFloatMap(String dbName) {
        super(dbName);
    }
    
    public CharacterFloatMap(String dbPath, String dbName) {
        super(dbPath, dbName);
    }
    
    public CharacterFloatMap(String dbPath, String dbName, int cacheSize) {
    ...
    public void optimize() {
        try {
            ...
            for (Entry<Character, Float> entry : this.entrySet()) {
    ...
    public void putAll(Map<? extends Character, ? extends Float> m) {
        try {
            ...
            int counter = 0;
            for (Map.Entry<? extends Character, ? extends Float> e : m
                    .entrySet()) {
    ...
    @Override
    public Set<java.util.Map.Entry<Character, Float>> entrySet() {
        return new MapEntrySet<Character, Float>(this, this.keyDeSerFunc,
                this.valDeSerFunc);
    }
