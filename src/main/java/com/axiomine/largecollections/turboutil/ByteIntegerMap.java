...
public class ByteIntegerMap extends LargeCollection implements   Map<Byte,Integer>, Serializable{
    ...
    public ByteIntegerMap() {
        super();
    }
    
    public ByteIntegerMap(String dbName) {
        super(dbName);
    }
    
    public ByteIntegerMap(String dbPath, String dbName) {
        super(dbPath, dbName);
    }
    
    public ByteIntegerMap(String dbPath, String dbName, int cacheSize) {
