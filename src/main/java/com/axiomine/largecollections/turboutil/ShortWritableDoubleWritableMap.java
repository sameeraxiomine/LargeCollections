...
public class ShortWritableDoubleWritableMap extends LargeCollection implements   Map<ShortWritable,DoubleWritable>, Serializable{
    ...
    public ShortWritableDoubleWritableMap() {
        super();
    }
    
    public ShortWritableDoubleWritableMap(String dbName) {
        super(dbName);
    }
    
    public ShortWritableDoubleWritableMap(String dbPath, String dbName) {
        super(dbPath, dbName);
    }
    
    public ShortWritableDoubleWritableMap(String dbPath, String dbName, int cacheSize) {
    ...
    public void optimize() {
        try {
            ...
            for (Entry<ShortWritable, DoubleWritable> entry : this.entrySet()) {
    ...
    @Override
    public DoubleWritable put(ShortWritable key, DoubleWritable value) {
        if (key == null)
            return null;
    ...
    @Override
    public void putAll(Map<? extends ShortWritable, ? extends DoubleWritable> m) {
        try {
            WriteBatch batch = db.createWriteBatch();
            int counter = 0;
            for (Map.Entry<? extends ShortWritable, ? extends DoubleWritable> e : m
                    .entrySet()) {
    ...
    @Override
    public Set<java.util.Map.Entry<ShortWritable, DoubleWritable>> entrySet() {
        return new MapEntrySet<ShortWritable, DoubleWritable>(this, this.keyDeSerFunc,
                this.valDeSerFunc);
    }
