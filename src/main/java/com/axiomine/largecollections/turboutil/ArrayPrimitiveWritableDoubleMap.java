...
public class ArrayPrimitiveWritableDoubleMap extends LargeCollection implements   Map<ArrayPrimitiveWritable,Double>, Serializable{
    ...
    public ArrayPrimitiveWritableDoubleMap() {
        super();
    }
    
    public ArrayPrimitiveWritableDoubleMap(String dbName) {
        super(dbName);
    }
    
    public ArrayPrimitiveWritableDoubleMap(String dbPath, String dbName) {
        super(dbPath, dbName);
    }
    
    public ArrayPrimitiveWritableDoubleMap(String dbPath, String dbName, int cacheSize) {
    ...
    public void optimize() {
        try {
            ...
            for (Entry<ArrayPrimitiveWritable, Double> entry : this.entrySet()) {
    ...
    @Override
    public Double put(ArrayPrimitiveWritable key, Double value) {
        if (key == null)
            return null;
    ...
    @Override
    public void putAll(Map<? extends ArrayPrimitiveWritable, ? extends Double> m) {
        try {
            WriteBatch batch = db.createWriteBatch();
            int counter = 0;
            for (Map.Entry<? extends ArrayPrimitiveWritable, ? extends Double> e : m
                    .entrySet()) {
    ...
    @Override
    public Set<java.util.Map.Entry<ArrayPrimitiveWritable, Double>> entrySet() {
        return new MapEntrySet<ArrayPrimitiveWritable, Double>(this, this.keyDeSerFunc,
                this.valDeSerFunc);
    }
