...
public class BytesArrayKryoVMap<V> extends LargeCollection implements   Map<byte[],V>, Serializable{
    ...
    public BytesArrayKryoVMap() {
        super();
    }
    
    public BytesArrayKryoVMap(String dbName) {
        super(dbName);
    }
    
    public BytesArrayKryoVMap(String dbPath, String dbName) {
        super(dbPath, dbName);
    }
    
    public BytesArrayKryoVMap(String dbPath, String dbName, int cacheSize) {
    ...
    public void optimize() {
        try {
            ...
            for (Entry<byte[], V> entry : this.entrySet()) {
    ...
    public void putAll(Map<? extends byte[], ? extends V> m) {
        try {
            ...
            int counter = 0;
            for (Map.Entry<? extends byte[], ? extends V> e : m
                    .entrySet()) {
    ...
    public Set<java.util.Map.Entry<byte[], V>> entrySet() {
        return new MapEntrySet<byte[], V>(this, this.keyDeSerFunc,
                this.valDeSerFunc);
    }
