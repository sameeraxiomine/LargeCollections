...
public class LongWritableIntWritableMap extends LargeCollection implements   Map<LongWritable,IntWritable>, Serializable{
    ...
    public LongWritableIntWritableMap() {
        super();
    }
    
    public LongWritableIntWritableMap(String dbName) {
        super(dbName);
    }
    
    public LongWritableIntWritableMap(String dbPath, String dbName) {
        super(dbPath, dbName);
    }
    
    public LongWritableIntWritableMap(String dbPath, String dbName, int cacheSize) {
    ...
    public void optimize() {
        try {
            ...
            for (Entry<LongWritable, IntWritable> entry : this.entrySet()) {
    ...
    @Override
    public IntWritable put(LongWritable key, IntWritable value) {
        if (key == null)
            return null;
    ...
    @Override
    public void putAll(Map<? extends LongWritable, ? extends IntWritable> m) {
        try {
            WriteBatch batch = db.createWriteBatch();
            int counter = 0;
            for (Map.Entry<? extends LongWritable, ? extends IntWritable> e : m
                    .entrySet()) {
    ...
    @Override
    public Set<java.util.Map.Entry<LongWritable, IntWritable>> entrySet() {
        return new MapEntrySet<LongWritable, IntWritable>(this, this.keyDeSerFunc,
                this.valDeSerFunc);
    }
