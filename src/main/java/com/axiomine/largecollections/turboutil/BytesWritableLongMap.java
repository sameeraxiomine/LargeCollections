...
public class BytesWritableLongMap extends LargeCollection implements   Map<BytesWritable,Long>, Serializable{
    ...
    public BytesWritableLongMap() {
        super();
    }
    
    public BytesWritableLongMap(String dbName) {
        super(dbName);
    }
    
    public BytesWritableLongMap(String dbPath, String dbName) {
        super(dbPath, dbName);
    }
    
    public BytesWritableLongMap(String dbPath, String dbName, int cacheSize) {
    ...
    @Override
    public Long put(BytesWritable key, Long value) {
        if (key == null)
            return null;
    ...
    @Override
    public void putAll(Map<? extends BytesWritable, ? extends Long> m) {
        try {
            WriteBatch batch = db.createWriteBatch();
            int counter = 0;
            for (Map.Entry<? extends BytesWritable, ? extends Long> e : m
                    .entrySet()) {
    ...
    @Override
    public Set<java.util.Map.Entry<BytesWritable, Long>> entrySet() {
        return new MapEntrySet<BytesWritable, Long>(this, this.keyDeSerFunc,
                this.valDeSerFunc);
    }
