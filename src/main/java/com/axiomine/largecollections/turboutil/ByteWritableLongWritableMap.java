...
public class ByteWritableLongWritableMap extends LargeCollection implements   Map<ByteWritable,LongWritable>, Serializable{
    ...
    public ByteWritableLongWritableMap() {
        super();
    }
    
    public ByteWritableLongWritableMap(String dbName) {
        super(dbName);
    }
    
    public ByteWritableLongWritableMap(String dbPath, String dbName) {
        super(dbPath, dbName);
    }
    
    public ByteWritableLongWritableMap(String dbPath, String dbName, int cacheSize) {
    ...
    public void optimize() {
        try {
            ...
            for (Entry<ByteWritable, LongWritable> entry : this.entrySet()) {
    ...
    @Override
    public LongWritable put(ByteWritable key, LongWritable value) {
        if (key == null)
            return null;
    ...
    @Override
    public void putAll(Map<? extends ByteWritable, ? extends LongWritable> m) {
        try {
            WriteBatch batch = db.createWriteBatch();
            int counter = 0;
            for (Map.Entry<? extends ByteWritable, ? extends LongWritable> e : m
                    .entrySet()) {
    ...
    @Override
    public Set<java.util.Map.Entry<ByteWritable, LongWritable>> entrySet() {
        return new MapEntrySet<ByteWritable, LongWritable>(this, this.keyDeSerFunc,
                this.valDeSerFunc);
    }
