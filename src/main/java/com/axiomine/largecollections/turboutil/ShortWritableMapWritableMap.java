...
public class ShortWritableMapWritableMap extends LargeCollection implements   Map<ShortWritable,MapWritable>, Serializable{
    ...
    public ShortWritableMapWritableMap() {
        super();
    }
    
    public ShortWritableMapWritableMap(String dbName) {
        super(dbName);
    }
    
    public ShortWritableMapWritableMap(String dbPath, String dbName) {
        super(dbPath, dbName);
    }
    
    public ShortWritableMapWritableMap(String dbPath, String dbName, int cacheSize) {
    ...
    public void optimize() {
        try {
            ...
            for (Entry<ShortWritable, MapWritable> entry : this.entrySet()) {
    ...
    @Override
    public MapWritable put(ShortWritable key, MapWritable value) {
        if (key == null)
            return null;
    ...
    @Override
    public void putAll(Map<? extends ShortWritable, ? extends MapWritable> m) {
        try {
            WriteBatch batch = db.createWriteBatch();
            int counter = 0;
            for (Map.Entry<? extends ShortWritable, ? extends MapWritable> e : m
                    .entrySet()) {
    ...
    @Override
    public Set<java.util.Map.Entry<ShortWritable, MapWritable>> entrySet() {
        return new MapEntrySet<ShortWritable, MapWritable>(this, this.keyDeSerFunc,
                this.valDeSerFunc);
    }
