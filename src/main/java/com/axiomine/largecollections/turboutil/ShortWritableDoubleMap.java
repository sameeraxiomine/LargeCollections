...
public class ShortWritableDoubleMap extends LargeCollection implements   Map<ShortWritable,Double>, Serializable{
    ...
    public ShortWritableDoubleMap() {
        super();
    }
    
    public ShortWritableDoubleMap(String dbName) {
        super(dbName);
    }
    
    public ShortWritableDoubleMap(String dbPath, String dbName) {
        super(dbPath, dbName);
    }
    
    public ShortWritableDoubleMap(String dbPath, String dbName, int cacheSize) {
    ...
    public void optimize() {
        try {
            ...
            for (Entry<ShortWritable, Double> entry : this.entrySet()) {
    ...
    @Override
    public Double put(ShortWritable key, Double value) {
        if (key == null)
            return null;
    ...
    @Override
    public void putAll(Map<? extends ShortWritable, ? extends Double> m) {
        try {
            WriteBatch batch = db.createWriteBatch();
            int counter = 0;
            for (Map.Entry<? extends ShortWritable, ? extends Double> e : m
                    .entrySet()) {
    ...
    @Override
    public Set<java.util.Map.Entry<ShortWritable, Double>> entrySet() {
        return new MapEntrySet<ShortWritable, Double>(this, this.keyDeSerFunc,
                this.valDeSerFunc);
    }
