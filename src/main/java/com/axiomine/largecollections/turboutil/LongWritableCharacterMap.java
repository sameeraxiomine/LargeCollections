...
public class LongWritableCharacterMap extends LargeCollection implements   Map<LongWritable,Character>, Serializable{
    ...
    public LongWritableCharacterMap() {
        super();
    }
    
    public LongWritableCharacterMap(String dbName) {
        super(dbName);
    }
    
    public LongWritableCharacterMap(String dbPath, String dbName) {
        super(dbPath, dbName);
    }
    
    public LongWritableCharacterMap(String dbPath, String dbName, int cacheSize) {
    ...
    public void optimize() {
        try {
            ...
            for (Entry<LongWritable, Character> entry : this.entrySet()) {
    ...
    @Override
    public Character put(LongWritable key, Character value) {
        if (key == null)
            return null;
    ...
    @Override
    public void putAll(Map<? extends LongWritable, ? extends Character> m) {
        try {
            WriteBatch batch = db.createWriteBatch();
            int counter = 0;
            for (Map.Entry<? extends LongWritable, ? extends Character> e : m
                    .entrySet()) {
    ...
    @Override
    public Set<java.util.Map.Entry<LongWritable, Character>> entrySet() {
        return new MapEntrySet<LongWritable, Character>(this, this.keyDeSerFunc,
                this.valDeSerFunc);
    }
