...
public class CharacterArrayPrimitiveWritableMap extends LargeCollection implements   Map<Character,ArrayPrimitiveWritable>, Serializable{
    ...
    public CharacterArrayPrimitiveWritableMap() {
        super();
    }
    
    public CharacterArrayPrimitiveWritableMap(String dbName) {
        super(dbName);
    }
    
    public CharacterArrayPrimitiveWritableMap(String dbPath, String dbName) {
        super(dbPath, dbName);
    }
    
    public CharacterArrayPrimitiveWritableMap(String dbPath, String dbName, int cacheSize) {
    ...
    public void optimize() {
        try {
            ...
            for (Entry<Character, ArrayPrimitiveWritable> entry : this.entrySet()) {
    ...
    @Override
    public ArrayPrimitiveWritable put(Character key, ArrayPrimitiveWritable value) {
        if (key == null)
            return null;
    ...
    @Override
    public void putAll(Map<? extends Character, ? extends ArrayPrimitiveWritable> m) {
        try {
            WriteBatch batch = db.createWriteBatch();
            int counter = 0;
            for (Map.Entry<? extends Character, ? extends ArrayPrimitiveWritable> e : m
                    .entrySet()) {
    ...
    @Override
    public Set<java.util.Map.Entry<Character, ArrayPrimitiveWritable>> entrySet() {
        return new MapEntrySet<Character, ArrayPrimitiveWritable>(this, this.keyDeSerFunc,
                this.valDeSerFunc);
    }
