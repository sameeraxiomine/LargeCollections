...
public class ShortWritableByteMap extends LargeCollection implements   Map<ShortWritable,Byte>, Serializable{
    ...
    public ShortWritableByteMap() {
        super();
    }
    
    public ShortWritableByteMap(String dbName) {
        super(dbName);
    }
    
    public ShortWritableByteMap(String dbPath, String dbName) {
        super(dbPath, dbName);
    }
    
    public ShortWritableByteMap(String dbPath, String dbName, int cacheSize) {
