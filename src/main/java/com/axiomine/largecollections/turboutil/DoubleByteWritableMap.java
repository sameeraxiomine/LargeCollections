...
public class DoubleByteWritableMap extends LargeCollection implements   Map<Double,ByteWritable>, Serializable{
    ...
    public DoubleByteWritableMap() {
        super();
    }
    
    public DoubleByteWritableMap(String dbName) {
        super(dbName);
    }
    
    public DoubleByteWritableMap(String dbPath, String dbName) {
        super(dbPath, dbName);
    }
    
    public DoubleByteWritableMap(String dbPath, String dbName, int cacheSize) {
    ...
    public void optimize() {
        try {
            ...
            for (Entry<Double, ByteWritable> entry : this.entrySet()) {
    ...
    @Override
    public ByteWritable put(Double key, ByteWritable value) {
        if (key == null)
            return null;
    ...
    @Override
    public void putAll(Map<? extends Double, ? extends ByteWritable> m) {
        try {
            WriteBatch batch = db.createWriteBatch();
            int counter = 0;
            for (Map.Entry<? extends Double, ? extends ByteWritable> e : m
                    .entrySet()) {
    ...
    @Override
    public Set<java.util.Map.Entry<Double, ByteWritable>> entrySet() {
        return new MapEntrySet<Double, ByteWritable>(this, this.keyDeSerFunc,
                this.valDeSerFunc);
    }
