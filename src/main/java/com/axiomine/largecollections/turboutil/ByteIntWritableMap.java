...
public class ByteIntWritableMap extends LargeCollection implements   Map<Byte,IntWritable>, Serializable{
    ...
    public ByteIntWritableMap() {
        super();
    }
    
    public ByteIntWritableMap(String dbName) {
        super(dbName);
    }
    
    public ByteIntWritableMap(String dbPath, String dbName) {
        super(dbPath, dbName);
    }
    
    public ByteIntWritableMap(String dbPath, String dbName, int cacheSize) {
