...
public class ShortWritableBooleanWritableMap extends LargeCollection implements   Map<ShortWritable,BooleanWritable>, Serializable{
    ...
    public ShortWritableBooleanWritableMap() {
        super();
    }
    
    public ShortWritableBooleanWritableMap(String dbName) {
        super(dbName);
    }
    
    public ShortWritableBooleanWritableMap(String dbPath, String dbName) {
        super(dbPath, dbName);
    }
    
    public ShortWritableBooleanWritableMap(String dbPath, String dbName, int cacheSize) {
    ...
    public void optimize() {
        try {
            ...
            for (Entry<ShortWritable, BooleanWritable> entry : this.entrySet()) {
    ...
    @Override
    public BooleanWritable put(ShortWritable key, BooleanWritable value) {
        if (key == null)
            return null;
    ...
    @Override
    public void putAll(Map<? extends ShortWritable, ? extends BooleanWritable> m) {
        try {
            WriteBatch batch = db.createWriteBatch();
            int counter = 0;
            for (Map.Entry<? extends ShortWritable, ? extends BooleanWritable> e : m
                    .entrySet()) {
    ...
    @Override
    public Set<java.util.Map.Entry<ShortWritable, BooleanWritable>> entrySet() {
        return new MapEntrySet<ShortWritable, BooleanWritable>(this, this.keyDeSerFunc,
                this.valDeSerFunc);
    }
