...
public class ByteBytesArrayMap extends LargeCollection implements   Map<Byte,byte[]>, Serializable{
    ...
    public ByteBytesArrayMap() {
        super();
    }
    
    public ByteBytesArrayMap(String dbName) {
        super(dbName);
    }
    
    public ByteBytesArrayMap(String dbPath, String dbName) {
        super(dbPath, dbName);
    }
    
    public ByteBytesArrayMap(String dbPath, String dbName, int cacheSize) {
