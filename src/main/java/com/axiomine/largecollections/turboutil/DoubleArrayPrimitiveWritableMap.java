...
public class DoubleArrayPrimitiveWritableMap extends LargeCollection implements   Map<Double,ArrayPrimitiveWritable>, Serializable{
    ...
    public DoubleArrayPrimitiveWritableMap() {
        super();
    }
    
    public DoubleArrayPrimitiveWritableMap(String dbName) {
        super(dbName);
    }
    
    public DoubleArrayPrimitiveWritableMap(String dbPath, String dbName) {
        super(dbPath, dbName);
    }
    
    public DoubleArrayPrimitiveWritableMap(String dbPath, String dbName, int cacheSize) {
    ...
    public void optimize() {
        try {
            ...
            for (Entry<Double, ArrayPrimitiveWritable> entry : this.entrySet()) {
    ...
    @Override
    public ArrayPrimitiveWritable put(Double key, ArrayPrimitiveWritable value) {
        if (key == null)
            return null;
    ...
    @Override
    public void putAll(Map<? extends Double, ? extends ArrayPrimitiveWritable> m) {
        try {
            WriteBatch batch = db.createWriteBatch();
            int counter = 0;
            for (Map.Entry<? extends Double, ? extends ArrayPrimitiveWritable> e : m
                    .entrySet()) {
    ...
    @Override
    public Set<java.util.Map.Entry<Double, ArrayPrimitiveWritable>> entrySet() {
        return new MapEntrySet<Double, ArrayPrimitiveWritable>(this, this.keyDeSerFunc,
                this.valDeSerFunc);
    }
