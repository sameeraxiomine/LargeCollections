...
public class BytesArrayDoubleMap extends LargeCollection implements   Map<byte[],Double>, Serializable{
    ...
    public BytesArrayDoubleMap(String dbName) {
        super(dbName);
    }
    
    public BytesArrayDoubleMap(String dbPath, String dbName) {
        super(dbPath, dbName);
    }
    
    public BytesArrayDoubleMap(String dbPath, String dbName, int cacheSize) {
    ...
    public void optimize() {
        try {
            ...
            for (Entry<byte[], Double> entry : this.entrySet()) {
    ...
    public void putAll(Map<? extends byte[], ? extends Double> m) {
        try {
            ...
            int counter = 0;
            for (Map.Entry<? extends byte[], ? extends Double> e : m
                    .entrySet()) {
    ...
    @Override
    public Set<java.util.Map.Entry<byte[], Double>> entrySet() {
        return new MapEntrySet<byte[], Double>(this, this.keyDeSerFunc,
                this.valDeSerFunc);
    }
