...
public class IntegerDoubleMap extends LargeCollection implements   Map<Integer,Double>, Serializable{
    ...
    public IntegerDoubleMap() {
        super();
    }
    
    public IntegerDoubleMap(String dbName) {
        super(dbName);
    }
    
    public IntegerDoubleMap(String dbPath, String dbName) {
        super(dbPath, dbName);
    }
    
    public IntegerDoubleMap(String dbPath, String dbName, int cacheSize) {
    ...
    public void putAll(Map<? extends Integer, ? extends Double> m) {
        try {
            ...
            int counter = 0;
            for (Map.Entry<? extends Integer, ? extends Double> e : m
                    .entrySet()) {
    ...
    public Set<java.util.Map.Entry<Integer, Double>> entrySet() {
        return new MapEntrySet<Integer, Double>(this, this.keyDeSerFunc,
                this.valDeSerFunc);
    }
