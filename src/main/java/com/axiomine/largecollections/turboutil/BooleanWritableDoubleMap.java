...
public class BooleanWritableDoubleMap extends LargeCollection implements   Map<BooleanWritable,Double>, Serializable{
    ...
    public BooleanWritableDoubleMap() {
        super();
    }
    
    public BooleanWritableDoubleMap(String dbName) {
        super(dbName);
    }
    
    public BooleanWritableDoubleMap(String dbPath, String dbName) {
        super(dbPath, dbName);
    }
    
    public BooleanWritableDoubleMap(String dbPath, String dbName, int cacheSize) {
    ...
    public void optimize() {
        try {
            ...
            for (Entry<BooleanWritable, Double> entry : this.entrySet()) {
    ...
    @Override
    public Double put(BooleanWritable key, Double value) {
        if (key == null)
            return null;
    ...
    @Override
    public void putAll(Map<? extends BooleanWritable, ? extends Double> m) {
        try {
            WriteBatch batch = db.createWriteBatch();
            int counter = 0;
            for (Map.Entry<? extends BooleanWritable, ? extends Double> e : m
                    .entrySet()) {
    ...
    @Override
    public Set<java.util.Map.Entry<BooleanWritable, Double>> entrySet() {
        return new MapEntrySet<BooleanWritable, Double>(this, this.keyDeSerFunc,
                this.valDeSerFunc);
    }
