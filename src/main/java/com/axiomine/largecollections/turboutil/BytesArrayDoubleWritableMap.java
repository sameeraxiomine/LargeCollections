...
public class BytesArrayDoubleWritableMap extends LargeCollection implements   Map<byte[],DoubleWritable>, Serializable{
    ...
    public BytesArrayDoubleWritableMap() {
        super();
    }
    
    public BytesArrayDoubleWritableMap(String dbName) {
        super(dbName);
    }
    
    public BytesArrayDoubleWritableMap(String dbPath, String dbName) {
        super(dbPath, dbName);
    }
    
    public BytesArrayDoubleWritableMap(String dbPath, String dbName, int cacheSize) {
