...
public class LongIntWritableMap extends LargeCollection implements   Map<Long,IntWritable>, Serializable{
    ...
    public LongIntWritableMap() {
        super();
    }
    
    public LongIntWritableMap(String dbName) {
        super(dbName);
    }
    
    public LongIntWritableMap(String dbPath, String dbName) {
        super(dbPath, dbName);
    }
    
    public LongIntWritableMap(String dbPath, String dbName, int cacheSize) {
    ...
    @Override
    public IntWritable put(Long key, IntWritable value) {
        if (key == null)
            return null;
    ...
    @Override
    public void putAll(Map<? extends Long, ? extends IntWritable> m) {
        try {
            WriteBatch batch = db.createWriteBatch();
            int counter = 0;
            for (Map.Entry<? extends Long, ? extends IntWritable> e : m
                    .entrySet()) {
    ...
    @Override
    public Set<java.util.Map.Entry<Long, IntWritable>> entrySet() {
        return new MapEntrySet<Long, IntWritable>(this, this.keyDeSerFunc,
                this.valDeSerFunc);
    }
