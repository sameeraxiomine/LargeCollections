...
public class IntWritableFloatWritableMap extends LargeCollection implements   Map<IntWritable,FloatWritable>, Serializable{
    ...
    public IntWritableFloatWritableMap() {
        super();
    }
    
    public IntWritableFloatWritableMap(String dbName) {
        super(dbName);
    }
    
    public IntWritableFloatWritableMap(String dbPath, String dbName) {
        super(dbPath, dbName);
    }
    
    public IntWritableFloatWritableMap(String dbPath, String dbName, int cacheSize) {
    ...
    public void optimize() {
        try {
            ...
            for (Entry<IntWritable, FloatWritable> entry : this.entrySet()) {
    ...
    @Override
    public FloatWritable put(IntWritable key, FloatWritable value) {
        if (key == null)
            return null;
    ...
    @Override
    public void putAll(Map<? extends IntWritable, ? extends FloatWritable> m) {
        try {
            WriteBatch batch = db.createWriteBatch();
            int counter = 0;
            for (Map.Entry<? extends IntWritable, ? extends FloatWritable> e : m
                    .entrySet()) {
    ...
    @Override
    public Set<java.util.Map.Entry<IntWritable, FloatWritable>> entrySet() {
        return new MapEntrySet<IntWritable, FloatWritable>(this, this.keyDeSerFunc,
                this.valDeSerFunc);
    }
