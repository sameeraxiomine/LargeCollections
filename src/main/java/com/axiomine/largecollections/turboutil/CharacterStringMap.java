...
public class CharacterStringMap extends LargeCollection implements   Map<Character,String>, Serializable{
    ...
    public CharacterStringMap() {
        super();
    }
    
    public CharacterStringMap(String dbName) {
        super(dbName);
    }
    
    public CharacterStringMap(String dbPath, String dbName) {
        super(dbPath, dbName);
    }
    
    public CharacterStringMap(String dbPath, String dbName, int cacheSize) {
    ...
    public void optimize() {
        try {
            ...
            for (Entry<Character, String> entry : this.entrySet()) {
    ...
    public void putAll(Map<? extends Character, ? extends String> m) {
        try {
            ...
            int counter = 0;
            for (Map.Entry<? extends Character, ? extends String> e : m
                    .entrySet()) {
    ...
    @Override
    public Set<java.util.Map.Entry<Character, String>> entrySet() {
        return new MapEntrySet<Character, String>(this, this.keyDeSerFunc,
                this.valDeSerFunc);
    }
