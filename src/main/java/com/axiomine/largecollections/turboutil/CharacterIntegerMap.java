...
public class CharacterIntegerMap extends LargeCollection implements   Map<Character,Integer>, Serializable{
    ...
    public CharacterIntegerMap(String dbName) {
        super(dbName);
    }
    
    public CharacterIntegerMap(String dbPath, String dbName) {
        super(dbPath, dbName);
    }
    
    public CharacterIntegerMap(String dbPath, String dbName, int cacheSize) {
    ...
    public void optimize() {
        try {
            ...
            for (Entry<Character, Integer> entry : this.entrySet()) {
    ...
    public void putAll(Map<? extends Character, ? extends Integer> m) {
        try {
            ...
            int counter = 0;
            for (Map.Entry<? extends Character, ? extends Integer> e : m
                    .entrySet()) {
    ...
    @Override
    public Set<java.util.Map.Entry<Character, Integer>> entrySet() {
        return new MapEntrySet<Character, Integer>(this, this.keyDeSerFunc,
                this.valDeSerFunc);
    }
