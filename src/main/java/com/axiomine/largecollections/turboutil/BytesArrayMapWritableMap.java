...
public class BytesArrayMapWritableMap extends LargeCollection implements   Map<byte[],MapWritable>, Serializable{
    ...
    public BytesArrayMapWritableMap() {
        super();
    }
    
    public BytesArrayMapWritableMap(String dbName) {
        super(dbName);
    }
    
    public BytesArrayMapWritableMap(String dbPath, String dbName) {
        super(dbPath, dbName);
    }
    
    public BytesArrayMapWritableMap(String dbPath, String dbName, int cacheSize) {
