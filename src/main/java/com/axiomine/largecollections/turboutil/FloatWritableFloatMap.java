...
public class FloatWritableFloatMap extends LargeCollection implements   Map<FloatWritable,Float>, Serializable{
    ...
    public FloatWritableFloatMap() {
        super();
    }
    
    public FloatWritableFloatMap(String dbName) {
        super(dbName);
    }
    
    public FloatWritableFloatMap(String dbPath, String dbName) {
        super(dbPath, dbName);
    }
    
    public FloatWritableFloatMap(String dbPath, String dbName, int cacheSize) {
    ...
    public void optimize() {
        try {
            ...
            for (Entry<FloatWritable, Float> entry : this.entrySet()) {
    ...
    @Override
    public Float put(FloatWritable key, Float value) {
        if (key == null)
            return null;
    ...
    @Override
    public void putAll(Map<? extends FloatWritable, ? extends Float> m) {
        try {
            WriteBatch batch = db.createWriteBatch();
            int counter = 0;
            for (Map.Entry<? extends FloatWritable, ? extends Float> e : m
                    .entrySet()) {
    ...
    @Override
    public Set<java.util.Map.Entry<FloatWritable, Float>> entrySet() {
        return new MapEntrySet<FloatWritable, Float>(this, this.keyDeSerFunc,
                this.valDeSerFunc);
    }
