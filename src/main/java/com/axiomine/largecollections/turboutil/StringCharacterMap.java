...
public class StringCharacterMap extends LargeCollection implements   Map<String,Character>, Serializable{
    ...
    public StringCharacterMap() {
        super();
    }
    
    public StringCharacterMap(String dbName) {
        super(dbName);
    }
    
    public StringCharacterMap(String dbPath, String dbName) {
        super(dbPath, dbName);
    }
    
    public StringCharacterMap(String dbPath, String dbName, int cacheSize) {
    ...
    public void optimize() {
        try {
            ...
            for (Entry<String, Character> entry : this.entrySet()) {
    ...
    public void putAll(Map<? extends String, ? extends Character> m) {
        try {
            ...
            int counter = 0;
            for (Map.Entry<? extends String, ? extends Character> e : m
                    .entrySet()) {
    ...
    @Override
    public Set<java.util.Map.Entry<String, Character>> entrySet() {
        return new MapEntrySet<String, Character>(this, this.keyDeSerFunc,
                this.valDeSerFunc);
    }
