...
public class BooleanWritableIntegerMap extends LargeCollection implements   Map<BooleanWritable,Integer>, Serializable{
    ...
    public BooleanWritableIntegerMap() {
        super();
    }
    
    public BooleanWritableIntegerMap(String dbName) {
        super(dbName);
    }
    
    public BooleanWritableIntegerMap(String dbPath, String dbName) {
        super(dbPath, dbName);
    }
    
    public BooleanWritableIntegerMap(String dbPath, String dbName, int cacheSize) {
    ...
    public void optimize() {
        try {
            ...
            for (Entry<BooleanWritable, Integer> entry : this.entrySet()) {
    ...
    @Override
    public Integer put(BooleanWritable key, Integer value) {
        if (key == null)
            return null;
    ...
    @Override
    public void putAll(Map<? extends BooleanWritable, ? extends Integer> m) {
        try {
            WriteBatch batch = db.createWriteBatch();
            int counter = 0;
            for (Map.Entry<? extends BooleanWritable, ? extends Integer> e : m
                    .entrySet()) {
    ...
    @Override
    public Set<java.util.Map.Entry<BooleanWritable, Integer>> entrySet() {
        return new MapEntrySet<BooleanWritable, Integer>(this, this.keyDeSerFunc,
                this.valDeSerFunc);
    }
