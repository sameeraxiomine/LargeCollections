...
public class LongWritableBytesWritableMap extends LargeCollection implements   Map<LongWritable,BytesWritable>, Serializable{
    ...
    public LongWritableBytesWritableMap() {
        super();
    }
    
    public LongWritableBytesWritableMap(String dbName) {
        super(dbName);
    }
    
    public LongWritableBytesWritableMap(String dbPath, String dbName) {
        super(dbPath, dbName);
    }
    
    public LongWritableBytesWritableMap(String dbPath, String dbName, int cacheSize) {
    ...
    public void optimize() {
        try {
            ...
            for (Entry<LongWritable, BytesWritable> entry : this.entrySet()) {
    ...
    @Override
    public BytesWritable put(LongWritable key, BytesWritable value) {
        if (key == null)
            return null;
    ...
    @Override
    public void putAll(Map<? extends LongWritable, ? extends BytesWritable> m) {
        try {
            WriteBatch batch = db.createWriteBatch();
            int counter = 0;
            for (Map.Entry<? extends LongWritable, ? extends BytesWritable> e : m
                    .entrySet()) {
    ...
    @Override
    public Set<java.util.Map.Entry<LongWritable, BytesWritable>> entrySet() {
        return new MapEntrySet<LongWritable, BytesWritable>(this, this.keyDeSerFunc,
                this.valDeSerFunc);
    }
