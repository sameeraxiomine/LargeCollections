...
public class MapWritableTextMap extends LargeCollection implements   Map<MapWritable,Text>, Serializable{
    ...
    public MapWritableTextMap() {
        super();
    }
    
    public MapWritableTextMap(String dbName) {
        super(dbName);
    }
    
    public MapWritableTextMap(String dbPath, String dbName) {
        super(dbPath, dbName);
    }
    
    public MapWritableTextMap(String dbPath, String dbName, int cacheSize) {
    ...
    public void optimize() {
        try {
            ...
            for (Entry<MapWritable, Text> entry : this.entrySet()) {
    ...
    @Override
    public Text put(MapWritable key, Text value) {
        if (key == null)
            return null;
    ...
    @Override
    public void putAll(Map<? extends MapWritable, ? extends Text> m) {
        try {
            WriteBatch batch = db.createWriteBatch();
            int counter = 0;
            for (Map.Entry<? extends MapWritable, ? extends Text> e : m
                    .entrySet()) {
    ...
    @Override
    public Set<java.util.Map.Entry<MapWritable, Text>> entrySet() {
        return new MapEntrySet<MapWritable, Text>(this, this.keyDeSerFunc,
                this.valDeSerFunc);
    }
