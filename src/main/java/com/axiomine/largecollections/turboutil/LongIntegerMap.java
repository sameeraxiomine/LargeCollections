...
public class LongIntegerMap extends LargeCollection implements   Map<Long,Integer>, Serializable{
    ...
    public LongIntegerMap() {
        super();
    }
    
    public LongIntegerMap(String dbName) {
        super(dbName);
    }
    
    public LongIntegerMap(String dbPath, String dbName) {
        super(dbPath, dbName);
    }
    
    public LongIntegerMap(String dbPath, String dbName, int cacheSize) {
    ...
    public void putAll(Map<? extends Long, ? extends Integer> m) {
        try {
            ...
            int counter = 0;
            for (Map.Entry<? extends Long, ? extends Integer> e : m
                    .entrySet()) {
    ...
    public Set<java.util.Map.Entry<Long, Integer>> entrySet() {
        return new MapEntrySet<Long, Integer>(this, this.keyDeSerFunc,
                this.valDeSerFunc);
    }
