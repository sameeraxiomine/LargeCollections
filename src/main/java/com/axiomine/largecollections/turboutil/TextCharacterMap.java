...
public class TextCharacterMap extends LargeCollection implements   Map<Text,Character>, Serializable{
    ...
    public TextCharacterMap() {
        super();
    }
    
    public TextCharacterMap(String dbName) {
        super(dbName);
    }
    
    public TextCharacterMap(String dbPath, String dbName) {
        super(dbPath, dbName);
    }
    
    public TextCharacterMap(String dbPath, String dbName, int cacheSize) {
    ...
    public void optimize() {
        try {
            ...
            for (Entry<Text, Character> entry : this.entrySet()) {
    ...
    @Override
    public Character put(Text key, Character value) {
        if (key == null)
            return null;
    ...
    @Override
    public void putAll(Map<? extends Text, ? extends Character> m) {
        try {
            WriteBatch batch = db.createWriteBatch();
            int counter = 0;
            for (Map.Entry<? extends Text, ? extends Character> e : m
                    .entrySet()) {
    ...
    @Override
    public Set<java.util.Map.Entry<Text, Character>> entrySet() {
        return new MapEntrySet<Text, Character>(this, this.keyDeSerFunc,
                this.valDeSerFunc);
    }
