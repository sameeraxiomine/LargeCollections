...
public class MapWritableByteMap extends LargeCollection implements   Map<MapWritable,Byte>, Serializable{
    ...
    public MapWritableByteMap() {
        super();
    }
    
    public MapWritableByteMap(String dbName) {
        super(dbName);
    }
    
    public MapWritableByteMap(String dbPath, String dbName) {
        super(dbPath, dbName);
    }
    
    public MapWritableByteMap(String dbPath, String dbName, int cacheSize) {
