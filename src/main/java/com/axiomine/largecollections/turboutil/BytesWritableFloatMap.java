...
public class BytesWritableFloatMap extends LargeCollection implements   Map<BytesWritable,Float>, Serializable{
    ...
    public BytesWritableFloatMap() {
        super();
    }
    
    public BytesWritableFloatMap(String dbName) {
        super(dbName);
    }
    
    public BytesWritableFloatMap(String dbPath, String dbName) {
        super(dbPath, dbName);
    }
    
    public BytesWritableFloatMap(String dbPath, String dbName, int cacheSize) {
    ...
    @Override
    public Float put(BytesWritable key, Float value) {
        if (key == null)
            return null;
    ...
    @Override
    public void putAll(Map<? extends BytesWritable, ? extends Float> m) {
        try {
            WriteBatch batch = db.createWriteBatch();
            int counter = 0;
            for (Map.Entry<? extends BytesWritable, ? extends Float> e : m
                    .entrySet()) {
    ...
    @Override
    public Set<java.util.Map.Entry<BytesWritable, Float>> entrySet() {
        return new MapEntrySet<BytesWritable, Float>(this, this.keyDeSerFunc,
                this.valDeSerFunc);
    }
