...
public class FloatWritableMapWritableMap extends LargeCollection implements   Map<FloatWritable,MapWritable>, Serializable{
    ...
    public FloatWritableMapWritableMap() {
        super();
    }
    
    public FloatWritableMapWritableMap(String dbName) {
        super(dbName);
    }
    
    public FloatWritableMapWritableMap(String dbPath, String dbName) {
        super(dbPath, dbName);
    }
    
    public FloatWritableMapWritableMap(String dbPath, String dbName, int cacheSize) {
    ...
    public void optimize() {
        try {
            ...
            for (Entry<FloatWritable, MapWritable> entry : this.entrySet()) {
    ...
    @Override
    public MapWritable put(FloatWritable key, MapWritable value) {
        if (key == null)
            return null;
    ...
    @Override
    public void putAll(Map<? extends FloatWritable, ? extends MapWritable> m) {
        try {
            WriteBatch batch = db.createWriteBatch();
            int counter = 0;
            for (Map.Entry<? extends FloatWritable, ? extends MapWritable> e : m
                    .entrySet()) {
    ...
    @Override
    public Set<java.util.Map.Entry<FloatWritable, MapWritable>> entrySet() {
        return new MapEntrySet<FloatWritable, MapWritable>(this, this.keyDeSerFunc,
                this.valDeSerFunc);
    }
