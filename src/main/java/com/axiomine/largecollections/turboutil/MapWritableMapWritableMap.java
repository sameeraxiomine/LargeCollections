...
public class MapWritableMapWritableMap extends LargeCollection implements   Map<MapWritable,MapWritable>, Serializable{
    ...
    public MapWritableMapWritableMap() {
        super();
    }
    
    public MapWritableMapWritableMap(String dbName) {
        super(dbName);
    }
    
    public MapWritableMapWritableMap(String dbPath, String dbName) {
        super(dbPath, dbName);
    }
    
    public MapWritableMapWritableMap(String dbPath, String dbName, int cacheSize) {
    ...
    public void optimize() {
        try {
            ...
            for (Entry<MapWritable, MapWritable> entry : this.entrySet()) {
    ...
    @Override
    public MapWritable put(MapWritable key, MapWritable value) {
        if (key == null)
            return null;
    ...
    @Override
    public void putAll(Map<? extends MapWritable, ? extends MapWritable> m) {
        try {
            WriteBatch batch = db.createWriteBatch();
            int counter = 0;
            for (Map.Entry<? extends MapWritable, ? extends MapWritable> e : m
                    .entrySet()) {
    ...
    @Override
    public Set<java.util.Map.Entry<MapWritable, MapWritable>> entrySet() {
        return new MapEntrySet<MapWritable, MapWritable>(this, this.keyDeSerFunc,
                this.valDeSerFunc);
    }
