...
public class DoubleWritableFloatWritableMap extends LargeCollection implements   Map<DoubleWritable,FloatWritable>, Serializable{
    ...
    public DoubleWritableFloatWritableMap() {
        super();
    }
    
    public DoubleWritableFloatWritableMap(String dbName) {
        super(dbName);
    }
    
    public DoubleWritableFloatWritableMap(String dbPath, String dbName) {
        super(dbPath, dbName);
    }
    
    public DoubleWritableFloatWritableMap(String dbPath, String dbName, int cacheSize) {
    ...
    public void optimize() {
        try {
            ...
            for (Entry<DoubleWritable, FloatWritable> entry : this.entrySet()) {
    ...
    @Override
    public FloatWritable put(DoubleWritable key, FloatWritable value) {
        if (key == null)
            return null;
    ...
    @Override
    public void putAll(Map<? extends DoubleWritable, ? extends FloatWritable> m) {
        try {
            WriteBatch batch = db.createWriteBatch();
            int counter = 0;
            for (Map.Entry<? extends DoubleWritable, ? extends FloatWritable> e : m
                    .entrySet()) {
    ...
    @Override
    public Set<java.util.Map.Entry<DoubleWritable, FloatWritable>> entrySet() {
        return new MapEntrySet<DoubleWritable, FloatWritable>(this, this.keyDeSerFunc,
                this.valDeSerFunc);
    }
