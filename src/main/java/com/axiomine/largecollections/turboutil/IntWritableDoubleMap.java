...
public class IntWritableDoubleMap extends LargeCollection implements   Map<IntWritable,Double>, Serializable{
    ...
    public IntWritableDoubleMap() {
        super();
    }
    
    public IntWritableDoubleMap(String dbName) {
        super(dbName);
    }
    
    public IntWritableDoubleMap(String dbPath, String dbName) {
        super(dbPath, dbName);
    }
    
    public IntWritableDoubleMap(String dbPath, String dbName, int cacheSize) {
    ...
    public void optimize() {
        try {
            ...
            for (Entry<IntWritable, Double> entry : this.entrySet()) {
    ...
    @Override
    public Double put(IntWritable key, Double value) {
        if (key == null)
            return null;
    ...
    @Override
    public void putAll(Map<? extends IntWritable, ? extends Double> m) {
        try {
            WriteBatch batch = db.createWriteBatch();
            int counter = 0;
            for (Map.Entry<? extends IntWritable, ? extends Double> e : m
                    .entrySet()) {
    ...
    @Override
    public Set<java.util.Map.Entry<IntWritable, Double>> entrySet() {
        return new MapEntrySet<IntWritable, Double>(this, this.keyDeSerFunc,
                this.valDeSerFunc);
    }
