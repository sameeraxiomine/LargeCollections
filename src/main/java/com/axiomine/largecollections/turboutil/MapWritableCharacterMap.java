...
public class MapWritableCharacterMap extends LargeCollection implements   Map<MapWritable,Character>, Serializable{
    ...
    public MapWritableCharacterMap() {
        super();
    }
    
    public MapWritableCharacterMap(String dbName) {
        super(dbName);
    }
    
    public MapWritableCharacterMap(String dbPath, String dbName) {
        super(dbPath, dbName);
    }
    
    public MapWritableCharacterMap(String dbPath, String dbName, int cacheSize) {
    ...
    public void optimize() {
        try {
            ...
            for (Entry<MapWritable, Character> entry : this.entrySet()) {
    ...
    @Override
    public Character put(MapWritable key, Character value) {
        if (key == null)
            return null;
    ...
    @Override
    public void putAll(Map<? extends MapWritable, ? extends Character> m) {
        try {
            WriteBatch batch = db.createWriteBatch();
            int counter = 0;
            for (Map.Entry<? extends MapWritable, ? extends Character> e : m
                    .entrySet()) {
    ...
    @Override
    public Set<java.util.Map.Entry<MapWritable, Character>> entrySet() {
        return new MapEntrySet<MapWritable, Character>(this, this.keyDeSerFunc,
                this.valDeSerFunc);
    }
