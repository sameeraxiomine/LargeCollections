...
public class ByteDoubleMap extends LargeCollection implements   Map<Byte,Double>, Serializable{
    ...
    public ByteDoubleMap() {
        super();
    }
    
    public ByteDoubleMap(String dbName) {
        super(dbName);
    }
    
    public ByteDoubleMap(String dbPath, String dbName) {
        super(dbPath, dbName);
    }
    
    public ByteDoubleMap(String dbPath, String dbName, int cacheSize) {
