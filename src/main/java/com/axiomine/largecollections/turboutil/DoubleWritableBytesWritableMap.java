...
public class DoubleWritableBytesWritableMap extends LargeCollection implements   Map<DoubleWritable,BytesWritable>, Serializable{
    ...
    public DoubleWritableBytesWritableMap() {
        super();
    }
    
    public DoubleWritableBytesWritableMap(String dbName) {
        super(dbName);
    }
    
    public DoubleWritableBytesWritableMap(String dbPath, String dbName) {
        super(dbPath, dbName);
    }
    
    public DoubleWritableBytesWritableMap(String dbPath, String dbName, int cacheSize) {
    ...
    public void optimize() {
        try {
            ...
            for (Entry<DoubleWritable, BytesWritable> entry : this.entrySet()) {
    ...
    @Override
    public BytesWritable put(DoubleWritable key, BytesWritable value) {
        if (key == null)
            return null;
    ...
    @Override
    public void putAll(Map<? extends DoubleWritable, ? extends BytesWritable> m) {
        try {
            WriteBatch batch = db.createWriteBatch();
            int counter = 0;
            for (Map.Entry<? extends DoubleWritable, ? extends BytesWritable> e : m
                    .entrySet()) {
    ...
    @Override
    public Set<java.util.Map.Entry<DoubleWritable, BytesWritable>> entrySet() {
        return new MapEntrySet<DoubleWritable, BytesWritable>(this, this.keyDeSerFunc,
                this.valDeSerFunc);
    }
