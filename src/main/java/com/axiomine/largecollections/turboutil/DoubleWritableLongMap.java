...
public class DoubleWritableLongMap extends LargeCollection implements   Map<DoubleWritable,Long>, Serializable{
    ...
    public DoubleWritableLongMap() {
        super();
    }
    
    public DoubleWritableLongMap(String dbName) {
        super(dbName);
    }
    
    public DoubleWritableLongMap(String dbPath, String dbName) {
        super(dbPath, dbName);
    }
    
    public DoubleWritableLongMap(String dbPath, String dbName, int cacheSize) {
    ...
    public void optimize() {
        try {
            ...
            for (Entry<DoubleWritable, Long> entry : this.entrySet()) {
    ...
    @Override
    public Long put(DoubleWritable key, Long value) {
        if (key == null)
            return null;
    ...
    @Override
    public void putAll(Map<? extends DoubleWritable, ? extends Long> m) {
        try {
            WriteBatch batch = db.createWriteBatch();
            int counter = 0;
            for (Map.Entry<? extends DoubleWritable, ? extends Long> e : m
                    .entrySet()) {
    ...
    @Override
    public Set<java.util.Map.Entry<DoubleWritable, Long>> entrySet() {
        return new MapEntrySet<DoubleWritable, Long>(this, this.keyDeSerFunc,
                this.valDeSerFunc);
    }
