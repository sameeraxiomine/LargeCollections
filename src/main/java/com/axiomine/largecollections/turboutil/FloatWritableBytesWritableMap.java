...
public class FloatWritableBytesWritableMap extends LargeCollection implements   Map<FloatWritable,BytesWritable>, Serializable{
    ...
    public FloatWritableBytesWritableMap() {
        super();
    }
    
    public FloatWritableBytesWritableMap(String dbName) {
        super(dbName);
    }
    
    public FloatWritableBytesWritableMap(String dbPath, String dbName) {
        super(dbPath, dbName);
    }
    
    public FloatWritableBytesWritableMap(String dbPath, String dbName, int cacheSize) {
    ...
    @Override
    public BytesWritable put(FloatWritable key, BytesWritable value) {
        if (key == null)
            return null;
    ...
    @Override
    public void putAll(Map<? extends FloatWritable, ? extends BytesWritable> m) {
        try {
            WriteBatch batch = db.createWriteBatch();
            int counter = 0;
            for (Map.Entry<? extends FloatWritable, ? extends BytesWritable> e : m
                    .entrySet()) {
    ...
    @Override
    public Set<java.util.Map.Entry<FloatWritable, BytesWritable>> entrySet() {
        return new MapEntrySet<FloatWritable, BytesWritable>(this, this.keyDeSerFunc,
                this.valDeSerFunc);
    }
