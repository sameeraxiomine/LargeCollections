...
public class BytesWritableBytesWritableMap extends LargeCollection implements   Map<BytesWritable,BytesWritable>, Serializable{
    ...
    public BytesWritableBytesWritableMap() {
        super();
    }
    
    public BytesWritableBytesWritableMap(String dbName) {
        super(dbName);
    }
    
    public BytesWritableBytesWritableMap(String dbPath, String dbName) {
        super(dbPath, dbName);
    }
    
    public BytesWritableBytesWritableMap(String dbPath, String dbName, int cacheSize) {
    ...
    @Override
    public BytesWritable put(BytesWritable key, BytesWritable value) {
        if (key == null)
            return null;
    ...
    @Override
    public void putAll(Map<? extends BytesWritable, ? extends BytesWritable> m) {
        try {
            WriteBatch batch = db.createWriteBatch();
            int counter = 0;
            for (Map.Entry<? extends BytesWritable, ? extends BytesWritable> e : m
                    .entrySet()) {
    ...
    @Override
    public Set<java.util.Map.Entry<BytesWritable, BytesWritable>> entrySet() {
        return new MapEntrySet<BytesWritable, BytesWritable>(this, this.keyDeSerFunc,
                this.valDeSerFunc);
    }
