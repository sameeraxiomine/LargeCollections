...
public class FloatFloatMap extends LargeCollection implements   Map<Float,Float>, Serializable{
    ...
    public FloatFloatMap(String dbName) {
        super(dbName);
    }
    
    public FloatFloatMap(String dbPath, String dbName) {
        super(dbPath, dbName);
    }
    
    public FloatFloatMap(String dbPath, String dbName, int cacheSize) {
    ...
    public void optimize() {
        try {
            ...
            for (Entry<Float, Float> entry : this.entrySet()) {
    ...
    public void putAll(Map<? extends Float, ? extends Float> m) {
        try {
            ...
            int counter = 0;
            for (Map.Entry<? extends Float, ? extends Float> e : m
                    .entrySet()) {
    ...
    @Override
    public Set<java.util.Map.Entry<Float, Float>> entrySet() {
        return new MapEntrySet<Float, Float>(this, this.keyDeSerFunc,
                this.valDeSerFunc);
    }
