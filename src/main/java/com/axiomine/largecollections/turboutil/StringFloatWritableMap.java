...
public class StringFloatWritableMap extends LargeCollection implements   Map<String,FloatWritable>, Serializable{
    ...
    public StringFloatWritableMap() {
        super();
    }
    
    public StringFloatWritableMap(String dbName) {
        super(dbName);
    }
    
    public StringFloatWritableMap(String dbPath, String dbName) {
        super(dbPath, dbName);
    }
    
    public StringFloatWritableMap(String dbPath, String dbName, int cacheSize) {
    ...
    public void optimize() {
        try {
            ...
            for (Entry<String, FloatWritable> entry : this.entrySet()) {
    ...
    @Override
    public FloatWritable put(String key, FloatWritable value) {
        if (key == null)
            return null;
    ...
    @Override
    public void putAll(Map<? extends String, ? extends FloatWritable> m) {
        try {
            WriteBatch batch = db.createWriteBatch();
            int counter = 0;
            for (Map.Entry<? extends String, ? extends FloatWritable> e : m
                    .entrySet()) {
    ...
    @Override
    public Set<java.util.Map.Entry<String, FloatWritable>> entrySet() {
        return new MapEntrySet<String, FloatWritable>(this, this.keyDeSerFunc,
                this.valDeSerFunc);
    }
