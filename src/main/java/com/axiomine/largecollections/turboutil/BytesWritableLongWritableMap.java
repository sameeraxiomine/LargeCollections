...
public class BytesWritableLongWritableMap extends LargeCollection implements   Map<BytesWritable,LongWritable>, Serializable{
    ...
    public BytesWritableLongWritableMap() {
        super();
    }
    
    public BytesWritableLongWritableMap(String dbName) {
        super(dbName);
    }
    
    public BytesWritableLongWritableMap(String dbPath, String dbName) {
        super(dbPath, dbName);
    }
    
    public BytesWritableLongWritableMap(String dbPath, String dbName, int cacheSize) {
    ...
    @Override
    public LongWritable put(BytesWritable key, LongWritable value) {
        if (key == null)
            return null;
    ...
    @Override
    public void putAll(Map<? extends BytesWritable, ? extends LongWritable> m) {
        try {
            WriteBatch batch = db.createWriteBatch();
            int counter = 0;
            for (Map.Entry<? extends BytesWritable, ? extends LongWritable> e : m
                    .entrySet()) {
    ...
    @Override
    public Set<java.util.Map.Entry<BytesWritable, LongWritable>> entrySet() {
        return new MapEntrySet<BytesWritable, LongWritable>(this, this.keyDeSerFunc,
                this.valDeSerFunc);
    }
