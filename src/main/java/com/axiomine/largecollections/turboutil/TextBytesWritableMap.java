...
public class TextBytesWritableMap extends LargeCollection implements   Map<Text,BytesWritable>, Serializable{
    ...
    public TextBytesWritableMap() {
        super();
    }
    
    public TextBytesWritableMap(String dbName) {
        super(dbName);
    }
    
    public TextBytesWritableMap(String dbPath, String dbName) {
        super(dbPath, dbName);
    }
    
    public TextBytesWritableMap(String dbPath, String dbName, int cacheSize) {
    ...
    public void optimize() {
        try {
            ...
            for (Entry<Text, BytesWritable> entry : this.entrySet()) {
    ...
    @Override
    public BytesWritable put(Text key, BytesWritable value) {
        if (key == null)
            return null;
    ...
    @Override
    public void putAll(Map<? extends Text, ? extends BytesWritable> m) {
        try {
            WriteBatch batch = db.createWriteBatch();
            int counter = 0;
            for (Map.Entry<? extends Text, ? extends BytesWritable> e : m
                    .entrySet()) {
    ...
    @Override
    public Set<java.util.Map.Entry<Text, BytesWritable>> entrySet() {
        return new MapEntrySet<Text, BytesWritable>(this, this.keyDeSerFunc,
                this.valDeSerFunc);
    }
