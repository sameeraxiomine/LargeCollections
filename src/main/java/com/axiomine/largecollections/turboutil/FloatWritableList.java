...
public class FloatWritableList extends LargeCollection implements List<FloatWritable>, Serializable {
    ...
    public void optimize() {
        try {
            ...
            MapEntryIterator<Integer, FloatWritable> iterator = new MapEntryIterator(this, new WritableSerDes.FloatWritableDeSerFunction(),tDeSerFunc);
            while(iterator.hasNext()){
                Entry<Integer, FloatWritable> entry = iterator.next();
