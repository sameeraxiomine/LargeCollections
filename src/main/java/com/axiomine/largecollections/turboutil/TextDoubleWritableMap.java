...
public class TextDoubleWritableMap extends LargeCollection implements   Map<Text,DoubleWritable>, Serializable{
    ...
    public TextDoubleWritableMap() {
        super();
    }
    
    public TextDoubleWritableMap(String dbName) {
        super(dbName);
    }
    
    public TextDoubleWritableMap(String dbPath, String dbName) {
        super(dbPath, dbName);
    }
    
    public TextDoubleWritableMap(String dbPath, String dbName, int cacheSize) {
    ...
    public void optimize() {
        try {
            ...
            for (Entry<Text, DoubleWritable> entry : this.entrySet()) {
    ...
    @Override
    public DoubleWritable put(Text key, DoubleWritable value) {
        if (key == null)
            return null;
    ...
    @Override
    public void putAll(Map<? extends Text, ? extends DoubleWritable> m) {
        try {
            WriteBatch batch = db.createWriteBatch();
            int counter = 0;
            for (Map.Entry<? extends Text, ? extends DoubleWritable> e : m
                    .entrySet()) {
    ...
    @Override
    public Set<java.util.Map.Entry<Text, DoubleWritable>> entrySet() {
        return new MapEntrySet<Text, DoubleWritable>(this, this.keyDeSerFunc,
                this.valDeSerFunc);
    }
