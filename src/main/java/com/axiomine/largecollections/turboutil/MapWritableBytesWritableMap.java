...
public class MapWritableBytesWritableMap extends LargeCollection implements   Map<MapWritable,BytesWritable>, Serializable{
    ...
    public MapWritableBytesWritableMap() {
        super();
    }
    
    public MapWritableBytesWritableMap(String dbName) {
        super(dbName);
    }
    
    public MapWritableBytesWritableMap(String dbPath, String dbName) {
        super(dbPath, dbName);
    }
    
    public MapWritableBytesWritableMap(String dbPath, String dbName, int cacheSize) {
    ...
    public void optimize() {
        try {
            ...
            for (Entry<MapWritable, BytesWritable> entry : this.entrySet()) {
    ...
    @Override
    public BytesWritable put(MapWritable key, BytesWritable value) {
        if (key == null)
            return null;
    ...
    @Override
    public void putAll(Map<? extends MapWritable, ? extends BytesWritable> m) {
        try {
            WriteBatch batch = db.createWriteBatch();
            int counter = 0;
            for (Map.Entry<? extends MapWritable, ? extends BytesWritable> e : m
                    .entrySet()) {
    ...
    @Override
    public Set<java.util.Map.Entry<MapWritable, BytesWritable>> entrySet() {
        return new MapEntrySet<MapWritable, BytesWritable>(this, this.keyDeSerFunc,
                this.valDeSerFunc);
    }
