...
public class DoubleWritableLongWritableMap extends LargeCollection implements   Map<DoubleWritable,LongWritable>, Serializable{
    ...
    public DoubleWritableLongWritableMap() {
        super();
    }
    
    public DoubleWritableLongWritableMap(String dbName) {
        super(dbName);
    }
    
    public DoubleWritableLongWritableMap(String dbPath, String dbName) {
        super(dbPath, dbName);
    }
    
    public DoubleWritableLongWritableMap(String dbPath, String dbName, int cacheSize) {
    ...
    public void optimize() {
        try {
            ...
            for (Entry<DoubleWritable, LongWritable> entry : this.entrySet()) {
    ...
    @Override
    public LongWritable put(DoubleWritable key, LongWritable value) {
        if (key == null)
            return null;
    ...
    @Override
    public void putAll(Map<? extends DoubleWritable, ? extends LongWritable> m) {
        try {
            WriteBatch batch = db.createWriteBatch();
            int counter = 0;
            for (Map.Entry<? extends DoubleWritable, ? extends LongWritable> e : m
                    .entrySet()) {
    ...
    @Override
    public Set<java.util.Map.Entry<DoubleWritable, LongWritable>> entrySet() {
        return new MapEntrySet<DoubleWritable, LongWritable>(this, this.keyDeSerFunc,
                this.valDeSerFunc);
    }
