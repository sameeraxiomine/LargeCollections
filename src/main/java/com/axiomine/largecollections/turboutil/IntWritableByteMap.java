...
public class IntWritableByteMap extends LargeCollection implements   Map<IntWritable,Byte>, Serializable{
    ...
    public IntWritableByteMap() {
        super();
    }
    
    public IntWritableByteMap(String dbName) {
        super(dbName);
    }
    
    public IntWritableByteMap(String dbPath, String dbName) {
        super(dbPath, dbName);
    }
    
    public IntWritableByteMap(String dbPath, String dbName, int cacheSize) {
