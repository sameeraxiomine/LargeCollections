...
public class CharacterBooleanWritableMap extends LargeCollection implements   Map<Character,BooleanWritable>, Serializable{
    ...
    public CharacterBooleanWritableMap() {
        super();
    }
    
    public CharacterBooleanWritableMap(String dbName) {
        super(dbName);
    }
    
    public CharacterBooleanWritableMap(String dbPath, String dbName) {
        super(dbPath, dbName);
    }
    
    public CharacterBooleanWritableMap(String dbPath, String dbName, int cacheSize) {
    ...
    public void optimize() {
        try {
            ...
            for (Entry<Character, BooleanWritable> entry : this.entrySet()) {
    ...
    @Override
    public BooleanWritable put(Character key, BooleanWritable value) {
        if (key == null)
            return null;
    ...
    @Override
    public void putAll(Map<? extends Character, ? extends BooleanWritable> m) {
        try {
            WriteBatch batch = db.createWriteBatch();
            int counter = 0;
            for (Map.Entry<? extends Character, ? extends BooleanWritable> e : m
                    .entrySet()) {
    ...
    @Override
    public Set<java.util.Map.Entry<Character, BooleanWritable>> entrySet() {
        return new MapEntrySet<Character, BooleanWritable>(this, this.keyDeSerFunc,
                this.valDeSerFunc);
    }
