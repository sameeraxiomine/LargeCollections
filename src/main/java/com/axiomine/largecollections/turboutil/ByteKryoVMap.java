...
public class ByteKryoVMap<V> extends LargeCollection implements   Map<Byte,V>, Serializable{
    ...
    public ByteKryoVMap(String dbName) {
        super(dbName);
    }
    
    public ByteKryoVMap(String dbPath, String dbName) {
        super(dbPath, dbName);
    }
    
    public ByteKryoVMap(String dbPath, String dbName, int cacheSize) {
