...
public class LongWritableBytesArrayMap extends LargeCollection implements   Map<LongWritable,byte[]>, Serializable{
    ...
    public LongWritableBytesArrayMap() {
        super();
    }
    
    public LongWritableBytesArrayMap(String dbName) {
        super(dbName);
    }
    
    public LongWritableBytesArrayMap(String dbPath, String dbName) {
        super(dbPath, dbName);
    }
    
    public LongWritableBytesArrayMap(String dbPath, String dbName, int cacheSize) {
    ...
    public void optimize() {
        try {
            ...
            for (Entry<LongWritable, byte[]> entry : this.entrySet()) {
    ...
    @Override
    public byte[] put(LongWritable key, byte[] value) {
        if (key == null)
            return null;
    ...
    @Override
    public void putAll(Map<? extends LongWritable, ? extends byte[]> m) {
        try {
            WriteBatch batch = db.createWriteBatch();
            int counter = 0;
            for (Map.Entry<? extends LongWritable, ? extends byte[]> e : m
                    .entrySet()) {
    ...
    @Override
    public Set<java.util.Map.Entry<LongWritable, byte[]>> entrySet() {
        return new MapEntrySet<LongWritable, byte[]>(this, this.keyDeSerFunc,
                this.valDeSerFunc);
    }
