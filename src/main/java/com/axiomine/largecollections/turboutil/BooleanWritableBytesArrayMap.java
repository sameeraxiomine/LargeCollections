...
public class BooleanWritableBytesArrayMap extends LargeCollection implements   Map<BooleanWritable,byte[]>, Serializable{
    ...
    public BooleanWritableBytesArrayMap() {
        super();
    }
    
    public BooleanWritableBytesArrayMap(String dbName) {
        super(dbName);
    }
    
    public BooleanWritableBytesArrayMap(String dbPath, String dbName) {
        super(dbPath, dbName);
    }
    
    public BooleanWritableBytesArrayMap(String dbPath, String dbName, int cacheSize) {
    ...
    public void optimize() {
        try {
            ...
            for (Entry<BooleanWritable, byte[]> entry : this.entrySet()) {
    ...
    @Override
    public byte[] put(BooleanWritable key, byte[] value) {
        if (key == null)
            return null;
    ...
    @Override
    public void putAll(Map<? extends BooleanWritable, ? extends byte[]> m) {
        try {
            WriteBatch batch = db.createWriteBatch();
            int counter = 0;
            for (Map.Entry<? extends BooleanWritable, ? extends byte[]> e : m
                    .entrySet()) {
    ...
    @Override
    public Set<java.util.Map.Entry<BooleanWritable, byte[]>> entrySet() {
        return new MapEntrySet<BooleanWritable, byte[]>(this, this.keyDeSerFunc,
                this.valDeSerFunc);
    }
