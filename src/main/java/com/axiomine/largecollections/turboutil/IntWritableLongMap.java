...
public class IntWritableLongMap extends LargeCollection implements   Map<IntWritable,Long>, Serializable{
    ...
    public IntWritableLongMap() {
        super();
    }
    
    public IntWritableLongMap(String dbName) {
        super(dbName);
    }
    
    public IntWritableLongMap(String dbPath, String dbName) {
        super(dbPath, dbName);
    }
    
    public IntWritableLongMap(String dbPath, String dbName, int cacheSize) {
    ...
    public void optimize() {
        try {
            ...
            for (Entry<IntWritable, Long> entry : this.entrySet()) {
    ...
    @Override
    public Long put(IntWritable key, Long value) {
        if (key == null)
            return null;
    ...
    @Override
    public void putAll(Map<? extends IntWritable, ? extends Long> m) {
        try {
            WriteBatch batch = db.createWriteBatch();
            int counter = 0;
            for (Map.Entry<? extends IntWritable, ? extends Long> e : m
                    .entrySet()) {
    ...
    @Override
    public Set<java.util.Map.Entry<IntWritable, Long>> entrySet() {
        return new MapEntrySet<IntWritable, Long>(this, this.keyDeSerFunc,
                this.valDeSerFunc);
    }
