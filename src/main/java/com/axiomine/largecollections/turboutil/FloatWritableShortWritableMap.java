...
public class FloatWritableShortWritableMap extends LargeCollection implements   Map<FloatWritable,ShortWritable>, Serializable{
    ...
    public FloatWritableShortWritableMap(String dbName) {
        super(dbName);
    }
    
    public FloatWritableShortWritableMap(String dbPath, String dbName) {
        super(dbPath, dbName);
    }
    
    public FloatWritableShortWritableMap(String dbPath, String dbName, int cacheSize) {
    ...
    public void optimize() {
        try {
            ...
            for (Entry<FloatWritable, ShortWritable> entry : this.entrySet()) {
    ...
    @Override
    public ShortWritable put(FloatWritable key, ShortWritable value) {
        if (key == null)
            return null;
    ...
    @Override
    public void putAll(Map<? extends FloatWritable, ? extends ShortWritable> m) {
        try {
            WriteBatch batch = db.createWriteBatch();
            int counter = 0;
            for (Map.Entry<? extends FloatWritable, ? extends ShortWritable> e : m
                    .entrySet()) {
    ...
    @Override
    public Set<java.util.Map.Entry<FloatWritable, ShortWritable>> entrySet() {
        return new MapEntrySet<FloatWritable, ShortWritable>(this, this.keyDeSerFunc,
                this.valDeSerFunc);
    }
