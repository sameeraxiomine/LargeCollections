...
public class LongMapWritableMap extends LargeCollection implements   Map<Long,MapWritable>, Serializable{
    ...
    public LongMapWritableMap() {
        super();
    }
    
    public LongMapWritableMap(String dbName) {
        super(dbName);
    }
    
    public LongMapWritableMap(String dbPath, String dbName) {
        super(dbPath, dbName);
    }
    
    public LongMapWritableMap(String dbPath, String dbName, int cacheSize) {
    ...
    @Override
    public MapWritable put(Long key, MapWritable value) {
        if (key == null)
            return null;
    ...
    @Override
    public void putAll(Map<? extends Long, ? extends MapWritable> m) {
        try {
            WriteBatch batch = db.createWriteBatch();
            int counter = 0;
            for (Map.Entry<? extends Long, ? extends MapWritable> e : m
                    .entrySet()) {
    ...
    @Override
    public Set<java.util.Map.Entry<Long, MapWritable>> entrySet() {
        return new MapEntrySet<Long, MapWritable>(this, this.keyDeSerFunc,
                this.valDeSerFunc);
    }
