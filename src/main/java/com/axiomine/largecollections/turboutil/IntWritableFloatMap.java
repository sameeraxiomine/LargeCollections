...
public class IntWritableFloatMap extends LargeCollection implements   Map<IntWritable,Float>, Serializable{
    ...
    public IntWritableFloatMap() {
        super();
    }
    
    public IntWritableFloatMap(String dbName) {
        super(dbName);
    }
    
    public IntWritableFloatMap(String dbPath, String dbName) {
        super(dbPath, dbName);
    }
    
    public IntWritableFloatMap(String dbPath, String dbName, int cacheSize) {
    ...
    public void optimize() {
        try {
            ...
            for (Entry<IntWritable, Float> entry : this.entrySet()) {
    ...
    @Override
    public Float put(IntWritable key, Float value) {
        if (key == null)
            return null;
    ...
    @Override
    public void putAll(Map<? extends IntWritable, ? extends Float> m) {
        try {
            WriteBatch batch = db.createWriteBatch();
            int counter = 0;
            for (Map.Entry<? extends IntWritable, ? extends Float> e : m
                    .entrySet()) {
    ...
    @Override
    public Set<java.util.Map.Entry<IntWritable, Float>> entrySet() {
        return new MapEntrySet<IntWritable, Float>(this, this.keyDeSerFunc,
                this.valDeSerFunc);
    }
