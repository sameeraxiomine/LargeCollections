...
public class ByteFloatMap extends LargeCollection implements   Map<Byte,Float>, Serializable{
    ...
    public ByteFloatMap(String dbName) {
        super(dbName);
    }
    
    public ByteFloatMap(String dbPath, String dbName) {
        super(dbPath, dbName);
    }
    
    public ByteFloatMap(String dbPath, String dbName, int cacheSize) {
