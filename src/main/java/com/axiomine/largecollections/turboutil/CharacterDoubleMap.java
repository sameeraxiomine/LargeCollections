...
public class CharacterDoubleMap extends LargeCollection implements   Map<Character,Double>, Serializable{
    ...
    public CharacterDoubleMap() {
        super();
    }
    
    public CharacterDoubleMap(String dbName) {
        super(dbName);
    }
    
    public CharacterDoubleMap(String dbPath, String dbName) {
        super(dbPath, dbName);
    }
    
    public CharacterDoubleMap(String dbPath, String dbName, int cacheSize) {
    ...
    public void optimize() {
        try {
            ...
            for (Entry<Character, Double> entry : this.entrySet()) {
    ...
    public void putAll(Map<? extends Character, ? extends Double> m) {
        try {
            ...
            int counter = 0;
            for (Map.Entry<? extends Character, ? extends Double> e : m
                    .entrySet()) {
    ...
    @Override
    public Set<java.util.Map.Entry<Character, Double>> entrySet() {
        return new MapEntrySet<Character, Double>(this, this.keyDeSerFunc,
                this.valDeSerFunc);
    }
