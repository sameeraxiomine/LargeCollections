...
public class StringBytesArrayMap extends LargeCollection implements   Map<String,byte[]>, Serializable{
    ...
    public StringBytesArrayMap() {
        super();
    }
    
    public StringBytesArrayMap(String dbName) {
        super(dbName);
    }
    
    public StringBytesArrayMap(String dbPath, String dbName) {
        super(dbPath, dbName);
    }
    
    public StringBytesArrayMap(String dbPath, String dbName, int cacheSize) {
    ...
    public void putAll(Map<? extends String, ? extends byte[]> m) {
        try {
            ...
            int counter = 0;
            for (Map.Entry<? extends String, ? extends byte[]> e : m
                    .entrySet()) {
    ...
    public Set<java.util.Map.Entry<String, byte[]>> entrySet() {
        return new MapEntrySet<String, byte[]>(this, this.keyDeSerFunc,
                this.valDeSerFunc);
    }
