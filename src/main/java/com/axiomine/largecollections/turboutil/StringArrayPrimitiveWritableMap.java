...
public class StringArrayPrimitiveWritableMap extends LargeCollection implements   Map<String,ArrayPrimitiveWritable>, Serializable{
    ...
    public StringArrayPrimitiveWritableMap() {
        super();
    }
    
    public StringArrayPrimitiveWritableMap(String dbName) {
        super(dbName);
    }
    
    public StringArrayPrimitiveWritableMap(String dbPath, String dbName) {
        super(dbPath, dbName);
    }
    
    public StringArrayPrimitiveWritableMap(String dbPath, String dbName, int cacheSize) {
    ...
    public void optimize() {
        try {
            ...
            for (Entry<String, ArrayPrimitiveWritable> entry : this.entrySet()) {
    ...
    @Override
    public ArrayPrimitiveWritable put(String key, ArrayPrimitiveWritable value) {
        if (key == null)
            return null;
    ...
    @Override
    public void putAll(Map<? extends String, ? extends ArrayPrimitiveWritable> m) {
        try {
            WriteBatch batch = db.createWriteBatch();
            int counter = 0;
            for (Map.Entry<? extends String, ? extends ArrayPrimitiveWritable> e : m
                    .entrySet()) {
    ...
    @Override
    public Set<java.util.Map.Entry<String, ArrayPrimitiveWritable>> entrySet() {
        return new MapEntrySet<String, ArrayPrimitiveWritable>(this, this.keyDeSerFunc,
                this.valDeSerFunc);
    }
