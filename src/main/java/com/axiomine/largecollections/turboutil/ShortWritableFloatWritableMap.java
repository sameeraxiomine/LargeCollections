...
public class ShortWritableFloatWritableMap extends LargeCollection implements   Map<ShortWritable,FloatWritable>, Serializable{
    ...
    public ShortWritableFloatWritableMap() {
        super();
    }
    
    public ShortWritableFloatWritableMap(String dbName) {
        super(dbName);
    }
    
    public ShortWritableFloatWritableMap(String dbPath, String dbName) {
        super(dbPath, dbName);
    }
    
    public ShortWritableFloatWritableMap(String dbPath, String dbName, int cacheSize) {
    ...
    public void optimize() {
        try {
            ...
            for (Entry<ShortWritable, FloatWritable> entry : this.entrySet()) {
    ...
    @Override
    public FloatWritable put(ShortWritable key, FloatWritable value) {
        if (key == null)
            return null;
    ...
    @Override
    public void putAll(Map<? extends ShortWritable, ? extends FloatWritable> m) {
        try {
            WriteBatch batch = db.createWriteBatch();
            int counter = 0;
            for (Map.Entry<? extends ShortWritable, ? extends FloatWritable> e : m
                    .entrySet()) {
    ...
    @Override
    public Set<java.util.Map.Entry<ShortWritable, FloatWritable>> entrySet() {
        return new MapEntrySet<ShortWritable, FloatWritable>(this, this.keyDeSerFunc,
                this.valDeSerFunc);
    }
