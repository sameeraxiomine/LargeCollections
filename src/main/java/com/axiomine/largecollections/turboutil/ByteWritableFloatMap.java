...
public class ByteWritableFloatMap extends LargeCollection implements   Map<ByteWritable,Float>, Serializable{
    ...
    public ByteWritableFloatMap() {
        super();
    }
    
    public ByteWritableFloatMap(String dbName) {
        super(dbName);
    }
    
    public ByteWritableFloatMap(String dbPath, String dbName) {
        super(dbPath, dbName);
    }
    
    public ByteWritableFloatMap(String dbPath, String dbName, int cacheSize) {
    ...
    public void optimize() {
        try {
            ...
            for (Entry<ByteWritable, Float> entry : this.entrySet()) {
    ...
    @Override
    public Float put(ByteWritable key, Float value) {
        if (key == null)
            return null;
    ...
    @Override
    public void putAll(Map<? extends ByteWritable, ? extends Float> m) {
        try {
            WriteBatch batch = db.createWriteBatch();
            int counter = 0;
            for (Map.Entry<? extends ByteWritable, ? extends Float> e : m
                    .entrySet()) {
    ...
    @Override
    public Set<java.util.Map.Entry<ByteWritable, Float>> entrySet() {
        return new MapEntrySet<ByteWritable, Float>(this, this.keyDeSerFunc,
                this.valDeSerFunc);
    }
