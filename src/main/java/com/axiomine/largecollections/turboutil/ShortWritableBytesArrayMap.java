...
public class ShortWritableBytesArrayMap extends LargeCollection implements   Map<ShortWritable,byte[]>, Serializable{
    ...
    public ShortWritableBytesArrayMap() {
        super();
    }
    
    public ShortWritableBytesArrayMap(String dbName) {
        super(dbName);
    }
    
    public ShortWritableBytesArrayMap(String dbPath, String dbName) {
        super(dbPath, dbName);
    }
    
    public ShortWritableBytesArrayMap(String dbPath, String dbName, int cacheSize) {
    ...
    public void optimize() {
        try {
            ...
            for (Entry<ShortWritable, byte[]> entry : this.entrySet()) {
    ...
    @Override
    public byte[] put(ShortWritable key, byte[] value) {
        if (key == null)
            return null;
    ...
    @Override
    public void putAll(Map<? extends ShortWritable, ? extends byte[]> m) {
        try {
            WriteBatch batch = db.createWriteBatch();
            int counter = 0;
            for (Map.Entry<? extends ShortWritable, ? extends byte[]> e : m
                    .entrySet()) {
    ...
    @Override
    public Set<java.util.Map.Entry<ShortWritable, byte[]>> entrySet() {
        return new MapEntrySet<ShortWritable, byte[]>(this, this.keyDeSerFunc,
                this.valDeSerFunc);
    }
