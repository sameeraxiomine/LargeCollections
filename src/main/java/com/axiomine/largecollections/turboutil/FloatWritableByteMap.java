...
public class FloatWritableByteMap extends LargeCollection implements   Map<FloatWritable,Byte>, Serializable{
    ...
    public FloatWritableByteMap() {
        super();
    }
    
    public FloatWritableByteMap(String dbName) {
        super(dbName);
    }
    
    public FloatWritableByteMap(String dbPath, String dbName) {
        super(dbPath, dbName);
    }
    
    public FloatWritableByteMap(String dbPath, String dbName, int cacheSize) {
