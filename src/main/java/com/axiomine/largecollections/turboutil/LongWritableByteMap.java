...
public class LongWritableByteMap extends LargeCollection implements   Map<LongWritable,Byte>, Serializable{
    ...
    public LongWritableByteMap() {
        super();
    }
    
    public LongWritableByteMap(String dbName) {
        super(dbName);
    }
    
    public LongWritableByteMap(String dbPath, String dbName) {
        super(dbPath, dbName);
    }
    
    public LongWritableByteMap(String dbPath, String dbName, int cacheSize) {
