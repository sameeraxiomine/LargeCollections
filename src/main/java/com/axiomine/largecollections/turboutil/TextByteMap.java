...
public class TextByteMap extends LargeCollection implements   Map<Text,Byte>, Serializable{
    ...
    public TextByteMap(String dbName) {
        super(dbName);
    }
    
    public TextByteMap(String dbPath, String dbName) {
        super(dbPath, dbName);
    }
    
    public TextByteMap(String dbPath, String dbName, int cacheSize) {
