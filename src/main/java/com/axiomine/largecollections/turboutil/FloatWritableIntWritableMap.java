...
public class FloatWritableIntWritableMap extends LargeCollection implements   Map<FloatWritable,IntWritable>, Serializable{
    ...
    public FloatWritableIntWritableMap() {
        super();
    }
    
    public FloatWritableIntWritableMap(String dbName) {
        super(dbName);
    }
    
    public FloatWritableIntWritableMap(String dbPath, String dbName) {
        super(dbPath, dbName);
    }
    
    public FloatWritableIntWritableMap(String dbPath, String dbName, int cacheSize) {
    ...
    public void optimize() {
        try {
            ...
            for (Entry<FloatWritable, IntWritable> entry : this.entrySet()) {
    ...
    @Override
    public IntWritable put(FloatWritable key, IntWritable value) {
        if (key == null)
            return null;
    ...
    @Override
    public void putAll(Map<? extends FloatWritable, ? extends IntWritable> m) {
        try {
            WriteBatch batch = db.createWriteBatch();
            int counter = 0;
            for (Map.Entry<? extends FloatWritable, ? extends IntWritable> e : m
                    .entrySet()) {
    ...
    @Override
    public Set<java.util.Map.Entry<FloatWritable, IntWritable>> entrySet() {
        return new MapEntrySet<FloatWritable, IntWritable>(this, this.keyDeSerFunc,
                this.valDeSerFunc);
    }
