...
public class BytesWritableBooleanWritableMap extends LargeCollection implements   Map<BytesWritable,BooleanWritable>, Serializable{
    ...
    public BytesWritableBooleanWritableMap() {
        super();
    }
    
    public BytesWritableBooleanWritableMap(String dbName) {
        super(dbName);
    }
    
    public BytesWritableBooleanWritableMap(String dbPath, String dbName) {
        super(dbPath, dbName);
    }
    
    public BytesWritableBooleanWritableMap(String dbPath, String dbName, int cacheSize) {
    ...
    @Override
    public BooleanWritable put(BytesWritable key, BooleanWritable value) {
        if (key == null)
            return null;
    ...
    @Override
    public void putAll(Map<? extends BytesWritable, ? extends BooleanWritable> m) {
        try {
            WriteBatch batch = db.createWriteBatch();
            int counter = 0;
            for (Map.Entry<? extends BytesWritable, ? extends BooleanWritable> e : m
                    .entrySet()) {
    ...
    @Override
    public Set<java.util.Map.Entry<BytesWritable, BooleanWritable>> entrySet() {
        return new MapEntrySet<BytesWritable, BooleanWritable>(this, this.keyDeSerFunc,
                this.valDeSerFunc);
    }
