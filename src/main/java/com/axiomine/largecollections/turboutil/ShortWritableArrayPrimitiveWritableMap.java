...
public class ShortWritableArrayPrimitiveWritableMap extends LargeCollection implements   Map<ShortWritable,ArrayPrimitiveWritable>, Serializable{
    ...
    public ShortWritableArrayPrimitiveWritableMap() {
        super();
    }
    
    public ShortWritableArrayPrimitiveWritableMap(String dbName) {
        super(dbName);
    }
    
    public ShortWritableArrayPrimitiveWritableMap(String dbPath, String dbName) {
        super(dbPath, dbName);
    }
    
    public ShortWritableArrayPrimitiveWritableMap(String dbPath, String dbName, int cacheSize) {
    ...
    public void optimize() {
        try {
            ...
            for (Entry<ShortWritable, ArrayPrimitiveWritable> entry : this.entrySet()) {
    ...
    @Override
    public ArrayPrimitiveWritable put(ShortWritable key, ArrayPrimitiveWritable value) {
        if (key == null)
            return null;
    ...
    @Override
    public void putAll(Map<? extends ShortWritable, ? extends ArrayPrimitiveWritable> m) {
        try {
            WriteBatch batch = db.createWriteBatch();
            int counter = 0;
            for (Map.Entry<? extends ShortWritable, ? extends ArrayPrimitiveWritable> e : m
                    .entrySet()) {
    ...
    @Override
    public Set<java.util.Map.Entry<ShortWritable, ArrayPrimitiveWritable>> entrySet() {
        return new MapEntrySet<ShortWritable, ArrayPrimitiveWritable>(this, this.keyDeSerFunc,
                this.valDeSerFunc);
    }
