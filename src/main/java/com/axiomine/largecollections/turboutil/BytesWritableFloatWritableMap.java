...
public class BytesWritableFloatWritableMap extends LargeCollection implements   Map<BytesWritable,FloatWritable>, Serializable{
    ...
    public BytesWritableFloatWritableMap() {
        super();
    }
    
    public BytesWritableFloatWritableMap(String dbName) {
        super(dbName);
    }
    
    public BytesWritableFloatWritableMap(String dbPath, String dbName) {
        super(dbPath, dbName);
    }
    
    public BytesWritableFloatWritableMap(String dbPath, String dbName, int cacheSize) {
    ...
    @Override
    public FloatWritable put(BytesWritable key, FloatWritable value) {
        if (key == null)
            return null;
    ...
    @Override
    public void putAll(Map<? extends BytesWritable, ? extends FloatWritable> m) {
        try {
            WriteBatch batch = db.createWriteBatch();
            int counter = 0;
            for (Map.Entry<? extends BytesWritable, ? extends FloatWritable> e : m
                    .entrySet()) {
    ...
    @Override
    public Set<java.util.Map.Entry<BytesWritable, FloatWritable>> entrySet() {
        return new MapEntrySet<BytesWritable, FloatWritable>(this, this.keyDeSerFunc,
                this.valDeSerFunc);
    }
