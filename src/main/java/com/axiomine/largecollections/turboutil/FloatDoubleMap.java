...
public class FloatDoubleMap extends LargeCollection implements   Map<Float,Double>, Serializable{
    ...
    public FloatDoubleMap() {
        super();
    }
    
    public FloatDoubleMap(String dbName) {
        super(dbName);
    }
    
    public FloatDoubleMap(String dbPath, String dbName) {
        super(dbPath, dbName);
    }
    
    public FloatDoubleMap(String dbPath, String dbName, int cacheSize) {
    ...
    public void optimize() {
        try {
            ...
            for (Entry<Float, Double> entry : this.entrySet()) {
    ...
    public void putAll(Map<? extends Float, ? extends Double> m) {
        try {
            ...
            int counter = 0;
            for (Map.Entry<? extends Float, ? extends Double> e : m
                    .entrySet()) {
    ...
    @Override
    public Set<java.util.Map.Entry<Float, Double>> entrySet() {
        return new MapEntrySet<Float, Double>(this, this.keyDeSerFunc,
                this.valDeSerFunc);
    }
