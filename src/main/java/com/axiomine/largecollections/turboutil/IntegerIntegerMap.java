...
public class IntegerIntegerMap extends LargeCollection implements   Map<Integer,Integer>, Serializable{
    ...
    public IntegerIntegerMap() {
        super();
    }
    
    public IntegerIntegerMap(String dbName) {
        super(dbName);
    }
    
    public IntegerIntegerMap(String dbPath, String dbName) {
        super(dbPath, dbName);
    }
    
    public IntegerIntegerMap(String dbPath, String dbName, int cacheSize) {
