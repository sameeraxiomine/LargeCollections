...
public class TextLongMap extends LargeCollection implements   Map<Text,Long>, Serializable{
    ...
    public TextLongMap(String dbName) {
        super(dbName);
    }
    
    public TextLongMap(String dbPath, String dbName) {
        super(dbPath, dbName);
    }
    
    public TextLongMap(String dbPath, String dbName, int cacheSize) {
    ...
    public void optimize() {
        try {
            ...
            for (Entry<Text, Long> entry : this.entrySet()) {
    ...
    @Override
    public Long put(Text key, Long value) {
        if (key == null)
            return null;
    ...
    @Override
    public void putAll(Map<? extends Text, ? extends Long> m) {
        try {
            WriteBatch batch = db.createWriteBatch();
            int counter = 0;
            for (Map.Entry<? extends Text, ? extends Long> e : m
                    .entrySet()) {
    ...
    @Override
    public Set<java.util.Map.Entry<Text, Long>> entrySet() {
        return new MapEntrySet<Text, Long>(this, this.keyDeSerFunc,
                this.valDeSerFunc);
    }
