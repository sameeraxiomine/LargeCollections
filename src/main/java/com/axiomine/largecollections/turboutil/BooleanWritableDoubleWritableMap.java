...
public class BooleanWritableDoubleWritableMap extends LargeCollection implements   Map<BooleanWritable,DoubleWritable>, Serializable{
    ...
    public BooleanWritableDoubleWritableMap() {
        super();
    }
    
    public BooleanWritableDoubleWritableMap(String dbName) {
        super(dbName);
    }
    
    public BooleanWritableDoubleWritableMap(String dbPath, String dbName) {
        super(dbPath, dbName);
    }
    
    public BooleanWritableDoubleWritableMap(String dbPath, String dbName, int cacheSize) {
    ...
    public void optimize() {
        try {
            ...
            for (Entry<BooleanWritable, DoubleWritable> entry : this.entrySet()) {
    ...
    @Override
    public DoubleWritable put(BooleanWritable key, DoubleWritable value) {
        if (key == null)
            return null;
    ...
    @Override
    public void putAll(Map<? extends BooleanWritable, ? extends DoubleWritable> m) {
        try {
            WriteBatch batch = db.createWriteBatch();
            int counter = 0;
            for (Map.Entry<? extends BooleanWritable, ? extends DoubleWritable> e : m
                    .entrySet()) {
    ...
    @Override
    public Set<java.util.Map.Entry<BooleanWritable, DoubleWritable>> entrySet() {
        return new MapEntrySet<BooleanWritable, DoubleWritable>(this, this.keyDeSerFunc,
                this.valDeSerFunc);
    }
