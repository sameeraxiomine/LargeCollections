...
public class StringList extends LargeCollection implements List<String>, Serializable {
    ...
    public StringList(String dbName) {
        super(dbName);
    }
    
    public StringList(String dbPath,String dbName) {
        super(dbPath, dbName);
    }
    
    public StringList(String dbPath,String dbName,int cacheSize) {
        super(dbPath, dbName, cacheSize);
    }
    
    public StringList(String dbPath,String dbName,int cacheSize,int bloomFilterSize) {
    ...
    public Iterator<String> iterator() {
        ...
        return new MapValueIterator<String>(this.getDB(),this.tDeSerFunc);
    }
    ...
    public ListIterator<String> listIterator() {
        return new MyListIterator<String>(this,this.tSerFunc,this.tDeSerFunc);
    }

    @Override
    public ListIterator<String> listIterator(int index) {
        return new MyListIterator<String>(this,this.tSerFunc,this.tDeSerFunc,index);
    }
    ...
    public void optimize() {
        try {
            ...
            MapEntryIterator<Integer, String> iterator = new MapEntryIterator(this, new StringSerDes.DeSerFunction(),tDeSerFunc);
    ...
    private void readObject(java.io.ObjectInputStream in) throws IOException,
        ...
        this.deserialize(in);
        tSerFunc       =  new StringSerDes.SerFunction();
        tDeSerFunc       = new StringSerDes.DeSerFunction();
    }
