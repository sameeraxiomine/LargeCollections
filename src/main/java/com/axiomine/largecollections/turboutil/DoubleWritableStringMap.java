...
public class DoubleWritableStringMap extends LargeCollection implements   Map<DoubleWritable,String>, Serializable{
    ...
    public DoubleWritableStringMap() {
        super();
    }
    
    public DoubleWritableStringMap(String dbName) {
        super(dbName);
    }
    
    public DoubleWritableStringMap(String dbPath, String dbName) {
        super(dbPath, dbName);
    }
    
    public DoubleWritableStringMap(String dbPath, String dbName, int cacheSize) {
    ...
    public void optimize() {
        try {
            ...
            for (Entry<DoubleWritable, String> entry : this.entrySet()) {
    ...
    @Override
    public String put(DoubleWritable key, String value) {
        if (key == null)
            return null;
    ...
    @Override
    public void putAll(Map<? extends DoubleWritable, ? extends String> m) {
        try {
            WriteBatch batch = db.createWriteBatch();
            int counter = 0;
            for (Map.Entry<? extends DoubleWritable, ? extends String> e : m
                    .entrySet()) {
    ...
    @Override
    public Set<java.util.Map.Entry<DoubleWritable, String>> entrySet() {
        return new MapEntrySet<DoubleWritable, String>(this, this.keyDeSerFunc,
                this.valDeSerFunc);
    }
