...
public class BooleanWritableArrayPrimitiveWritableMap extends LargeCollection implements   Map<BooleanWritable,ArrayPrimitiveWritable>, Serializable{
    ...
    public BooleanWritableArrayPrimitiveWritableMap() {
        super();
    }
    
    public BooleanWritableArrayPrimitiveWritableMap(String dbName) {
        super(dbName);
    }
    
    public BooleanWritableArrayPrimitiveWritableMap(String dbPath, String dbName) {
        super(dbPath, dbName);
    }
    
    public BooleanWritableArrayPrimitiveWritableMap(String dbPath, String dbName, int cacheSize) {
    ...
    public void optimize() {
        try {
            ...
            for (Entry<BooleanWritable, ArrayPrimitiveWritable> entry : this.entrySet()) {
    ...
    @Override
    public ArrayPrimitiveWritable put(BooleanWritable key, ArrayPrimitiveWritable value) {
        if (key == null)
            return null;
    ...
    @Override
    public void putAll(Map<? extends BooleanWritable, ? extends ArrayPrimitiveWritable> m) {
        try {
            WriteBatch batch = db.createWriteBatch();
            int counter = 0;
            for (Map.Entry<? extends BooleanWritable, ? extends ArrayPrimitiveWritable> e : m
                    .entrySet()) {
    ...
    @Override
    public Set<java.util.Map.Entry<BooleanWritable, ArrayPrimitiveWritable>> entrySet() {
        return new MapEntrySet<BooleanWritable, ArrayPrimitiveWritable>(this, this.keyDeSerFunc,
                this.valDeSerFunc);
    }
