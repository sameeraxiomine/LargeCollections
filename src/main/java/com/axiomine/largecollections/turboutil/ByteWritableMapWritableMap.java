...
public class ByteWritableMapWritableMap extends LargeCollection implements   Map<ByteWritable,MapWritable>, Serializable{
    ...
    public ByteWritableMapWritableMap() {
        super();
    }
    
    public ByteWritableMapWritableMap(String dbName) {
        super(dbName);
    }
    
    public ByteWritableMapWritableMap(String dbPath, String dbName) {
        super(dbPath, dbName);
    }
    
    public ByteWritableMapWritableMap(String dbPath, String dbName, int cacheSize) {
    ...
    public void optimize() {
        try {
            ...
            for (Entry<ByteWritable, MapWritable> entry : this.entrySet()) {
    ...
    @Override
    public MapWritable put(ByteWritable key, MapWritable value) {
        if (key == null)
            return null;
    ...
    @Override
    public void putAll(Map<? extends ByteWritable, ? extends MapWritable> m) {
        try {
            WriteBatch batch = db.createWriteBatch();
            int counter = 0;
            for (Map.Entry<? extends ByteWritable, ? extends MapWritable> e : m
                    .entrySet()) {
    ...
    @Override
    public Set<java.util.Map.Entry<ByteWritable, MapWritable>> entrySet() {
        return new MapEntrySet<ByteWritable, MapWritable>(this, this.keyDeSerFunc,
                this.valDeSerFunc);
    }
