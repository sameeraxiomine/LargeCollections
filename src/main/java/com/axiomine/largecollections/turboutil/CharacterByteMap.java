...
public class CharacterByteMap extends LargeCollection implements   Map<Character,Byte>, Serializable{
    ...
    public CharacterByteMap() {
        super();
    }
    
    public CharacterByteMap(String dbName) {
        super(dbName);
    }
    
    public CharacterByteMap(String dbPath, String dbName) {
        super(dbPath, dbName);
    }
    
    public CharacterByteMap(String dbPath, String dbName, int cacheSize) {
