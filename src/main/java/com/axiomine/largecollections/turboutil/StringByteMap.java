...
public class StringByteMap extends LargeCollection implements   Map<String,Byte>, Serializable{
    ...
    public StringByteMap() {
        super();
    }
    
    public StringByteMap(String dbName) {
        super(dbName);
    }
    
    public StringByteMap(String dbPath, String dbName) {
        super(dbPath, dbName);
    }
    
    public StringByteMap(String dbPath, String dbName, int cacheSize) {
