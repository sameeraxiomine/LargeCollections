...
public class KCharacterMap<K> extends LargeCollection implements   Map<K,Character>, Serializable{
    ...
    public KCharacterMap() {
        super();
    }
    
    public KCharacterMap(String dbName) {
        super(dbName);
    }
    
    public KCharacterMap(String dbPath, String dbName) {
        super(dbPath, dbName);
    }
    
    public KCharacterMap(String dbPath, String dbName, int cacheSize) {
