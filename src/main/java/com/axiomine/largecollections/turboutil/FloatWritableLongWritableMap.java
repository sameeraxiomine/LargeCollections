...
public class FloatWritableLongWritableMap extends LargeCollection implements   Map<FloatWritable,LongWritable>, Serializable{
    ...
    public FloatWritableLongWritableMap() {
        super();
    }
    
    public FloatWritableLongWritableMap(String dbName) {
        super(dbName);
    }
    
    public FloatWritableLongWritableMap(String dbPath, String dbName) {
        super(dbPath, dbName);
    }
    
    public FloatWritableLongWritableMap(String dbPath, String dbName, int cacheSize) {
    ...
    public void optimize() {
        try {
            ...
            for (Entry<FloatWritable, LongWritable> entry : this.entrySet()) {
    ...
    @Override
    public LongWritable put(FloatWritable key, LongWritable value) {
        if (key == null)
            return null;
    ...
    @Override
    public void putAll(Map<? extends FloatWritable, ? extends LongWritable> m) {
        try {
            WriteBatch batch = db.createWriteBatch();
            int counter = 0;
            for (Map.Entry<? extends FloatWritable, ? extends LongWritable> e : m
                    .entrySet()) {
    ...
    @Override
    public Set<java.util.Map.Entry<FloatWritable, LongWritable>> entrySet() {
        return new MapEntrySet<FloatWritable, LongWritable>(this, this.keyDeSerFunc,
                this.valDeSerFunc);
    }
