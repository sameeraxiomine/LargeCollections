...
public class BytesArrayLongMap extends LargeCollection implements   Map<byte[],Long>, Serializable{
    ...
    public BytesArrayLongMap() {
        super();
    }
    
    public BytesArrayLongMap(String dbName) {
        super(dbName);
    }
    
    public BytesArrayLongMap(String dbPath, String dbName) {
        super(dbPath, dbName);
    }
    
    public BytesArrayLongMap(String dbPath, String dbName, int cacheSize) {
    ...
    public void optimize() {
        try {
            ...
            for (Entry<byte[], Long> entry : this.entrySet()) {
    ...
    public void putAll(Map<? extends byte[], ? extends Long> m) {
        try {
            ...
            int counter = 0;
            for (Map.Entry<? extends byte[], ? extends Long> e : m
                    .entrySet()) {
    ...
    @Override
    public Set<java.util.Map.Entry<byte[], Long>> entrySet() {
        return new MapEntrySet<byte[], Long>(this, this.keyDeSerFunc,
                this.valDeSerFunc);
    }
