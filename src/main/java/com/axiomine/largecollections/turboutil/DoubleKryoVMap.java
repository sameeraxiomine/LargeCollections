...
public class DoubleKryoVMap<V> extends LargeCollection implements   Map<Double,V>, Serializable{
    ...
    public DoubleKryoVMap() {
        super();
    }
    
    public DoubleKryoVMap(String dbName) {
        super(dbName);
    }
    
    public DoubleKryoVMap(String dbPath, String dbName) {
        super(dbPath, dbName);
    }
    
    public DoubleKryoVMap(String dbPath, String dbName, int cacheSize) {
    ...
    public void putAll(Map<? extends Double, ? extends V> m) {
        try {
            ...
            int counter = 0;
            for (Map.Entry<? extends Double, ? extends V> e : m
                    .entrySet()) {
    ...
    @Override
    public Set<java.util.Map.Entry<Double, V>> entrySet() {
        return new MapEntrySet<Double, V>(this, this.keyDeSerFunc,
                this.valDeSerFunc);
    }
