...
public class LongDoubleWritableMap extends LargeCollection implements   Map<Long,DoubleWritable>, Serializable{
    ...
    public LongDoubleWritableMap() {
        super();
    }
    
    public LongDoubleWritableMap(String dbName) {
        super(dbName);
    }
    
    public LongDoubleWritableMap(String dbPath, String dbName) {
        super(dbPath, dbName);
    }
    
    public LongDoubleWritableMap(String dbPath, String dbName, int cacheSize) {
    ...
    @Override
    public DoubleWritable put(Long key, DoubleWritable value) {
        if (key == null)
            return null;
    ...
    @Override
    public void putAll(Map<? extends Long, ? extends DoubleWritable> m) {
        try {
            WriteBatch batch = db.createWriteBatch();
            int counter = 0;
            for (Map.Entry<? extends Long, ? extends DoubleWritable> e : m
                    .entrySet()) {
    ...
    @Override
    public Set<java.util.Map.Entry<Long, DoubleWritable>> entrySet() {
        return new MapEntrySet<Long, DoubleWritable>(this, this.keyDeSerFunc,
                this.valDeSerFunc);
    }
