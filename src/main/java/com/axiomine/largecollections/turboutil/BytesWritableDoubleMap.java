...
public class BytesWritableDoubleMap extends LargeCollection implements   Map<BytesWritable,Double>, Serializable{
    ...
    public BytesWritableDoubleMap() {
        super();
    }
    
    public BytesWritableDoubleMap(String dbName) {
        super(dbName);
    }
    
    public BytesWritableDoubleMap(String dbPath, String dbName) {
        super(dbPath, dbName);
    }
    
    public BytesWritableDoubleMap(String dbPath, String dbName, int cacheSize) {
    ...
    @Override
    public Double put(BytesWritable key, Double value) {
        if (key == null)
            return null;
    ...
    @Override
    public void putAll(Map<? extends BytesWritable, ? extends Double> m) {
        try {
            WriteBatch batch = db.createWriteBatch();
            int counter = 0;
            for (Map.Entry<? extends BytesWritable, ? extends Double> e : m
                    .entrySet()) {
    ...
    @Override
    public Set<java.util.Map.Entry<BytesWritable, Double>> entrySet() {
        return new MapEntrySet<BytesWritable, Double>(this, this.keyDeSerFunc,
                this.valDeSerFunc);
    }
