...
public class ByteFloatWritableMap extends LargeCollection implements   Map<Byte,FloatWritable>, Serializable{
    ...
    public ByteFloatWritableMap() {
        super();
    }
    
    public ByteFloatWritableMap(String dbName) {
        super(dbName);
    }
    
    public ByteFloatWritableMap(String dbPath, String dbName) {
        super(dbPath, dbName);
    }
    
    public ByteFloatWritableMap(String dbPath, String dbName, int cacheSize) {
