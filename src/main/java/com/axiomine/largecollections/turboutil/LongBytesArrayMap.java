...
public class LongBytesArrayMap extends LargeCollection implements   Map<Long,byte[]>, Serializable{
    ...
    public LongBytesArrayMap() {
        super();
    }
    
    public LongBytesArrayMap(String dbName) {
        super(dbName);
    }
    
    public LongBytesArrayMap(String dbPath, String dbName) {
        super(dbPath, dbName);
    }
    
    public LongBytesArrayMap(String dbPath, String dbName, int cacheSize) {
