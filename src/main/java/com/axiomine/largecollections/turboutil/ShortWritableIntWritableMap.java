...
public class ShortWritableIntWritableMap extends LargeCollection implements   Map<ShortWritable,IntWritable>, Serializable{
    ...
    public ShortWritableIntWritableMap() {
        super();
    }
    
    public ShortWritableIntWritableMap(String dbName) {
        super(dbName);
    }
    
    public ShortWritableIntWritableMap(String dbPath, String dbName) {
        super(dbPath, dbName);
    }
    
    public ShortWritableIntWritableMap(String dbPath, String dbName, int cacheSize) {
    ...
    public void optimize() {
        try {
            ...
            for (Entry<ShortWritable, IntWritable> entry : this.entrySet()) {
    ...
    @Override
    public IntWritable put(ShortWritable key, IntWritable value) {
        if (key == null)
            return null;
    ...
    @Override
    public void putAll(Map<? extends ShortWritable, ? extends IntWritable> m) {
        try {
            WriteBatch batch = db.createWriteBatch();
            int counter = 0;
            for (Map.Entry<? extends ShortWritable, ? extends IntWritable> e : m
                    .entrySet()) {
    ...
    @Override
    public Set<java.util.Map.Entry<ShortWritable, IntWritable>> entrySet() {
        return new MapEntrySet<ShortWritable, IntWritable>(this, this.keyDeSerFunc,
                this.valDeSerFunc);
    }
