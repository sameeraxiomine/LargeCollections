...
public class IntegerTextMap extends LargeCollection implements   Map<Integer,Text>, Serializable{
    ...
    public IntegerTextMap() {
        super();
    }
    
    public IntegerTextMap(String dbName) {
        super(dbName);
    }
    
    public IntegerTextMap(String dbPath, String dbName) {
        super(dbPath, dbName);
    }
    
    public IntegerTextMap(String dbPath, String dbName, int cacheSize) {
    ...
    public void optimize() {
        try {
            ...
            for (Entry<Integer, Text> entry : this.entrySet()) {
    ...
    @Override
    public Text put(Integer key, Text value) {
        if (key == null)
            return null;
    ...
    @Override
    public void putAll(Map<? extends Integer, ? extends Text> m) {
        try {
            WriteBatch batch = db.createWriteBatch();
            int counter = 0;
            for (Map.Entry<? extends Integer, ? extends Text> e : m
                    .entrySet()) {
    ...
    @Override
    public Set<java.util.Map.Entry<Integer, Text>> entrySet() {
        return new MapEntrySet<Integer, Text>(this, this.keyDeSerFunc,
                this.valDeSerFunc);
    }
