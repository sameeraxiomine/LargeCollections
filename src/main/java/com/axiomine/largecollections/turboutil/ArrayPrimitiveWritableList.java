...
public class ArrayPrimitiveWritableList extends LargeCollection implements List<ArrayPrimitiveWritable>, Serializable {
    ...
    public void optimize() {
        try {
            ...
            MapEntryIterator<Integer, ArrayPrimitiveWritable> iterator = new MapEntryIterator(this, new WritableSerDes.ArrayPrimitiveWritableDeSerFunction(),tDeSerFunc);
            while(iterator.hasNext()){
                Entry<Integer, ArrayPrimitiveWritable> entry = iterator.next();
