...
public class IntegerLongWritableMap extends LargeCollection implements   Map<Integer,LongWritable>, Serializable{
    ...
    public IntegerLongWritableMap() {
        super();
    }
    
    public IntegerLongWritableMap(String dbName) {
        super(dbName);
    }
    
    public IntegerLongWritableMap(String dbPath, String dbName) {
        super(dbPath, dbName);
    }
    
    public IntegerLongWritableMap(String dbPath, String dbName, int cacheSize) {
    ...
    public void optimize() {
        try {
            ...
            for (Entry<Integer, LongWritable> entry : this.entrySet()) {
    ...
    @Override
    public LongWritable put(Integer key, LongWritable value) {
        if (key == null)
            return null;
    ...
    @Override
    public void putAll(Map<? extends Integer, ? extends LongWritable> m) {
        try {
            WriteBatch batch = db.createWriteBatch();
            int counter = 0;
            for (Map.Entry<? extends Integer, ? extends LongWritable> e : m
                    .entrySet()) {
    ...
    @Override
    public Set<java.util.Map.Entry<Integer, LongWritable>> entrySet() {
        return new MapEntrySet<Integer, LongWritable>(this, this.keyDeSerFunc,
                this.valDeSerFunc);
    }
