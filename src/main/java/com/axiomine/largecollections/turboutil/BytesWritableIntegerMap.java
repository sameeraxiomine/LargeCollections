...
public class BytesWritableIntegerMap extends LargeCollection implements   Map<BytesWritable,Integer>, Serializable{
    ...
    public BytesWritableIntegerMap() {
        super();
    }
    
    public BytesWritableIntegerMap(String dbName) {
        super(dbName);
    }
    
    public BytesWritableIntegerMap(String dbPath, String dbName) {
        super(dbPath, dbName);
    }
    
    public BytesWritableIntegerMap(String dbPath, String dbName, int cacheSize) {
    ...
    @Override
    public Integer put(BytesWritable key, Integer value) {
        if (key == null)
            return null;
    ...
    @Override
    public void putAll(Map<? extends BytesWritable, ? extends Integer> m) {
        try {
            WriteBatch batch = db.createWriteBatch();
            int counter = 0;
            for (Map.Entry<? extends BytesWritable, ? extends Integer> e : m
                    .entrySet()) {
    ...
    @Override
    public Set<java.util.Map.Entry<BytesWritable, Integer>> entrySet() {
        return new MapEntrySet<BytesWritable, Integer>(this, this.keyDeSerFunc,
                this.valDeSerFunc);
    }
