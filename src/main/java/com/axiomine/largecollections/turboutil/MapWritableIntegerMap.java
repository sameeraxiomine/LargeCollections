...
public class MapWritableIntegerMap extends LargeCollection implements   Map<MapWritable,Integer>, Serializable{
    ...
    public MapWritableIntegerMap() {
        super();
    }
    
    public MapWritableIntegerMap(String dbName) {
        super(dbName);
    }
    
    public MapWritableIntegerMap(String dbPath, String dbName) {
        super(dbPath, dbName);
    }
    
    public MapWritableIntegerMap(String dbPath, String dbName, int cacheSize) {
    ...
    public void optimize() {
        try {
            ...
            for (Entry<MapWritable, Integer> entry : this.entrySet()) {
    ...
    @Override
    public Integer put(MapWritable key, Integer value) {
        if (key == null)
            return null;
    ...
    @Override
    public void putAll(Map<? extends MapWritable, ? extends Integer> m) {
        try {
            WriteBatch batch = db.createWriteBatch();
            int counter = 0;
            for (Map.Entry<? extends MapWritable, ? extends Integer> e : m
                    .entrySet()) {
    ...
    @Override
    public Set<java.util.Map.Entry<MapWritable, Integer>> entrySet() {
        return new MapEntrySet<MapWritable, Integer>(this, this.keyDeSerFunc,
                this.valDeSerFunc);
    }
