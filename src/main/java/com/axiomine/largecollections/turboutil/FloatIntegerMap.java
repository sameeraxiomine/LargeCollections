...
public class FloatIntegerMap extends LargeCollection implements   Map<Float,Integer>, Serializable{
    ...
    public FloatIntegerMap() {
        super();
    }
    
    public FloatIntegerMap(String dbName) {
        super(dbName);
    }
    
    public FloatIntegerMap(String dbPath, String dbName) {
        super(dbPath, dbName);
    }
    
    public FloatIntegerMap(String dbPath, String dbName, int cacheSize) {
    ...
    public void optimize() {
        try {
            ...
            for (Entry<Float, Integer> entry : this.entrySet()) {
    ...
    public void putAll(Map<? extends Float, ? extends Integer> m) {
        try {
            ...
            int counter = 0;
            for (Map.Entry<? extends Float, ? extends Integer> e : m
                    .entrySet()) {
    ...
    @Override
    public Set<java.util.Map.Entry<Float, Integer>> entrySet() {
        return new MapEntrySet<Float, Integer>(this, this.keyDeSerFunc,
                this.valDeSerFunc);
    }
