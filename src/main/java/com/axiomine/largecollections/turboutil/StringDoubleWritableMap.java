...
public class StringDoubleWritableMap extends LargeCollection implements   Map<String,DoubleWritable>, Serializable{
    ...
    public StringDoubleWritableMap() {
        super();
    }
    
    public StringDoubleWritableMap(String dbName) {
        super(dbName);
    }
    
    public StringDoubleWritableMap(String dbPath, String dbName) {
        super(dbPath, dbName);
    }
    
    public StringDoubleWritableMap(String dbPath, String dbName, int cacheSize) {
    ...
    @Override
    public DoubleWritable put(String key, DoubleWritable value) {
        if (key == null)
            return null;
    ...
    @Override
    public void putAll(Map<? extends String, ? extends DoubleWritable> m) {
        try {
            WriteBatch batch = db.createWriteBatch();
            int counter = 0;
            for (Map.Entry<? extends String, ? extends DoubleWritable> e : m
                    .entrySet()) {
    ...
    @Override
    public Set<java.util.Map.Entry<String, DoubleWritable>> entrySet() {
        return new MapEntrySet<String, DoubleWritable>(this, this.keyDeSerFunc,
                this.valDeSerFunc);
    }
