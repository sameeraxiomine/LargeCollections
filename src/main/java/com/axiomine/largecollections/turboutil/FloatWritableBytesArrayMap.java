...
public class FloatWritableBytesArrayMap extends LargeCollection implements   Map<FloatWritable,byte[]>, Serializable{
    ...
    public FloatWritableBytesArrayMap() {
        super();
    }
    
    public FloatWritableBytesArrayMap(String dbName) {
        super(dbName);
    }
    
    public FloatWritableBytesArrayMap(String dbPath, String dbName) {
        super(dbPath, dbName);
    }
    
    public FloatWritableBytesArrayMap(String dbPath, String dbName, int cacheSize) {
    ...
    public void optimize() {
        try {
            ...
            for (Entry<FloatWritable, byte[]> entry : this.entrySet()) {
    ...
    @Override
    public byte[] put(FloatWritable key, byte[] value) {
        if (key == null)
            return null;
    ...
    @Override
    public void putAll(Map<? extends FloatWritable, ? extends byte[]> m) {
        try {
            WriteBatch batch = db.createWriteBatch();
            int counter = 0;
            for (Map.Entry<? extends FloatWritable, ? extends byte[]> e : m
                    .entrySet()) {
    ...
    @Override
    public Set<java.util.Map.Entry<FloatWritable, byte[]>> entrySet() {
        return new MapEntrySet<FloatWritable, byte[]>(this, this.keyDeSerFunc,
                this.valDeSerFunc);
    }
