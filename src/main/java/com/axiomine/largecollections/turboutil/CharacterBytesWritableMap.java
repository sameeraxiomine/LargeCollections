...
public class CharacterBytesWritableMap extends LargeCollection implements   Map<Character,BytesWritable>, Serializable{
    ...
    public CharacterBytesWritableMap() {
        super();
    }
    
    public CharacterBytesWritableMap(String dbName) {
        super(dbName);
    }
    
    public CharacterBytesWritableMap(String dbPath, String dbName) {
        super(dbPath, dbName);
    }
    
    public CharacterBytesWritableMap(String dbPath, String dbName, int cacheSize) {
    ...
    public void optimize() {
        try {
            ...
            for (Entry<Character, BytesWritable> entry : this.entrySet()) {
    ...
    @Override
    public BytesWritable put(Character key, BytesWritable value) {
        if (key == null)
            return null;
    ...
    @Override
    public void putAll(Map<? extends Character, ? extends BytesWritable> m) {
        try {
            WriteBatch batch = db.createWriteBatch();
            int counter = 0;
            for (Map.Entry<? extends Character, ? extends BytesWritable> e : m
                    .entrySet()) {
    ...
    @Override
    public Set<java.util.Map.Entry<Character, BytesWritable>> entrySet() {
        return new MapEntrySet<Character, BytesWritable>(this, this.keyDeSerFunc,
                this.valDeSerFunc);
    }
