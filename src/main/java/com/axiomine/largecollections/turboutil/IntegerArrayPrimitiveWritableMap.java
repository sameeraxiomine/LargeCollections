...
public class IntegerArrayPrimitiveWritableMap extends LargeCollection implements   Map<Integer,ArrayPrimitiveWritable>, Serializable{
    ...
    public IntegerArrayPrimitiveWritableMap() {
        super();
    }
    
    public IntegerArrayPrimitiveWritableMap(String dbName) {
        super(dbName);
    }
    
    public IntegerArrayPrimitiveWritableMap(String dbPath, String dbName) {
        super(dbPath, dbName);
    }
    
    public IntegerArrayPrimitiveWritableMap(String dbPath, String dbName, int cacheSize) {
    ...
    public void optimize() {
        try {
            ...
            for (Entry<Integer, ArrayPrimitiveWritable> entry : this.entrySet()) {
    ...
    @Override
    public ArrayPrimitiveWritable put(Integer key, ArrayPrimitiveWritable value) {
        if (key == null)
            return null;
    ...
    @Override
    public void putAll(Map<? extends Integer, ? extends ArrayPrimitiveWritable> m) {
        try {
            WriteBatch batch = db.createWriteBatch();
            int counter = 0;
            for (Map.Entry<? extends Integer, ? extends ArrayPrimitiveWritable> e : m
                    .entrySet()) {
    ...
    @Override
    public Set<java.util.Map.Entry<Integer, ArrayPrimitiveWritable>> entrySet() {
        return new MapEntrySet<Integer, ArrayPrimitiveWritable>(this, this.keyDeSerFunc,
                this.valDeSerFunc);
    }
