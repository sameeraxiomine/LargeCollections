...
public class TextTextMap extends LargeCollection implements   Map<Text,Text>, Serializable{
    ...
    public TextTextMap(String dbName) {
        super(dbName);
    }
    
    public TextTextMap(String dbPath, String dbName) {
        super(dbPath, dbName);
    }
    
    public TextTextMap(String dbPath, String dbName, int cacheSize) {
    ...
    public void optimize() {
        try {
            ...
            for (Entry<Text, Text> entry : this.entrySet()) {
    ...
    public void putAll(Map<? extends Text, ? extends Text> m) {
        try {
            ...
            int counter = 0;
            for (Map.Entry<? extends Text, ? extends Text> e : m
                    .entrySet()) {
    ...
    @Override
    public Set<java.util.Map.Entry<Text, Text>> entrySet() {
        return new MapEntrySet<Text, Text>(this, this.keyDeSerFunc,
                this.valDeSerFunc);
    }
