...
public class BooleanWritableFloatWritableMap extends LargeCollection implements   Map<BooleanWritable,FloatWritable>, Serializable{
    ...
    public BooleanWritableFloatWritableMap() {
        super();
    }
    
    public BooleanWritableFloatWritableMap(String dbName) {
        super(dbName);
    }
    
    public BooleanWritableFloatWritableMap(String dbPath, String dbName) {
        super(dbPath, dbName);
    }
    
    public BooleanWritableFloatWritableMap(String dbPath, String dbName, int cacheSize) {
    ...
    public void optimize() {
        try {
            ...
            for (Entry<BooleanWritable, FloatWritable> entry : this.entrySet()) {
    ...
    @Override
    public FloatWritable put(BooleanWritable key, FloatWritable value) {
        if (key == null)
            return null;
    ...
    @Override
    public void putAll(Map<? extends BooleanWritable, ? extends FloatWritable> m) {
        try {
            WriteBatch batch = db.createWriteBatch();
            int counter = 0;
            for (Map.Entry<? extends BooleanWritable, ? extends FloatWritable> e : m
                    .entrySet()) {
    ...
    @Override
    public Set<java.util.Map.Entry<BooleanWritable, FloatWritable>> entrySet() {
        return new MapEntrySet<BooleanWritable, FloatWritable>(this, this.keyDeSerFunc,
                this.valDeSerFunc);
    }
