...
public class BytesArrayBooleanWritableMap extends LargeCollection implements   Map<byte[],BooleanWritable>, Serializable{
    ...
    public BytesArrayBooleanWritableMap() {
        super();
    }
    
    public BytesArrayBooleanWritableMap(String dbName) {
        super(dbName);
    }
    
    public BytesArrayBooleanWritableMap(String dbPath, String dbName) {
        super(dbPath, dbName);
    }
    
    public BytesArrayBooleanWritableMap(String dbPath, String dbName, int cacheSize) {
