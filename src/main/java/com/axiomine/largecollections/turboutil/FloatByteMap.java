...
public class FloatByteMap extends LargeCollection implements   Map<Float,Byte>, Serializable{
    ...
    public FloatByteMap(String dbName) {
        super(dbName);
    }
    
    public FloatByteMap(String dbPath, String dbName) {
        super(dbPath, dbName);
    }
    
    public FloatByteMap(String dbPath, String dbName, int cacheSize) {
