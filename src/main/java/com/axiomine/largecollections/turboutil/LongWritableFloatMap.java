...
public class LongWritableFloatMap extends LargeCollection implements   Map<LongWritable,Float>, Serializable{
    ...
    public LongWritableFloatMap() {
        super();
    }
    
    public LongWritableFloatMap(String dbName) {
        super(dbName);
    }
    
    public LongWritableFloatMap(String dbPath, String dbName) {
        super(dbPath, dbName);
    }
    
    public LongWritableFloatMap(String dbPath, String dbName, int cacheSize) {
    ...
    public void optimize() {
        try {
            ...
            for (Entry<LongWritable, Float> entry : this.entrySet()) {
    ...
    @Override
    public Float put(LongWritable key, Float value) {
        if (key == null)
            return null;
    ...
    @Override
    public void putAll(Map<? extends LongWritable, ? extends Float> m) {
        try {
            WriteBatch batch = db.createWriteBatch();
            int counter = 0;
            for (Map.Entry<? extends LongWritable, ? extends Float> e : m
                    .entrySet()) {
    ...
    @Override
    public Set<java.util.Map.Entry<LongWritable, Float>> entrySet() {
        return new MapEntrySet<LongWritable, Float>(this, this.keyDeSerFunc,
                this.valDeSerFunc);
    }
