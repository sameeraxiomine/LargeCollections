...
public class LongShortWritableMap extends LargeCollection implements   Map<Long,ShortWritable>, Serializable{
    ...
    public LongShortWritableMap() {
        super();
    }
    
    public LongShortWritableMap(String dbName) {
        super(dbName);
    }
    
    public LongShortWritableMap(String dbPath, String dbName) {
        super(dbPath, dbName);
    }
    
    public LongShortWritableMap(String dbPath, String dbName, int cacheSize) {
    ...
    @Override
    public ShortWritable put(Long key, ShortWritable value) {
        if (key == null)
            return null;
    ...
    @Override
    public void putAll(Map<? extends Long, ? extends ShortWritable> m) {
        try {
            WriteBatch batch = db.createWriteBatch();
            int counter = 0;
            for (Map.Entry<? extends Long, ? extends ShortWritable> e : m
                    .entrySet()) {
    ...
    @Override
    public Set<java.util.Map.Entry<Long, ShortWritable>> entrySet() {
        return new MapEntrySet<Long, ShortWritable>(this, this.keyDeSerFunc,
                this.valDeSerFunc);
    }
