...
public class BytesWritableArrayPrimitiveWritableMap extends LargeCollection implements   Map<BytesWritable,ArrayPrimitiveWritable>, Serializable{
    ...
    public BytesWritableArrayPrimitiveWritableMap() {
        super();
    }
    
    public BytesWritableArrayPrimitiveWritableMap(String dbName) {
        super(dbName);
    }
    
    public BytesWritableArrayPrimitiveWritableMap(String dbPath, String dbName) {
        super(dbPath, dbName);
    }
    
    public BytesWritableArrayPrimitiveWritableMap(String dbPath, String dbName, int cacheSize) {
    ...
    @Override
    public ArrayPrimitiveWritable put(BytesWritable key, ArrayPrimitiveWritable value) {
        if (key == null)
            return null;
    ...
    @Override
    public void putAll(Map<? extends BytesWritable, ? extends ArrayPrimitiveWritable> m) {
        try {
            WriteBatch batch = db.createWriteBatch();
            int counter = 0;
            for (Map.Entry<? extends BytesWritable, ? extends ArrayPrimitiveWritable> e : m
                    .entrySet()) {
    ...
    @Override
    public Set<java.util.Map.Entry<BytesWritable, ArrayPrimitiveWritable>> entrySet() {
        return new MapEntrySet<BytesWritable, ArrayPrimitiveWritable>(this, this.keyDeSerFunc,
                this.valDeSerFunc);
    }
