...
public class ArrayPrimitiveWritableStringMap extends LargeCollection implements   Map<ArrayPrimitiveWritable,String>, Serializable{
    ...
    public ArrayPrimitiveWritableStringMap() {
        super();
    }
    
    public ArrayPrimitiveWritableStringMap(String dbName) {
        super(dbName);
    }
    
    public ArrayPrimitiveWritableStringMap(String dbPath, String dbName) {
        super(dbPath, dbName);
    }
    
    public ArrayPrimitiveWritableStringMap(String dbPath, String dbName, int cacheSize) {
    ...
    @Override
    public String put(ArrayPrimitiveWritable key, String value) {
        if (key == null)
            return null;
    ...
    @Override
    public void putAll(Map<? extends ArrayPrimitiveWritable, ? extends String> m) {
        try {
            WriteBatch batch = db.createWriteBatch();
            int counter = 0;
            for (Map.Entry<? extends ArrayPrimitiveWritable, ? extends String> e : m
                    .entrySet()) {
    ...
    @Override
    public Set<java.util.Map.Entry<ArrayPrimitiveWritable, String>> entrySet() {
        return new MapEntrySet<ArrayPrimitiveWritable, String>(this, this.keyDeSerFunc,
                this.valDeSerFunc);
    }
