...
public class BooleanWritableBooleanWritableMap extends LargeCollection implements   Map<BooleanWritable,BooleanWritable>, Serializable{
    ...
    public BooleanWritableBooleanWritableMap() {
        super();
    }
    
    public BooleanWritableBooleanWritableMap(String dbName) {
        super(dbName);
    }
    
    public BooleanWritableBooleanWritableMap(String dbPath, String dbName) {
        super(dbPath, dbName);
    }
    
    public BooleanWritableBooleanWritableMap(String dbPath, String dbName, int cacheSize) {
    ...
    public void optimize() {
        try {
            ...
            for (Entry<BooleanWritable, BooleanWritable> entry : this.entrySet()) {
    ...
    @Override
    public BooleanWritable put(BooleanWritable key, BooleanWritable value) {
        if (key == null)
            return null;
    ...
    @Override
    public void putAll(Map<? extends BooleanWritable, ? extends BooleanWritable> m) {
        try {
            WriteBatch batch = db.createWriteBatch();
            int counter = 0;
            for (Map.Entry<? extends BooleanWritable, ? extends BooleanWritable> e : m
                    .entrySet()) {
    ...
    @Override
    public Set<java.util.Map.Entry<BooleanWritable, BooleanWritable>> entrySet() {
        return new MapEntrySet<BooleanWritable, BooleanWritable>(this, this.keyDeSerFunc,
                this.valDeSerFunc);
    }
