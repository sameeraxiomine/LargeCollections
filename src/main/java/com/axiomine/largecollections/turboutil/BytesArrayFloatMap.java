...
public class BytesArrayFloatMap extends LargeCollection implements   Map<byte[],Float>, Serializable{
    ...
    public BytesArrayFloatMap() {
        super();
    }
    
    public BytesArrayFloatMap(String dbName) {
        super(dbName);
    }
    
    public BytesArrayFloatMap(String dbPath, String dbName) {
        super(dbPath, dbName);
    }
    
    public BytesArrayFloatMap(String dbPath, String dbName, int cacheSize) {
    ...
    public void optimize() {
        try {
            ...
            for (Entry<byte[], Float> entry : this.entrySet()) {
    ...
    public void putAll(Map<? extends byte[], ? extends Float> m) {
        try {
            ...
            int counter = 0;
            for (Map.Entry<? extends byte[], ? extends Float> e : m
                    .entrySet()) {
    ...
    @Override
    public Set<java.util.Map.Entry<byte[], Float>> entrySet() {
        return new MapEntrySet<byte[], Float>(this, this.keyDeSerFunc,
                this.valDeSerFunc);
    }
