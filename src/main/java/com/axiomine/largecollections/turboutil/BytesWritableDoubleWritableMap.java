...
public class BytesWritableDoubleWritableMap extends LargeCollection implements   Map<BytesWritable,DoubleWritable>, Serializable{
    ...
    public BytesWritableDoubleWritableMap() {
        super();
    }
    
    public BytesWritableDoubleWritableMap(String dbName) {
        super(dbName);
    }
    
    public BytesWritableDoubleWritableMap(String dbPath, String dbName) {
        super(dbPath, dbName);
    }
    
    public BytesWritableDoubleWritableMap(String dbPath, String dbName, int cacheSize) {
    ...
    public void optimize() {
        try {
            ...
            for (Entry<BytesWritable, DoubleWritable> entry : this.entrySet()) {
    ...
    @Override
    public DoubleWritable put(BytesWritable key, DoubleWritable value) {
        if (key == null)
            return null;
    ...
    @Override
    public void putAll(Map<? extends BytesWritable, ? extends DoubleWritable> m) {
        try {
            WriteBatch batch = db.createWriteBatch();
            int counter = 0;
            for (Map.Entry<? extends BytesWritable, ? extends DoubleWritable> e : m
                    .entrySet()) {
    ...
    @Override
    public Set<java.util.Map.Entry<BytesWritable, DoubleWritable>> entrySet() {
        return new MapEntrySet<BytesWritable, DoubleWritable>(this, this.keyDeSerFunc,
                this.valDeSerFunc);
    }
