...
public class ShortWritableCharacterMap extends LargeCollection implements   Map<ShortWritable,Character>, Serializable{
    ...
    public ShortWritableCharacterMap() {
        super();
    }
    
    public ShortWritableCharacterMap(String dbName) {
        super(dbName);
    }
    
    public ShortWritableCharacterMap(String dbPath, String dbName) {
        super(dbPath, dbName);
    }
    
    public ShortWritableCharacterMap(String dbPath, String dbName, int cacheSize) {
    ...
    public void optimize() {
        try {
            ...
            for (Entry<ShortWritable, Character> entry : this.entrySet()) {
    ...
    @Override
    public Character put(ShortWritable key, Character value) {
        if (key == null)
            return null;
    ...
    @Override
    public void putAll(Map<? extends ShortWritable, ? extends Character> m) {
        try {
            WriteBatch batch = db.createWriteBatch();
            int counter = 0;
            for (Map.Entry<? extends ShortWritable, ? extends Character> e : m
                    .entrySet()) {
    ...
    @Override
    public Set<java.util.Map.Entry<ShortWritable, Character>> entrySet() {
        return new MapEntrySet<ShortWritable, Character>(this, this.keyDeSerFunc,
                this.valDeSerFunc);
    }
