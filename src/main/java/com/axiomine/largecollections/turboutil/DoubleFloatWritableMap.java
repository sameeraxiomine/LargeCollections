...
public class DoubleFloatWritableMap extends LargeCollection implements   Map<Double,FloatWritable>, Serializable{
    ...
    public DoubleFloatWritableMap() {
        super();
    }
    
    public DoubleFloatWritableMap(String dbName) {
        super(dbName);
    }
    
    public DoubleFloatWritableMap(String dbPath, String dbName) {
        super(dbPath, dbName);
    }
    
    public DoubleFloatWritableMap(String dbPath, String dbName, int cacheSize) {
    ...
    public void optimize() {
        try {
            ...
            for (Entry<Double, FloatWritable> entry : this.entrySet()) {
    ...
    @Override
    public FloatWritable put(Double key, FloatWritable value) {
        if (key == null)
            return null;
    ...
    @Override
    public void putAll(Map<? extends Double, ? extends FloatWritable> m) {
        try {
            WriteBatch batch = db.createWriteBatch();
            int counter = 0;
            for (Map.Entry<? extends Double, ? extends FloatWritable> e : m
                    .entrySet()) {
    ...
    @Override
    public Set<java.util.Map.Entry<Double, FloatWritable>> entrySet() {
        return new MapEntrySet<Double, FloatWritable>(this, this.keyDeSerFunc,
                this.valDeSerFunc);
    }
