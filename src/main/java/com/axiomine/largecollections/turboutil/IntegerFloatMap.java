...
public class IntegerFloatMap extends LargeCollection implements   Map<Integer,Float>, Serializable{
    ...
    public IntegerFloatMap(String dbName) {
        super(dbName);
    }
    
    public IntegerFloatMap(String dbPath, String dbName) {
        super(dbPath, dbName);
    }
    
    public IntegerFloatMap(String dbPath, String dbName, int cacheSize) {
    ...
    public void putAll(Map<? extends Integer, ? extends Float> m) {
        try {
            ...
            int counter = 0;
            for (Map.Entry<? extends Integer, ? extends Float> e : m
                    .entrySet()) {
    ...
    public Set<java.util.Map.Entry<Integer, Float>> entrySet() {
        return new MapEntrySet<Integer, Float>(this, this.keyDeSerFunc,
                this.valDeSerFunc);
    }
