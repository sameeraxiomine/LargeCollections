...
public class FloatList extends LargeCollection implements List<Float>, Serializable {
    ...
    public FloatList(String dbName) {
        super(dbName);
    }
    
    public FloatList(String dbPath,String dbName) {
        super(dbPath, dbName);
    }
    
    public FloatList(String dbPath,String dbName,int cacheSize) {
        super(dbPath, dbName, cacheSize);
    }
    
    public FloatList(String dbPath,String dbName,int cacheSize,int bloomFilterSize) {
    ...
    public Iterator<Float> iterator() {
        ...
        return new MapValueIterator<Float>(this.getDB(),this.tDeSerFunc);
    }
    ...
    public ListIterator<Float> listIterator() {
        return new MyListIterator<Float>(this,this.tSerFunc,this.tDeSerFunc);
    }

    @Override
    public ListIterator<Float> listIterator(int index) {
        return new MyListIterator<Float>(this,this.tSerFunc,this.tDeSerFunc,index);
    }
    ...
    public void optimize() {
        try {
            ...
            MapEntryIterator<Integer, Float> iterator = new MapEntryIterator(this, new FloatSerDes.DeSerFunction(),tDeSerFunc);
    ...
    private void readObject(java.io.ObjectInputStream in) throws IOException,
        ...
        this.deserialize(in);
        tSerFunc       =  new FloatSerDes.SerFunction();
        tDeSerFunc       = new FloatSerDes.DeSerFunction();
    }
