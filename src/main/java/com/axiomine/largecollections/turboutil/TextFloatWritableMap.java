...
public class TextFloatWritableMap extends LargeCollection implements   Map<Text,FloatWritable>, Serializable{
    ...
    public TextFloatWritableMap() {
        super();
    }
    
    public TextFloatWritableMap(String dbName) {
        super(dbName);
    }
    
    public TextFloatWritableMap(String dbPath, String dbName) {
        super(dbPath, dbName);
    }
    
    public TextFloatWritableMap(String dbPath, String dbName, int cacheSize) {
    ...
    public void optimize() {
        try {
            ...
            for (Entry<Text, FloatWritable> entry : this.entrySet()) {
    ...
    @Override
    public FloatWritable put(Text key, FloatWritable value) {
        if (key == null)
            return null;
    ...
    @Override
    public void putAll(Map<? extends Text, ? extends FloatWritable> m) {
        try {
            WriteBatch batch = db.createWriteBatch();
            int counter = 0;
            for (Map.Entry<? extends Text, ? extends FloatWritable> e : m
                    .entrySet()) {
    ...
    @Override
    public Set<java.util.Map.Entry<Text, FloatWritable>> entrySet() {
        return new MapEntrySet<Text, FloatWritable>(this, this.keyDeSerFunc,
                this.valDeSerFunc);
    }
