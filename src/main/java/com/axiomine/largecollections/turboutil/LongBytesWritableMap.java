...
public class LongBytesWritableMap extends LargeCollection implements   Map<Long,BytesWritable>, Serializable{
    ...
    public LongBytesWritableMap() {
        super();
    }
    
    public LongBytesWritableMap(String dbName) {
        super(dbName);
    }
    
    public LongBytesWritableMap(String dbPath, String dbName) {
        super(dbPath, dbName);
    }
    
    public LongBytesWritableMap(String dbPath, String dbName, int cacheSize) {
    ...
    @Override
    public BytesWritable put(Long key, BytesWritable value) {
        if (key == null)
            return null;
    ...
    @Override
    public void putAll(Map<? extends Long, ? extends BytesWritable> m) {
        try {
            WriteBatch batch = db.createWriteBatch();
            int counter = 0;
            for (Map.Entry<? extends Long, ? extends BytesWritable> e : m
                    .entrySet()) {
    ...
    @Override
    public Set<java.util.Map.Entry<Long, BytesWritable>> entrySet() {
        return new MapEntrySet<Long, BytesWritable>(this, this.keyDeSerFunc,
                this.valDeSerFunc);
    }
