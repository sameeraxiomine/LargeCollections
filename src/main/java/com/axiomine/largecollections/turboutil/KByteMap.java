...
public class KByteMap<K> extends LargeCollection implements   Map<K,Byte>, Serializable{
    ...
    public KByteMap(String dbName) {
        super(dbName);
    }
    
    public KByteMap(String dbPath, String dbName) {
        super(dbPath, dbName);
    }
    
    public KByteMap(String dbPath, String dbName, int cacheSize) {
