...
public class StringBooleanWritableMap extends LargeCollection implements   Map<String,BooleanWritable>, Serializable{
    ...
    public StringBooleanWritableMap() {
        super();
    }
    
    public StringBooleanWritableMap(String dbName) {
        super(dbName);
    }
    
    public StringBooleanWritableMap(String dbPath, String dbName) {
        super(dbPath, dbName);
    }
    
    public StringBooleanWritableMap(String dbPath, String dbName, int cacheSize) {
    ...
    public void optimize() {
        try {
            ...
            for (Entry<String, BooleanWritable> entry : this.entrySet()) {
    ...
    @Override
    public BooleanWritable put(String key, BooleanWritable value) {
        if (key == null)
            return null;
    ...
    @Override
    public void putAll(Map<? extends String, ? extends BooleanWritable> m) {
        try {
            WriteBatch batch = db.createWriteBatch();
            int counter = 0;
            for (Map.Entry<? extends String, ? extends BooleanWritable> e : m
                    .entrySet()) {
    ...
    @Override
    public Set<java.util.Map.Entry<String, BooleanWritable>> entrySet() {
        return new MapEntrySet<String, BooleanWritable>(this, this.keyDeSerFunc,
                this.valDeSerFunc);
    }
