...
public class KBytesArrayMap<K> extends LargeCollection implements   Map<K,byte[]>, Serializable{
    ...
    public KBytesArrayMap() {
        super();
    }
    
    public KBytesArrayMap(String dbName) {
        super(dbName);
    }
    
    public KBytesArrayMap(String dbPath, String dbName) {
        super(dbPath, dbName);
    }
    
    public KBytesArrayMap(String dbPath, String dbName, int cacheSize) {
