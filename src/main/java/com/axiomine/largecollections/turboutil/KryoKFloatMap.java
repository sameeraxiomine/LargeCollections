...
public class KryoKFloatMap<K> extends LargeCollection implements   Map<K,Float>, Serializable{
    ...
    public KryoKFloatMap() {
        super();
    }
    
    public KryoKFloatMap(String dbName) {
        super(dbName);
    }
    
    public KryoKFloatMap(String dbPath, String dbName) {
        super(dbPath, dbName);
    }
    
    public KryoKFloatMap(String dbPath, String dbName, int cacheSize) {
