...
public class TextIntegerMap extends LargeCollection implements   Map<Text,Integer>, Serializable{
    ...
    public TextIntegerMap() {
        super();
    }
    
    public TextIntegerMap(String dbName) {
        super(dbName);
    }
    
    public TextIntegerMap(String dbPath, String dbName) {
        super(dbPath, dbName);
    }
    
    public TextIntegerMap(String dbPath, String dbName, int cacheSize) {
    ...
    public void optimize() {
        try {
            ...
            for (Entry<Text, Integer> entry : this.entrySet()) {
    ...
    @Override
    public void putAll(Map<? extends Text, ? extends Integer> m) {
        try {
            WriteBatch batch = db.createWriteBatch();
            int counter = 0;
            for (Map.Entry<? extends Text, ? extends Integer> e : m
                    .entrySet()) {
    ...
    @Override
    public Set<java.util.Map.Entry<Text, Integer>> entrySet() {
        return new MapEntrySet<Text, Integer>(this, this.keyDeSerFunc,
                this.valDeSerFunc);
    }
