...
public class BytesWritableStringMap extends LargeCollection implements   Map<BytesWritable,String>, Serializable{
    ...
    public BytesWritableStringMap(String dbName) {
        super(dbName);
    }
    
    public BytesWritableStringMap(String dbPath, String dbName) {
        super(dbPath, dbName);
    }
    
    public BytesWritableStringMap(String dbPath, String dbName, int cacheSize) {
    ...
    @Override
    public String put(BytesWritable key, String value) {
        if (key == null)
            return null;
    ...
    @Override
    public void putAll(Map<? extends BytesWritable, ? extends String> m) {
        try {
            WriteBatch batch = db.createWriteBatch();
            int counter = 0;
            for (Map.Entry<? extends BytesWritable, ? extends String> e : m
                    .entrySet()) {
    ...
    @Override
    public Set<java.util.Map.Entry<BytesWritable, String>> entrySet() {
        return new MapEntrySet<BytesWritable, String>(this, this.keyDeSerFunc,
                this.valDeSerFunc);
    }
