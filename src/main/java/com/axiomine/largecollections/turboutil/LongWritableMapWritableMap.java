...
public class LongWritableMapWritableMap extends LargeCollection implements   Map<LongWritable,MapWritable>, Serializable{
    ...
    public LongWritableMapWritableMap() {
        super();
    }
    
    public LongWritableMapWritableMap(String dbName) {
        super(dbName);
    }
    
    public LongWritableMapWritableMap(String dbPath, String dbName) {
        super(dbPath, dbName);
    }
    
    public LongWritableMapWritableMap(String dbPath, String dbName, int cacheSize) {
    ...
    public void optimize() {
        try {
            ...
            for (Entry<LongWritable, MapWritable> entry : this.entrySet()) {
    ...
    @Override
    public MapWritable put(LongWritable key, MapWritable value) {
        if (key == null)
            return null;
    ...
    @Override
    public void putAll(Map<? extends LongWritable, ? extends MapWritable> m) {
        try {
            WriteBatch batch = db.createWriteBatch();
            int counter = 0;
            for (Map.Entry<? extends LongWritable, ? extends MapWritable> e : m
                    .entrySet()) {
    ...
    @Override
    public Set<java.util.Map.Entry<LongWritable, MapWritable>> entrySet() {
        return new MapEntrySet<LongWritable, MapWritable>(this, this.keyDeSerFunc,
                this.valDeSerFunc);
    }
