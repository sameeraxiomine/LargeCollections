...
public class DoubleWritableBytesArrayMap extends LargeCollection implements   Map<DoubleWritable,byte[]>, Serializable{
    ...
    public DoubleWritableBytesArrayMap() {
        super();
    }
    
    public DoubleWritableBytesArrayMap(String dbName) {
        super(dbName);
    }
    
    public DoubleWritableBytesArrayMap(String dbPath, String dbName) {
        super(dbPath, dbName);
    }
    
    public DoubleWritableBytesArrayMap(String dbPath, String dbName, int cacheSize) {
    ...
    public void optimize() {
        try {
            ...
            for (Entry<DoubleWritable, byte[]> entry : this.entrySet()) {
    ...
    @Override
    public byte[] put(DoubleWritable key, byte[] value) {
        if (key == null)
            return null;
    ...
    @Override
    public void putAll(Map<? extends DoubleWritable, ? extends byte[]> m) {
        try {
            WriteBatch batch = db.createWriteBatch();
            int counter = 0;
            for (Map.Entry<? extends DoubleWritable, ? extends byte[]> e : m
                    .entrySet()) {
    ...
    @Override
    public Set<java.util.Map.Entry<DoubleWritable, byte[]>> entrySet() {
        return new MapEntrySet<DoubleWritable, byte[]>(this, this.keyDeSerFunc,
                this.valDeSerFunc);
    }
