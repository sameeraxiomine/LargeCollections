...
public class BytesArrayByteMap extends LargeCollection implements   Map<byte[],Byte>, Serializable{
    ...
    public BytesArrayByteMap() {
        super();
    }
    
    public BytesArrayByteMap(String dbName) {
        super(dbName);
    }
    
    public BytesArrayByteMap(String dbPath, String dbName) {
        super(dbPath, dbName);
    }
    
    public BytesArrayByteMap(String dbPath, String dbName, int cacheSize) {
