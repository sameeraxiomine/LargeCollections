...
public class ByteWritableIntWritableMap extends LargeCollection implements   Map<ByteWritable,IntWritable>, Serializable{
    ...
    public ByteWritableIntWritableMap() {
        super();
    }
    
    public ByteWritableIntWritableMap(String dbName) {
        super(dbName);
    }
    
    public ByteWritableIntWritableMap(String dbPath, String dbName) {
        super(dbPath, dbName);
    }
    
    public ByteWritableIntWritableMap(String dbPath, String dbName, int cacheSize) {
    ...
    public void optimize() {
        try {
            ...
            for (Entry<ByteWritable, IntWritable> entry : this.entrySet()) {
    ...
    public void putAll(Map<? extends ByteWritable, ? extends IntWritable> m) {
        try {
            ...
            int counter = 0;
            for (Map.Entry<? extends ByteWritable, ? extends IntWritable> e : m
                    .entrySet()) {
    ...
    public Set<java.util.Map.Entry<ByteWritable, IntWritable>> entrySet() {
        return new MapEntrySet<ByteWritable, IntWritable>(this, this.keyDeSerFunc,
                this.valDeSerFunc);
    }
