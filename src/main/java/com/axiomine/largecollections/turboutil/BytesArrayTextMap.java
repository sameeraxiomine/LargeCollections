...
public class BytesArrayTextMap extends LargeCollection implements   Map<byte[],Text>, Serializable{
    ...
    public BytesArrayTextMap(String dbName) {
        super(dbName);
    }
    
    public BytesArrayTextMap(String dbPath, String dbName) {
        super(dbPath, dbName);
    }
    
    public BytesArrayTextMap(String dbPath, String dbName, int cacheSize) {
    ...
    @Override
    public Text put(byte[] key, Text value) {
        if (key == null)
            return null;
    ...
    @Override
    public void putAll(Map<? extends byte[], ? extends Text> m) {
        try {
            WriteBatch batch = db.createWriteBatch();
            int counter = 0;
            for (Map.Entry<? extends byte[], ? extends Text> e : m
                    .entrySet()) {
    ...
    @Override
    public Set<java.util.Map.Entry<byte[], Text>> entrySet() {
        return new MapEntrySet<byte[], Text>(this, this.keyDeSerFunc,
                this.valDeSerFunc);
    }
