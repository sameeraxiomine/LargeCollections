...
public class ByteSet extends LargeCollection implements Set<Byte>, Serializable {
    ...
    public ByteSet(String dbName) {
        super(dbName);
    }
    
    public ByteSet(String dbPath,String dbName) {
        super(dbPath, dbName);
    }
    
    public ByteSet(String dbPath,String dbName,int cacheSize) {
        super(dbPath, dbName, cacheSize);
    }
    
    public ByteSet(String dbPath,String dbName,int cacheSize,int bloomFilterSize) {
