...
public class DoubleWritableFloatMap extends LargeCollection implements   Map<DoubleWritable,Float>, Serializable{
    ...
    public DoubleWritableFloatMap() {
        super();
    }
    
    public DoubleWritableFloatMap(String dbName) {
        super(dbName);
    }
    
    public DoubleWritableFloatMap(String dbPath, String dbName) {
        super(dbPath, dbName);
    }
    
    public DoubleWritableFloatMap(String dbPath, String dbName, int cacheSize) {
    ...
    @Override
    public Float put(DoubleWritable key, Float value) {
        if (key == null)
            return null;
    ...
    @Override
    public void putAll(Map<? extends DoubleWritable, ? extends Float> m) {
        try {
            WriteBatch batch = db.createWriteBatch();
            int counter = 0;
            for (Map.Entry<? extends DoubleWritable, ? extends Float> e : m
                    .entrySet()) {
    ...
    @Override
    public Set<java.util.Map.Entry<DoubleWritable, Float>> entrySet() {
        return new MapEntrySet<DoubleWritable, Float>(this, this.keyDeSerFunc,
                this.valDeSerFunc);
    }
