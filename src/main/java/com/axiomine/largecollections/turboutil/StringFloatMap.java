...
public class StringFloatMap extends LargeCollection implements   Map<String,Float>, Serializable{
    ...
    public StringFloatMap(String dbName) {
        super(dbName);
    }
    
    public StringFloatMap(String dbPath, String dbName) {
        super(dbPath, dbName);
    }
    
    public StringFloatMap(String dbPath, String dbName, int cacheSize) {
    ...
    public void putAll(Map<? extends String, ? extends Float> m) {
        try {
            ...
            int counter = 0;
            for (Map.Entry<? extends String, ? extends Float> e : m
                    .entrySet()) {
    ...
    public Set<java.util.Map.Entry<String, Float>> entrySet() {
        return new MapEntrySet<String, Float>(this, this.keyDeSerFunc,
                this.valDeSerFunc);
    }
