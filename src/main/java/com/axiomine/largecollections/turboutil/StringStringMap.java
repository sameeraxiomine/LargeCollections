...
public class StringStringMap extends LargeCollection implements   Map<String,String>, Serializable{
    ...
    public StringStringMap(String dbName) {
        super(dbName);
    }
    
    public StringStringMap(String dbPath, String dbName) {
        super(dbPath, dbName);
    }
    
    public StringStringMap(String dbPath, String dbName, int cacheSize) {
