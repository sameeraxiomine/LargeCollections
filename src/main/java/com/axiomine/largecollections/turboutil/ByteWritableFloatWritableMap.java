...
public class ByteWritableFloatWritableMap extends LargeCollection implements   Map<ByteWritable,FloatWritable>, Serializable{
    ...
    public ByteWritableFloatWritableMap() {
        super();
    }
    
    public ByteWritableFloatWritableMap(String dbName) {
        super(dbName);
    }
    
    public ByteWritableFloatWritableMap(String dbPath, String dbName) {
        super(dbPath, dbName);
    }
    
    public ByteWritableFloatWritableMap(String dbPath, String dbName, int cacheSize) {
    ...
    public void optimize() {
        try {
            ...
            for (Entry<ByteWritable, FloatWritable> entry : this.entrySet()) {
    ...
    @Override
    public FloatWritable put(ByteWritable key, FloatWritable value) {
        if (key == null)
            return null;
    ...
    @Override
    public void putAll(Map<? extends ByteWritable, ? extends FloatWritable> m) {
        try {
            WriteBatch batch = db.createWriteBatch();
            int counter = 0;
            for (Map.Entry<? extends ByteWritable, ? extends FloatWritable> e : m
                    .entrySet()) {
    ...
    @Override
    public Set<java.util.Map.Entry<ByteWritable, FloatWritable>> entrySet() {
        return new MapEntrySet<ByteWritable, FloatWritable>(this, this.keyDeSerFunc,
                this.valDeSerFunc);
    }
