...
public class MapWritableStringMap extends LargeCollection implements   Map<MapWritable,String>, Serializable{
    ...
    public MapWritableStringMap() {
        super();
    }
    
    public MapWritableStringMap(String dbName) {
        super(dbName);
    }
    
    public MapWritableStringMap(String dbPath, String dbName) {
        super(dbPath, dbName);
    }
    
    public MapWritableStringMap(String dbPath, String dbName, int cacheSize) {
    ...
    public void optimize() {
        try {
            ...
            for (Entry<MapWritable, String> entry : this.entrySet()) {
    ...
    @Override
    public String put(MapWritable key, String value) {
        if (key == null)
            return null;
    ...
    @Override
    public void putAll(Map<? extends MapWritable, ? extends String> m) {
        try {
            WriteBatch batch = db.createWriteBatch();
            int counter = 0;
            for (Map.Entry<? extends MapWritable, ? extends String> e : m
                    .entrySet()) {
    ...
    @Override
    public Set<java.util.Map.Entry<MapWritable, String>> entrySet() {
        return new MapEntrySet<MapWritable, String>(this, this.keyDeSerFunc,
                this.valDeSerFunc);
    }
