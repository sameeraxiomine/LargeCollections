...
public class StringLongWritableMap extends LargeCollection implements   Map<String,LongWritable>, Serializable{
    ...
    public StringLongWritableMap() {
        super();
    }
    
    public StringLongWritableMap(String dbName) {
        super(dbName);
    }
    
    public StringLongWritableMap(String dbPath, String dbName) {
        super(dbPath, dbName);
    }
    
    public StringLongWritableMap(String dbPath, String dbName, int cacheSize) {
    ...
    public void optimize() {
        try {
            ...
            for (Entry<String, LongWritable> entry : this.entrySet()) {
    ...
    @Override
    public LongWritable put(String key, LongWritable value) {
        if (key == null)
            return null;
    ...
    @Override
    public void putAll(Map<? extends String, ? extends LongWritable> m) {
        try {
            WriteBatch batch = db.createWriteBatch();
            int counter = 0;
            for (Map.Entry<? extends String, ? extends LongWritable> e : m
                    .entrySet()) {
    ...
    @Override
    public Set<java.util.Map.Entry<String, LongWritable>> entrySet() {
        return new MapEntrySet<String, LongWritable>(this, this.keyDeSerFunc,
                this.valDeSerFunc);
    }
