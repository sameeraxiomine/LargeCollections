...
public class TextMapWritableMap extends LargeCollection implements   Map<Text,MapWritable>, Serializable{
    ...
    public TextMapWritableMap() {
        super();
    }
    
    public TextMapWritableMap(String dbName) {
        super(dbName);
    }
    
    public TextMapWritableMap(String dbPath, String dbName) {
        super(dbPath, dbName);
    }
    
    public TextMapWritableMap(String dbPath, String dbName, int cacheSize) {
    ...
    public void optimize() {
        try {
            ...
            for (Entry<Text, MapWritable> entry : this.entrySet()) {
    ...
    @Override
    public MapWritable put(Text key, MapWritable value) {
        if (key == null)
            return null;
    ...
    @Override
    public void putAll(Map<? extends Text, ? extends MapWritable> m) {
        try {
            WriteBatch batch = db.createWriteBatch();
            int counter = 0;
            for (Map.Entry<? extends Text, ? extends MapWritable> e : m
                    .entrySet()) {
    ...
    @Override
    public Set<java.util.Map.Entry<Text, MapWritable>> entrySet() {
        return new MapEntrySet<Text, MapWritable>(this, this.keyDeSerFunc,
                this.valDeSerFunc);
    }
