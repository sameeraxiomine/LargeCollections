...
public class BytesArrayIntegerMap extends LargeCollection implements   Map<byte[],Integer>, Serializable{
    ...
    public BytesArrayIntegerMap() {
        super();
    }
    
    public BytesArrayIntegerMap(String dbName) {
        super(dbName);
    }
    
    public BytesArrayIntegerMap(String dbPath, String dbName) {
        super(dbPath, dbName);
    }
    
    public BytesArrayIntegerMap(String dbPath, String dbName, int cacheSize) {
    ...
    public void putAll(Map<? extends byte[], ? extends Integer> m) {
        try {
            ...
            int counter = 0;
            for (Map.Entry<? extends byte[], ? extends Integer> e : m
                    .entrySet()) {
    ...
    @Override
    public Set<java.util.Map.Entry<byte[], Integer>> entrySet() {
        return new MapEntrySet<byte[], Integer>(this, this.keyDeSerFunc,
                this.valDeSerFunc);
    }
