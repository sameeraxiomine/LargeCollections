...
public class FloatBytesArrayMap extends LargeCollection implements   Map<Float,byte[]>, Serializable{
    ...
    public FloatBytesArrayMap() {
        super();
    }
    
    public FloatBytesArrayMap(String dbName) {
        super(dbName);
    }
    
    public FloatBytesArrayMap(String dbPath, String dbName) {
        super(dbPath, dbName);
    }
    
    public FloatBytesArrayMap(String dbPath, String dbName, int cacheSize) {
    ...
    public void putAll(Map<? extends Float, ? extends byte[]> m) {
        try {
            ...
            int counter = 0;
            for (Map.Entry<? extends Float, ? extends byte[]> e : m
                    .entrySet()) {
    ...
    @Override
    public Set<java.util.Map.Entry<Float, byte[]>> entrySet() {
        return new MapEntrySet<Float, byte[]>(this, this.keyDeSerFunc,
                this.valDeSerFunc);
    }
