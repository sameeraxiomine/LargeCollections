...
public class LongWritableTextMap extends LargeCollection implements   Map<LongWritable,Text>, Serializable{
    ...
    public LongWritableTextMap() {
        super();
    }
    
    public LongWritableTextMap(String dbName) {
        super(dbName);
    }
    
    public LongWritableTextMap(String dbPath, String dbName) {
        super(dbPath, dbName);
    }
    
    public LongWritableTextMap(String dbPath, String dbName, int cacheSize) {
    ...
    public void optimize() {
        try {
            ...
            for (Entry<LongWritable, Text> entry : this.entrySet()) {
    ...
    @Override
    public Text put(LongWritable key, Text value) {
        if (key == null)
            return null;
    ...
    @Override
    public void putAll(Map<? extends LongWritable, ? extends Text> m) {
        try {
            WriteBatch batch = db.createWriteBatch();
            int counter = 0;
            for (Map.Entry<? extends LongWritable, ? extends Text> e : m
                    .entrySet()) {
    ...
    @Override
    public Set<java.util.Map.Entry<LongWritable, Text>> entrySet() {
        return new MapEntrySet<LongWritable, Text>(this, this.keyDeSerFunc,
                this.valDeSerFunc);
    }
