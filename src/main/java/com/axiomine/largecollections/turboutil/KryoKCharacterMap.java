...
public class KryoKCharacterMap<K> extends LargeCollection implements   Map<K,Character>, Serializable{
    ...
    public KryoKCharacterMap() {
        super();
    }
    
    public KryoKCharacterMap(String dbName) {
        super(dbName);
    }
    
    public KryoKCharacterMap(String dbPath, String dbName) {
        super(dbPath, dbName);
    }
    
    public KryoKCharacterMap(String dbPath, String dbName, int cacheSize) {
    ...
    public void optimize() {
        try {
            ...
            for (Entry<K, Character> entry : this.entrySet()) {
    ...
    public void putAll(Map<? extends K, ? extends Character> m) {
        try {
            ...
            int counter = 0;
            for (Map.Entry<? extends K, ? extends Character> e : m
                    .entrySet()) {
    ...
    @Override
    public Set<java.util.Map.Entry<K, Character>> entrySet() {
        return new MapEntrySet<K, Character>(this, this.keyDeSerFunc,
                this.valDeSerFunc);
    }
