...
public class ByteWritableLongMap extends LargeCollection implements   Map<ByteWritable,Long>, Serializable{
    ...
    public ByteWritableLongMap() {
        super();
    }
    
    public ByteWritableLongMap(String dbName) {
        super(dbName);
    }
    
    public ByteWritableLongMap(String dbPath, String dbName) {
        super(dbPath, dbName);
    }
    
    public ByteWritableLongMap(String dbPath, String dbName, int cacheSize) {
    ...
    public void optimize() {
        try {
            ...
            for (Entry<ByteWritable, Long> entry : this.entrySet()) {
    ...
    @Override
    public Long put(ByteWritable key, Long value) {
        if (key == null)
            return null;
    ...
    @Override
    public void putAll(Map<? extends ByteWritable, ? extends Long> m) {
        try {
            WriteBatch batch = db.createWriteBatch();
            int counter = 0;
            for (Map.Entry<? extends ByteWritable, ? extends Long> e : m
                    .entrySet()) {
    ...
    @Override
    public Set<java.util.Map.Entry<ByteWritable, Long>> entrySet() {
        return new MapEntrySet<ByteWritable, Long>(this, this.keyDeSerFunc,
                this.valDeSerFunc);
    }
