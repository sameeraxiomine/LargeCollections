...
public class ByteWritableCharacterMap extends LargeCollection implements   Map<ByteWritable,Character>, Serializable{
    ...
    public ByteWritableCharacterMap() {
        super();
    }
    
    public ByteWritableCharacterMap(String dbName) {
        super(dbName);
    }
    
    public ByteWritableCharacterMap(String dbPath, String dbName) {
        super(dbPath, dbName);
    }
    
    public ByteWritableCharacterMap(String dbPath, String dbName, int cacheSize) {
    ...
    public void optimize() {
        try {
            ...
            for (Entry<ByteWritable, Character> entry : this.entrySet()) {
    ...
    @Override
    public Character put(ByteWritable key, Character value) {
        if (key == null)
            return null;
    ...
    @Override
    public void putAll(Map<? extends ByteWritable, ? extends Character> m) {
        try {
            WriteBatch batch = db.createWriteBatch();
            int counter = 0;
            for (Map.Entry<? extends ByteWritable, ? extends Character> e : m
                    .entrySet()) {
    ...
    @Override
    public Set<java.util.Map.Entry<ByteWritable, Character>> entrySet() {
        return new MapEntrySet<ByteWritable, Character>(this, this.keyDeSerFunc,
                this.valDeSerFunc);
    }
