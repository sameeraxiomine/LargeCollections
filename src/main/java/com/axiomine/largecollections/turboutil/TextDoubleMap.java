...
public class TextDoubleMap extends LargeCollection implements   Map<Text,Double>, Serializable{
    ...
    public TextDoubleMap() {
        super();
    }
    
    public TextDoubleMap(String dbName) {
        super(dbName);
    }
    
    public TextDoubleMap(String dbPath, String dbName) {
        super(dbPath, dbName);
    }
    
    public TextDoubleMap(String dbPath, String dbName, int cacheSize) {
    ...
    public void optimize() {
        try {
            ...
            for (Entry<Text, Double> entry : this.entrySet()) {
    ...
    @Override
    public Double put(Text key, Double value) {
        if (key == null)
            return null;
    ...
    @Override
    public void putAll(Map<? extends Text, ? extends Double> m) {
        try {
            WriteBatch batch = db.createWriteBatch();
            int counter = 0;
            for (Map.Entry<? extends Text, ? extends Double> e : m
                    .entrySet()) {
    ...
    @Override
    public Set<java.util.Map.Entry<Text, Double>> entrySet() {
        return new MapEntrySet<Text, Double>(this, this.keyDeSerFunc,
                this.valDeSerFunc);
    }
