...
public class MapWritableIntWritableMap extends LargeCollection implements   Map<MapWritable,IntWritable>, Serializable{
    ...
    public MapWritableIntWritableMap() {
        super();
    }
    
    public MapWritableIntWritableMap(String dbName) {
        super(dbName);
    }
    
    public MapWritableIntWritableMap(String dbPath, String dbName) {
        super(dbPath, dbName);
    }
    
    public MapWritableIntWritableMap(String dbPath, String dbName, int cacheSize) {
    ...
    public void optimize() {
        try {
            ...
            for (Entry<MapWritable, IntWritable> entry : this.entrySet()) {
    ...
    @Override
    public IntWritable put(MapWritable key, IntWritable value) {
        if (key == null)
            return null;
    ...
    @Override
    public void putAll(Map<? extends MapWritable, ? extends IntWritable> m) {
        try {
            WriteBatch batch = db.createWriteBatch();
            int counter = 0;
            for (Map.Entry<? extends MapWritable, ? extends IntWritable> e : m
                    .entrySet()) {
    ...
    @Override
    public Set<java.util.Map.Entry<MapWritable, IntWritable>> entrySet() {
        return new MapEntrySet<MapWritable, IntWritable>(this, this.keyDeSerFunc,
                this.valDeSerFunc);
    }
