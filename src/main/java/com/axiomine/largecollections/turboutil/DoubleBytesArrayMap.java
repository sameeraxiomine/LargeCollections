...
public class DoubleBytesArrayMap extends LargeCollection implements   Map<Double,byte[]>, Serializable{
    ...
    public DoubleBytesArrayMap() {
        super();
    }
    
    public DoubleBytesArrayMap(String dbName) {
        super(dbName);
    }
    
    public DoubleBytesArrayMap(String dbPath, String dbName) {
        super(dbPath, dbName);
    }
    
    public DoubleBytesArrayMap(String dbPath, String dbName, int cacheSize) {
