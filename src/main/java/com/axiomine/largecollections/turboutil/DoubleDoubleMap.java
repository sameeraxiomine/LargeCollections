...
public class DoubleDoubleMap extends LargeCollection implements   Map<Double,Double>, Serializable{
    ...
    public DoubleDoubleMap(String dbName) {
        super(dbName);
    }
    
    public DoubleDoubleMap(String dbPath, String dbName) {
        super(dbPath, dbName);
    }
    
    public DoubleDoubleMap(String dbPath, String dbName, int cacheSize) {
    ...
    public void putAll(Map<? extends Double, ? extends Double> m) {
        try {
            ...
            int counter = 0;
            for (Map.Entry<? extends Double, ? extends Double> e : m
                    .entrySet()) {
    ...
    public Set<java.util.Map.Entry<Double, Double>> entrySet() {
        return new MapEntrySet<Double, Double>(this, this.keyDeSerFunc,
                this.valDeSerFunc);
    }
