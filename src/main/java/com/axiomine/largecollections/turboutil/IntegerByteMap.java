...
public class IntegerByteMap extends LargeCollection implements   Map<Integer,Byte>, Serializable{
    ...
    public IntegerByteMap() {
        super();
    }
    
    public IntegerByteMap(String dbName) {
        super(dbName);
    }
    
    public IntegerByteMap(String dbPath, String dbName) {
        super(dbPath, dbName);
    }
    
    public IntegerByteMap(String dbPath, String dbName, int cacheSize) {
