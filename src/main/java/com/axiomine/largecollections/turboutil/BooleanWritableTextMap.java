...
public class BooleanWritableTextMap extends LargeCollection implements   Map<BooleanWritable,Text>, Serializable{
    ...
    public BooleanWritableTextMap() {
        super();
    }
    
    public BooleanWritableTextMap(String dbName) {
        super(dbName);
    }
    
    public BooleanWritableTextMap(String dbPath, String dbName) {
        super(dbPath, dbName);
    }
    
    public BooleanWritableTextMap(String dbPath, String dbName, int cacheSize) {
    ...
    public void optimize() {
        try {
            ...
            for (Entry<BooleanWritable, Text> entry : this.entrySet()) {
    ...
    @Override
    public Text put(BooleanWritable key, Text value) {
        if (key == null)
            return null;
    ...
    @Override
    public void putAll(Map<? extends BooleanWritable, ? extends Text> m) {
        try {
            WriteBatch batch = db.createWriteBatch();
            int counter = 0;
            for (Map.Entry<? extends BooleanWritable, ? extends Text> e : m
                    .entrySet()) {
    ...
    @Override
    public Set<java.util.Map.Entry<BooleanWritable, Text>> entrySet() {
        return new MapEntrySet<BooleanWritable, Text>(this, this.keyDeSerFunc,
                this.valDeSerFunc);
    }
