...
public class KryoKBytesArrayMap<K> extends LargeCollection implements   Map<K,byte[]>, Serializable{
    ...
    public KryoKBytesArrayMap(String dbName) {
        super(dbName);
    }
    
    public KryoKBytesArrayMap(String dbPath, String dbName) {
        super(dbPath, dbName);
    }
    
    public KryoKBytesArrayMap(String dbPath, String dbName, int cacheSize) {
