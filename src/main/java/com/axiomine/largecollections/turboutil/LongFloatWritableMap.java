...
public class LongFloatWritableMap extends LargeCollection implements   Map<Long,FloatWritable>, Serializable{
    ...
    public LongFloatWritableMap(String dbName) {
        super(dbName);
    }
    
    public LongFloatWritableMap(String dbPath, String dbName) {
        super(dbPath, dbName);
    }
    
    public LongFloatWritableMap(String dbPath, String dbName, int cacheSize) {
    ...
    @Override
    public FloatWritable put(Long key, FloatWritable value) {
        if (key == null)
            return null;
    ...
    @Override
    public void putAll(Map<? extends Long, ? extends FloatWritable> m) {
        try {
            WriteBatch batch = db.createWriteBatch();
            int counter = 0;
            for (Map.Entry<? extends Long, ? extends FloatWritable> e : m
                    .entrySet()) {
    ...
    @Override
    public Set<java.util.Map.Entry<Long, FloatWritable>> entrySet() {
        return new MapEntrySet<Long, FloatWritable>(this, this.keyDeSerFunc,
                this.valDeSerFunc);
    }
