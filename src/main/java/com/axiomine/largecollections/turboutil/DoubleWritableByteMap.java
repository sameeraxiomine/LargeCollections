...
public class DoubleWritableByteMap extends LargeCollection implements   Map<DoubleWritable,Byte>, Serializable{
    ...
    public DoubleWritableByteMap() {
        super();
    }
    
    public DoubleWritableByteMap(String dbName) {
        super(dbName);
    }
    
    public DoubleWritableByteMap(String dbPath, String dbName) {
        super(dbPath, dbName);
    }
    
    public DoubleWritableByteMap(String dbPath, String dbName, int cacheSize) {
