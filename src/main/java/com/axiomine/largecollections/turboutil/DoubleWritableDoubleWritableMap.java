...
public class DoubleWritableDoubleWritableMap extends LargeCollection implements   Map<DoubleWritable,DoubleWritable>, Serializable{
    ...
    public DoubleWritableDoubleWritableMap() {
        super();
    }
    
    public DoubleWritableDoubleWritableMap(String dbName) {
        super(dbName);
    }
    
    public DoubleWritableDoubleWritableMap(String dbPath, String dbName) {
        super(dbPath, dbName);
    }
    
    public DoubleWritableDoubleWritableMap(String dbPath, String dbName, int cacheSize) {
    ...
    public void optimize() {
        try {
            ...
            for (Entry<DoubleWritable, DoubleWritable> entry : this.entrySet()) {
    ...
    @Override
    public DoubleWritable put(DoubleWritable key, DoubleWritable value) {
        if (key == null)
            return null;
    ...
    @Override
    public void putAll(Map<? extends DoubleWritable, ? extends DoubleWritable> m) {
        try {
            WriteBatch batch = db.createWriteBatch();
            int counter = 0;
            for (Map.Entry<? extends DoubleWritable, ? extends DoubleWritable> e : m
                    .entrySet()) {
    ...
    @Override
    public Set<java.util.Map.Entry<DoubleWritable, DoubleWritable>> entrySet() {
        return new MapEntrySet<DoubleWritable, DoubleWritable>(this, this.keyDeSerFunc,
                this.valDeSerFunc);
    }
