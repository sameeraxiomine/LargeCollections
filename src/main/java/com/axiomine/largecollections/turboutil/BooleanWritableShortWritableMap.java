...
public class BooleanWritableShortWritableMap extends LargeCollection implements   Map<BooleanWritable,ShortWritable>, Serializable{
    ...
    public BooleanWritableShortWritableMap() {
        super();
    }
    
    public BooleanWritableShortWritableMap(String dbName) {
        super(dbName);
    }
    
    public BooleanWritableShortWritableMap(String dbPath, String dbName) {
        super(dbPath, dbName);
    }
    
    public BooleanWritableShortWritableMap(String dbPath, String dbName, int cacheSize) {
    ...
    public void optimize() {
        try {
            ...
            for (Entry<BooleanWritable, ShortWritable> entry : this.entrySet()) {
    ...
    @Override
    public ShortWritable put(BooleanWritable key, ShortWritable value) {
        if (key == null)
            return null;
    ...
    @Override
    public void putAll(Map<? extends BooleanWritable, ? extends ShortWritable> m) {
        try {
            WriteBatch batch = db.createWriteBatch();
            int counter = 0;
            for (Map.Entry<? extends BooleanWritable, ? extends ShortWritable> e : m
                    .entrySet()) {
    ...
    @Override
    public Set<java.util.Map.Entry<BooleanWritable, ShortWritable>> entrySet() {
        return new MapEntrySet<BooleanWritable, ShortWritable>(this, this.keyDeSerFunc,
                this.valDeSerFunc);
    }
