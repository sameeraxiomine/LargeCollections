...
public class FloatWritableStringMap extends LargeCollection implements   Map<FloatWritable,String>, Serializable{
    ...
    public FloatWritableStringMap() {
        super();
    }
    
    public FloatWritableStringMap(String dbName) {
        super(dbName);
    }
    
    public FloatWritableStringMap(String dbPath, String dbName) {
        super(dbPath, dbName);
    }
    
    public FloatWritableStringMap(String dbPath, String dbName, int cacheSize) {
    ...
    public void optimize() {
        try {
            ...
            for (Entry<FloatWritable, String> entry : this.entrySet()) {
    ...
    @Override
    public String put(FloatWritable key, String value) {
        if (key == null)
            return null;
    ...
    @Override
    public void putAll(Map<? extends FloatWritable, ? extends String> m) {
        try {
            WriteBatch batch = db.createWriteBatch();
            int counter = 0;
            for (Map.Entry<? extends FloatWritable, ? extends String> e : m
                    .entrySet()) {
    ...
    @Override
    public Set<java.util.Map.Entry<FloatWritable, String>> entrySet() {
        return new MapEntrySet<FloatWritable, String>(this, this.keyDeSerFunc,
                this.valDeSerFunc);
    }
