...
public class BooleanWritableBytesWritableMap extends LargeCollection implements   Map<BooleanWritable,BytesWritable>, Serializable{
    ...
    public BooleanWritableBytesWritableMap() {
        super();
    }
    
    public BooleanWritableBytesWritableMap(String dbName) {
        super(dbName);
    }
    
    public BooleanWritableBytesWritableMap(String dbPath, String dbName) {
        super(dbPath, dbName);
    }
    
    public BooleanWritableBytesWritableMap(String dbPath, String dbName, int cacheSize) {
    ...
    public void optimize() {
        try {
            ...
            for (Entry<BooleanWritable, BytesWritable> entry : this.entrySet()) {
    ...
    @Override
    public BytesWritable put(BooleanWritable key, BytesWritable value) {
        if (key == null)
            return null;
    ...
    @Override
    public void putAll(Map<? extends BooleanWritable, ? extends BytesWritable> m) {
        try {
            WriteBatch batch = db.createWriteBatch();
            int counter = 0;
            for (Map.Entry<? extends BooleanWritable, ? extends BytesWritable> e : m
                    .entrySet()) {
    ...
    @Override
    public Set<java.util.Map.Entry<BooleanWritable, BytesWritable>> entrySet() {
        return new MapEntrySet<BooleanWritable, BytesWritable>(this, this.keyDeSerFunc,
                this.valDeSerFunc);
    }
