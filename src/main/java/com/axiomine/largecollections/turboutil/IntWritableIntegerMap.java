...
public class IntWritableIntegerMap extends LargeCollection implements   Map<IntWritable,Integer>, Serializable{
    ...
    public IntWritableIntegerMap() {
        super();
    }
    
    public IntWritableIntegerMap(String dbName) {
        super(dbName);
    }
    
    public IntWritableIntegerMap(String dbPath, String dbName) {
        super(dbPath, dbName);
    }
    
    public IntWritableIntegerMap(String dbPath, String dbName, int cacheSize) {
    ...
    public void optimize() {
        try {
            ...
            for (Entry<IntWritable, Integer> entry : this.entrySet()) {
    ...
    @Override
    public Integer put(IntWritable key, Integer value) {
        if (key == null)
            return null;
    ...
    @Override
    public void putAll(Map<? extends IntWritable, ? extends Integer> m) {
        try {
            WriteBatch batch = db.createWriteBatch();
            int counter = 0;
            for (Map.Entry<? extends IntWritable, ? extends Integer> e : m
                    .entrySet()) {
    ...
    @Override
    public Set<java.util.Map.Entry<IntWritable, Integer>> entrySet() {
        return new MapEntrySet<IntWritable, Integer>(this, this.keyDeSerFunc,
                this.valDeSerFunc);
    }
