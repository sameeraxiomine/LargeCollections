...
public class CharacterFloatWritableMap extends LargeCollection implements   Map<Character,FloatWritable>, Serializable{
    ...
    public CharacterFloatWritableMap() {
        super();
    }
    
    public CharacterFloatWritableMap(String dbName) {
        super(dbName);
    }
    
    public CharacterFloatWritableMap(String dbPath, String dbName) {
        super(dbPath, dbName);
    }
    
    public CharacterFloatWritableMap(String dbPath, String dbName, int cacheSize) {
    ...
    public void optimize() {
        try {
            ...
            for (Entry<Character, FloatWritable> entry : this.entrySet()) {
    ...
    @Override
    public FloatWritable put(Character key, FloatWritable value) {
        if (key == null)
            return null;
    ...
    @Override
    public void putAll(Map<? extends Character, ? extends FloatWritable> m) {
        try {
            WriteBatch batch = db.createWriteBatch();
            int counter = 0;
            for (Map.Entry<? extends Character, ? extends FloatWritable> e : m
                    .entrySet()) {
    ...
    @Override
    public Set<java.util.Map.Entry<Character, FloatWritable>> entrySet() {
        return new MapEntrySet<Character, FloatWritable>(this, this.keyDeSerFunc,
                this.valDeSerFunc);
    }
