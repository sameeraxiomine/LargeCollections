...
public class BytesArrayBytesArrayMap extends LargeCollection implements   Map<byte[],byte[]>, Serializable{
    ...
    public BytesArrayBytesArrayMap() {
        super();
    }
    
    public BytesArrayBytesArrayMap(String dbName) {
        super(dbName);
    }
    
    public BytesArrayBytesArrayMap(String dbPath, String dbName) {
        super(dbPath, dbName);
    }
    
    public BytesArrayBytesArrayMap(String dbPath, String dbName, int cacheSize) {
