...
public class ByteLongMap extends LargeCollection implements   Map<Byte,Long>, Serializable{
    ...
    public ByteLongMap(String dbName) {
        super(dbName);
    }
    
    public ByteLongMap(String dbPath, String dbName) {
        super(dbPath, dbName);
    }
    
    public ByteLongMap(String dbPath, String dbName, int cacheSize) {
