...
public class DoubleBytesWritableMap extends LargeCollection implements   Map<Double,BytesWritable>, Serializable{
    ...
    public DoubleBytesWritableMap() {
        super();
    }
    
    public DoubleBytesWritableMap(String dbName) {
        super(dbName);
    }
    
    public DoubleBytesWritableMap(String dbPath, String dbName) {
        super(dbPath, dbName);
    }
    
    public DoubleBytesWritableMap(String dbPath, String dbName, int cacheSize) {
    ...
    public void optimize() {
        try {
            ...
            for (Entry<Double, BytesWritable> entry : this.entrySet()) {
    ...
    @Override
    public BytesWritable put(Double key, BytesWritable value) {
        if (key == null)
            return null;
    ...
    @Override
    public void putAll(Map<? extends Double, ? extends BytesWritable> m) {
        try {
            WriteBatch batch = db.createWriteBatch();
            int counter = 0;
            for (Map.Entry<? extends Double, ? extends BytesWritable> e : m
                    .entrySet()) {
    ...
    @Override
    public Set<java.util.Map.Entry<Double, BytesWritable>> entrySet() {
        return new MapEntrySet<Double, BytesWritable>(this, this.keyDeSerFunc,
                this.valDeSerFunc);
    }
