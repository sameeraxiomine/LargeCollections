...
public class TextLongWritableMap extends LargeCollection implements   Map<Text,LongWritable>, Serializable{
    ...
    public TextLongWritableMap() {
        super();
    }
    
    public TextLongWritableMap(String dbName) {
        super(dbName);
    }
    
    public TextLongWritableMap(String dbPath, String dbName) {
        super(dbPath, dbName);
    }
    
    public TextLongWritableMap(String dbPath, String dbName, int cacheSize) {
    ...
    public void optimize() {
        try {
            ...
            for (Entry<Text, LongWritable> entry : this.entrySet()) {
    ...
    @Override
    public LongWritable put(Text key, LongWritable value) {
        if (key == null)
            return null;
    ...
    @Override
    public void putAll(Map<? extends Text, ? extends LongWritable> m) {
        try {
            WriteBatch batch = db.createWriteBatch();
            int counter = 0;
            for (Map.Entry<? extends Text, ? extends LongWritable> e : m
                    .entrySet()) {
    ...
    @Override
    public Set<java.util.Map.Entry<Text, LongWritable>> entrySet() {
        return new MapEntrySet<Text, LongWritable>(this, this.keyDeSerFunc,
                this.valDeSerFunc);
    }
