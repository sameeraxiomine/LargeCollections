...
public class IntegerShortWritableMap extends LargeCollection implements   Map<Integer,ShortWritable>, Serializable{
    ...
    public IntegerShortWritableMap() {
        super();
    }
    
    public IntegerShortWritableMap(String dbName) {
        super(dbName);
    }
    
    public IntegerShortWritableMap(String dbPath, String dbName) {
        super(dbPath, dbName);
    }
    
    public IntegerShortWritableMap(String dbPath, String dbName, int cacheSize) {
    ...
    @Override
    public ShortWritable put(Integer key, ShortWritable value) {
        if (key == null)
            return null;
    ...
    @Override
    public void putAll(Map<? extends Integer, ? extends ShortWritable> m) {
        try {
            WriteBatch batch = db.createWriteBatch();
            int counter = 0;
            for (Map.Entry<? extends Integer, ? extends ShortWritable> e : m
                    .entrySet()) {
    ...
    @Override
    public Set<java.util.Map.Entry<Integer, ShortWritable>> entrySet() {
        return new MapEntrySet<Integer, ShortWritable>(this, this.keyDeSerFunc,
                this.valDeSerFunc);
    }
