...
public class IntWritableBytesArrayMap extends LargeCollection implements   Map<IntWritable,byte[]>, Serializable{
    ...
    public IntWritableBytesArrayMap() {
        super();
    }
    
    public IntWritableBytesArrayMap(String dbName) {
        super(dbName);
    }
    
    public IntWritableBytesArrayMap(String dbPath, String dbName) {
        super(dbPath, dbName);
    }
    
    public IntWritableBytesArrayMap(String dbPath, String dbName, int cacheSize) {
    ...
    public void optimize() {
        try {
            ...
            for (Entry<IntWritable, byte[]> entry : this.entrySet()) {
    ...
    @Override
    public byte[] put(IntWritable key, byte[] value) {
        if (key == null)
            return null;
    ...
    @Override
    public void putAll(Map<? extends IntWritable, ? extends byte[]> m) {
        try {
            WriteBatch batch = db.createWriteBatch();
            int counter = 0;
            for (Map.Entry<? extends IntWritable, ? extends byte[]> e : m
                    .entrySet()) {
    ...
    @Override
    public Set<java.util.Map.Entry<IntWritable, byte[]>> entrySet() {
        return new MapEntrySet<IntWritable, byte[]>(this, this.keyDeSerFunc,
                this.valDeSerFunc);
    }
