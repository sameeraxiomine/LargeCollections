...
public class IntegerByteWritableMap extends LargeCollection implements   Map<Integer,ByteWritable>, Serializable{
    ...
    public IntegerByteWritableMap() {
        super();
    }
    
    public IntegerByteWritableMap(String dbName) {
        super(dbName);
    }
    
    public IntegerByteWritableMap(String dbPath, String dbName) {
        super(dbPath, dbName);
    }
    
    public IntegerByteWritableMap(String dbPath, String dbName, int cacheSize) {
    ...
    public void optimize() {
        try {
            ...
            for (Entry<Integer, ByteWritable> entry : this.entrySet()) {
    ...
    @Override
    public ByteWritable put(Integer key, ByteWritable value) {
        if (key == null)
            return null;
    ...
    @Override
    public void putAll(Map<? extends Integer, ? extends ByteWritable> m) {
        try {
            WriteBatch batch = db.createWriteBatch();
            int counter = 0;
            for (Map.Entry<? extends Integer, ? extends ByteWritable> e : m
                    .entrySet()) {
    ...
    @Override
    public Set<java.util.Map.Entry<Integer, ByteWritable>> entrySet() {
        return new MapEntrySet<Integer, ByteWritable>(this, this.keyDeSerFunc,
                this.valDeSerFunc);
    }
