...
public class LongWritableStringMap extends LargeCollection implements   Map<LongWritable,String>, Serializable{
    ...
    public LongWritableStringMap() {
        super();
    }
    
    public LongWritableStringMap(String dbName) {
        super(dbName);
    }
    
    public LongWritableStringMap(String dbPath, String dbName) {
        super(dbPath, dbName);
    }
    
    public LongWritableStringMap(String dbPath, String dbName, int cacheSize) {
    ...
    public void optimize() {
        try {
            ...
            for (Entry<LongWritable, String> entry : this.entrySet()) {
    ...
    @Override
    public String put(LongWritable key, String value) {
        if (key == null)
            return null;
    ...
    @Override
    public void putAll(Map<? extends LongWritable, ? extends String> m) {
        try {
            WriteBatch batch = db.createWriteBatch();
            int counter = 0;
            for (Map.Entry<? extends LongWritable, ? extends String> e : m
                    .entrySet()) {
    ...
    @Override
    public Set<java.util.Map.Entry<LongWritable, String>> entrySet() {
        return new MapEntrySet<LongWritable, String>(this, this.keyDeSerFunc,
                this.valDeSerFunc);
    }
