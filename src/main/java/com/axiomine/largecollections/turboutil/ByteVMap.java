...
public class ByteVMap<V> extends LargeCollection implements   Map<Byte,V>, Serializable{
    ...
    public ByteVMap(String dbName) {
        super(dbName);
    }
    
    public ByteVMap(String dbPath, String dbName) {
        super(dbPath, dbName);
    }
    
    public ByteVMap(String dbPath, String dbName, int cacheSize) {
