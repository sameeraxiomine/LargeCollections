...
public class IntWritableBooleanWritableMap extends LargeCollection implements   Map<IntWritable,BooleanWritable>, Serializable{
    ...
    public IntWritableBooleanWritableMap() {
        super();
    }
    
    public IntWritableBooleanWritableMap(String dbName) {
        super(dbName);
    }
    
    public IntWritableBooleanWritableMap(String dbPath, String dbName) {
        super(dbPath, dbName);
    }
    
    public IntWritableBooleanWritableMap(String dbPath, String dbName, int cacheSize) {
    ...
    public void optimize() {
        try {
            ...
            for (Entry<IntWritable, BooleanWritable> entry : this.entrySet()) {
    ...
    @Override
    public BooleanWritable put(IntWritable key, BooleanWritable value) {
        if (key == null)
            return null;
    ...
    @Override
    public void putAll(Map<? extends IntWritable, ? extends BooleanWritable> m) {
        try {
            WriteBatch batch = db.createWriteBatch();
            int counter = 0;
            for (Map.Entry<? extends IntWritable, ? extends BooleanWritable> e : m
                    .entrySet()) {
    ...
    @Override
    public Set<java.util.Map.Entry<IntWritable, BooleanWritable>> entrySet() {
        return new MapEntrySet<IntWritable, BooleanWritable>(this, this.keyDeSerFunc,
                this.valDeSerFunc);
    }
