...
public class IntegerKryoVMap<V> extends LargeCollection implements   Map<Integer,V>, Serializable{
    ...
    public IntegerKryoVMap() {
        super();
    }
    
    public IntegerKryoVMap(String dbName) {
        super(dbName);
    }
    
    public IntegerKryoVMap(String dbPath, String dbName) {
        super(dbPath, dbName);
    }
    
    public IntegerKryoVMap(String dbPath, String dbName, int cacheSize) {
    ...
    public void putAll(Map<? extends Integer, ? extends V> m) {
        try {
            ...
            int counter = 0;
            for (Map.Entry<? extends Integer, ? extends V> e : m
                    .entrySet()) {
    ...
    public Set<java.util.Map.Entry<Integer, V>> entrySet() {
        return new MapEntrySet<Integer, V>(this, this.keyDeSerFunc,
                this.valDeSerFunc);
    }
