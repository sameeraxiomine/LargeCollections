...
public class BytesWritableBytesArrayMap extends LargeCollection implements   Map<BytesWritable,byte[]>, Serializable{
    ...
    public BytesWritableBytesArrayMap() {
        super();
    }
    
    public BytesWritableBytesArrayMap(String dbName) {
        super(dbName);
    }
    
    public BytesWritableBytesArrayMap(String dbPath, String dbName) {
        super(dbPath, dbName);
    }
    
    public BytesWritableBytesArrayMap(String dbPath, String dbName, int cacheSize) {
