...
public class ByteWritableTextMap extends LargeCollection implements   Map<ByteWritable,Text>, Serializable{
    ...
    public ByteWritableTextMap() {
        super();
    }
    
    public ByteWritableTextMap(String dbName) {
        super(dbName);
    }
    
    public ByteWritableTextMap(String dbPath, String dbName) {
        super(dbPath, dbName);
    }
    
    public ByteWritableTextMap(String dbPath, String dbName, int cacheSize) {
    ...
    public void optimize() {
        try {
            ...
            for (Entry<ByteWritable, Text> entry : this.entrySet()) {
    ...
    @Override
    public Text put(ByteWritable key, Text value) {
        if (key == null)
            return null;
    ...
    @Override
    public void putAll(Map<? extends ByteWritable, ? extends Text> m) {
        try {
            WriteBatch batch = db.createWriteBatch();
            int counter = 0;
            for (Map.Entry<? extends ByteWritable, ? extends Text> e : m
                    .entrySet()) {
    ...
    @Override
    public Set<java.util.Map.Entry<ByteWritable, Text>> entrySet() {
        return new MapEntrySet<ByteWritable, Text>(this, this.keyDeSerFunc,
                this.valDeSerFunc);
    }
