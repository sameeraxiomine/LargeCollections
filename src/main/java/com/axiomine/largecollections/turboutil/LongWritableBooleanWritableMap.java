...
public class LongWritableBooleanWritableMap extends LargeCollection implements   Map<LongWritable,BooleanWritable>, Serializable{
    ...
    public LongWritableBooleanWritableMap() {
        super();
    }
    
    public LongWritableBooleanWritableMap(String dbName) {
        super(dbName);
    }
    
    public LongWritableBooleanWritableMap(String dbPath, String dbName) {
        super(dbPath, dbName);
    }
    
    public LongWritableBooleanWritableMap(String dbPath, String dbName, int cacheSize) {
    ...
    public void optimize() {
        try {
            ...
            for (Entry<LongWritable, BooleanWritable> entry : this.entrySet()) {
    ...
    @Override
    public BooleanWritable put(LongWritable key, BooleanWritable value) {
        if (key == null)
            return null;
    ...
    @Override
    public void putAll(Map<? extends LongWritable, ? extends BooleanWritable> m) {
        try {
            WriteBatch batch = db.createWriteBatch();
            int counter = 0;
            for (Map.Entry<? extends LongWritable, ? extends BooleanWritable> e : m
                    .entrySet()) {
    ...
    @Override
    public Set<java.util.Map.Entry<LongWritable, BooleanWritable>> entrySet() {
        return new MapEntrySet<LongWritable, BooleanWritable>(this, this.keyDeSerFunc,
                this.valDeSerFunc);
    }
