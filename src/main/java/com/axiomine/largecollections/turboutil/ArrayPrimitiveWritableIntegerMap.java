...
public class ArrayPrimitiveWritableIntegerMap extends LargeCollection implements   Map<ArrayPrimitiveWritable,Integer>, Serializable{
    ...
    public ArrayPrimitiveWritableIntegerMap() {
        super();
    }
    
    public ArrayPrimitiveWritableIntegerMap(String dbName) {
        super(dbName);
    }
    
    public ArrayPrimitiveWritableIntegerMap(String dbPath, String dbName) {
        super(dbPath, dbName);
    }
    
    public ArrayPrimitiveWritableIntegerMap(String dbPath, String dbName, int cacheSize) {
    ...
    public void optimize() {
        try {
            ...
            for (Entry<ArrayPrimitiveWritable, Integer> entry : this.entrySet()) {
    ...
    @Override
    public Integer put(ArrayPrimitiveWritable key, Integer value) {
        if (key == null)
            return null;
    ...
    @Override
    public void putAll(Map<? extends ArrayPrimitiveWritable, ? extends Integer> m) {
        try {
            WriteBatch batch = db.createWriteBatch();
            int counter = 0;
            for (Map.Entry<? extends ArrayPrimitiveWritable, ? extends Integer> e : m
                    .entrySet()) {
    ...
    @Override
    public Set<java.util.Map.Entry<ArrayPrimitiveWritable, Integer>> entrySet() {
        return new MapEntrySet<ArrayPrimitiveWritable, Integer>(this, this.keyDeSerFunc,
                this.valDeSerFunc);
    }
