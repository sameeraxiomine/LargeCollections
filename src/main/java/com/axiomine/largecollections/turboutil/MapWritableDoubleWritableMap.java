...
public class MapWritableDoubleWritableMap extends LargeCollection implements   Map<MapWritable,DoubleWritable>, Serializable{
    ...
    public MapWritableDoubleWritableMap() {
        super();
    }
    
    public MapWritableDoubleWritableMap(String dbName) {
        super(dbName);
    }
    
    public MapWritableDoubleWritableMap(String dbPath, String dbName) {
        super(dbPath, dbName);
    }
    
    public MapWritableDoubleWritableMap(String dbPath, String dbName, int cacheSize) {
    ...
    public void optimize() {
        try {
            ...
            for (Entry<MapWritable, DoubleWritable> entry : this.entrySet()) {
    ...
    @Override
    public DoubleWritable put(MapWritable key, DoubleWritable value) {
        if (key == null)
            return null;
    ...
    @Override
    public void putAll(Map<? extends MapWritable, ? extends DoubleWritable> m) {
        try {
            WriteBatch batch = db.createWriteBatch();
            int counter = 0;
            for (Map.Entry<? extends MapWritable, ? extends DoubleWritable> e : m
                    .entrySet()) {
    ...
    @Override
    public Set<java.util.Map.Entry<MapWritable, DoubleWritable>> entrySet() {
        return new MapEntrySet<MapWritable, DoubleWritable>(this, this.keyDeSerFunc,
                this.valDeSerFunc);
    }
