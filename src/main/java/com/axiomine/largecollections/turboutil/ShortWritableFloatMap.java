...
public class ShortWritableFloatMap extends LargeCollection implements   Map<ShortWritable,Float>, Serializable{
    ...
    public ShortWritableFloatMap() {
        super();
    }
    
    public ShortWritableFloatMap(String dbName) {
        super(dbName);
    }
    
    public ShortWritableFloatMap(String dbPath, String dbName) {
        super(dbPath, dbName);
    }
    
    public ShortWritableFloatMap(String dbPath, String dbName, int cacheSize) {
    ...
    @Override
    public Float put(ShortWritable key, Float value) {
        if (key == null)
            return null;
    ...
    @Override
    public void putAll(Map<? extends ShortWritable, ? extends Float> m) {
        try {
            WriteBatch batch = db.createWriteBatch();
            int counter = 0;
            for (Map.Entry<? extends ShortWritable, ? extends Float> e : m
                    .entrySet()) {
    ...
    @Override
    public Set<java.util.Map.Entry<ShortWritable, Float>> entrySet() {
        return new MapEntrySet<ShortWritable, Float>(this, this.keyDeSerFunc,
                this.valDeSerFunc);
    }
