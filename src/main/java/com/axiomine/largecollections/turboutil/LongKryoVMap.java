...
public class LongKryoVMap<V> extends LargeCollection implements   Map<Long,V>, Serializable{
    ...
    public LongKryoVMap(String dbName) {
        super(dbName);
    }
    
    public LongKryoVMap(String dbPath, String dbName) {
        super(dbPath, dbName);
    }
    
    public LongKryoVMap(String dbPath, String dbName, int cacheSize) {
