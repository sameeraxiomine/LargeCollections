...
public class ShortWritableStringMap extends LargeCollection implements   Map<ShortWritable,String>, Serializable{
    ...
    public ShortWritableStringMap() {
        super();
    }
    
    public ShortWritableStringMap(String dbName) {
        super(dbName);
    }
    
    public ShortWritableStringMap(String dbPath, String dbName) {
        super(dbPath, dbName);
    }
    
    public ShortWritableStringMap(String dbPath, String dbName, int cacheSize) {
    ...
    public void optimize() {
        try {
            ...
            for (Entry<ShortWritable, String> entry : this.entrySet()) {
    ...
    @Override
    public String put(ShortWritable key, String value) {
        if (key == null)
            return null;
    ...
    @Override
    public void putAll(Map<? extends ShortWritable, ? extends String> m) {
        try {
            WriteBatch batch = db.createWriteBatch();
            int counter = 0;
            for (Map.Entry<? extends ShortWritable, ? extends String> e : m
                    .entrySet()) {
    ...
    @Override
    public Set<java.util.Map.Entry<ShortWritable, String>> entrySet() {
        return new MapEntrySet<ShortWritable, String>(this, this.keyDeSerFunc,
                this.valDeSerFunc);
    }
