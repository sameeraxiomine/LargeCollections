...
public class IntegerFloatWritableMap extends LargeCollection implements   Map<Integer,FloatWritable>, Serializable{
    ...
    public IntegerFloatWritableMap(String dbName) {
        super(dbName);
    }
    
    public IntegerFloatWritableMap(String dbPath, String dbName) {
        super(dbPath, dbName);
    }
    
    public IntegerFloatWritableMap(String dbPath, String dbName, int cacheSize) {
    ...
    public void optimize() {
        try {
            ...
            for (Entry<Integer, FloatWritable> entry : this.entrySet()) {
    ...
    @Override
    public FloatWritable put(Integer key, FloatWritable value) {
        if (key == null)
            return null;
    ...
    @Override
    public void putAll(Map<? extends Integer, ? extends FloatWritable> m) {
        try {
            WriteBatch batch = db.createWriteBatch();
            int counter = 0;
            for (Map.Entry<? extends Integer, ? extends FloatWritable> e : m
                    .entrySet()) {
    ...
    @Override
    public Set<java.util.Map.Entry<Integer, FloatWritable>> entrySet() {
        return new MapEntrySet<Integer, FloatWritable>(this, this.keyDeSerFunc,
                this.valDeSerFunc);
    }
