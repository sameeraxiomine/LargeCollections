...
public class StringMapWritableMap extends LargeCollection implements   Map<String,MapWritable>, Serializable{
    ...
    public StringMapWritableMap() {
        super();
    }
    
    public StringMapWritableMap(String dbName) {
        super(dbName);
    }
    
    public StringMapWritableMap(String dbPath, String dbName) {
        super(dbPath, dbName);
    }
    
    public StringMapWritableMap(String dbPath, String dbName, int cacheSize) {
    ...
    public void optimize() {
        try {
            ...
            for (Entry<String, MapWritable> entry : this.entrySet()) {
    ...
    @Override
    public MapWritable put(String key, MapWritable value) {
        if (key == null)
            return null;
    ...
    @Override
    public void putAll(Map<? extends String, ? extends MapWritable> m) {
        try {
            WriteBatch batch = db.createWriteBatch();
            int counter = 0;
            for (Map.Entry<? extends String, ? extends MapWritable> e : m
                    .entrySet()) {
    ...
    @Override
    public Set<java.util.Map.Entry<String, MapWritable>> entrySet() {
        return new MapEntrySet<String, MapWritable>(this, this.keyDeSerFunc,
                this.valDeSerFunc);
    }
