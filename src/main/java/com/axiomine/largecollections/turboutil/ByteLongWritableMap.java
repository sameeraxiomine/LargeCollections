...
public class ByteLongWritableMap extends LargeCollection implements   Map<Byte,LongWritable>, Serializable{
    ...
    public ByteLongWritableMap() {
        super();
    }
    
    public ByteLongWritableMap(String dbName) {
        super(dbName);
    }
    
    public ByteLongWritableMap(String dbPath, String dbName) {
        super(dbPath, dbName);
    }
    
    public ByteLongWritableMap(String dbPath, String dbName, int cacheSize) {
