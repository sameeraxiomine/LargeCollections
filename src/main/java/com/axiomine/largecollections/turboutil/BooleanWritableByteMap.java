...
public class BooleanWritableByteMap extends LargeCollection implements   Map<BooleanWritable,Byte>, Serializable{
    ...
    public BooleanWritableByteMap() {
        super();
    }
    
    public BooleanWritableByteMap(String dbName) {
        super(dbName);
    }
    
    public BooleanWritableByteMap(String dbPath, String dbName) {
        super(dbPath, dbName);
    }
    
    public BooleanWritableByteMap(String dbPath, String dbName, int cacheSize) {
