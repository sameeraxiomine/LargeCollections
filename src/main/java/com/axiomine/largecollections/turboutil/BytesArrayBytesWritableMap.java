...
public class BytesArrayBytesWritableMap extends LargeCollection implements   Map<byte[],BytesWritable>, Serializable{
    ...
    public BytesArrayBytesWritableMap() {
        super();
    }
    
    public BytesArrayBytesWritableMap(String dbName) {
        super(dbName);
    }
    
    public BytesArrayBytesWritableMap(String dbPath, String dbName) {
        super(dbPath, dbName);
    }
    
    public BytesArrayBytesWritableMap(String dbPath, String dbName, int cacheSize) {
