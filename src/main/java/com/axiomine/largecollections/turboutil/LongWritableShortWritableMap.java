...
public class LongWritableShortWritableMap extends LargeCollection implements   Map<LongWritable,ShortWritable>, Serializable{
    ...
    public LongWritableShortWritableMap() {
        super();
    }
    
    public LongWritableShortWritableMap(String dbName) {
        super(dbName);
    }
    
    public LongWritableShortWritableMap(String dbPath, String dbName) {
        super(dbPath, dbName);
    }
    
    public LongWritableShortWritableMap(String dbPath, String dbName, int cacheSize) {
    ...
    public void optimize() {
        try {
            ...
            for (Entry<LongWritable, ShortWritable> entry : this.entrySet()) {
    ...
    @Override
    public ShortWritable put(LongWritable key, ShortWritable value) {
        if (key == null)
            return null;
    ...
    @Override
    public void putAll(Map<? extends LongWritable, ? extends ShortWritable> m) {
        try {
            WriteBatch batch = db.createWriteBatch();
            int counter = 0;
            for (Map.Entry<? extends LongWritable, ? extends ShortWritable> e : m
                    .entrySet()) {
    ...
    @Override
    public Set<java.util.Map.Entry<LongWritable, ShortWritable>> entrySet() {
        return new MapEntrySet<LongWritable, ShortWritable>(this, this.keyDeSerFunc,
                this.valDeSerFunc);
    }
