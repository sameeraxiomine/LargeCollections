...
public class IntWritableBytesWritableMap extends LargeCollection implements   Map<IntWritable,BytesWritable>, Serializable{
    ...
    public IntWritableBytesWritableMap() {
        super();
    }
    
    public IntWritableBytesWritableMap(String dbName) {
        super(dbName);
    }
    
    public IntWritableBytesWritableMap(String dbPath, String dbName) {
        super(dbPath, dbName);
    }
    
    public IntWritableBytesWritableMap(String dbPath, String dbName, int cacheSize) {
    ...
    public void optimize() {
        try {
            ...
            for (Entry<IntWritable, BytesWritable> entry : this.entrySet()) {
    ...
    @Override
    public BytesWritable put(IntWritable key, BytesWritable value) {
        if (key == null)
            return null;
    ...
    @Override
    public void putAll(Map<? extends IntWritable, ? extends BytesWritable> m) {
        try {
            WriteBatch batch = db.createWriteBatch();
            int counter = 0;
            for (Map.Entry<? extends IntWritable, ? extends BytesWritable> e : m
                    .entrySet()) {
    ...
    @Override
    public Set<java.util.Map.Entry<IntWritable, BytesWritable>> entrySet() {
        return new MapEntrySet<IntWritable, BytesWritable>(this, this.keyDeSerFunc,
                this.valDeSerFunc);
    }
