...
public class TextStringMap extends LargeCollection implements   Map<Text,String>, Serializable{
    ...
    public TextStringMap() {
        super();
    }
    
    public TextStringMap(String dbName) {
        super(dbName);
    }
    
    public TextStringMap(String dbPath, String dbName) {
        super(dbPath, dbName);
    }
    
    public TextStringMap(String dbPath, String dbName, int cacheSize) {
    ...
    public void optimize() {
        try {
            ...
            for (Entry<Text, String> entry : this.entrySet()) {
    ...
    @Override
    public String put(Text key, String value) {
        if (key == null)
            return null;
    ...
    @Override
    public void putAll(Map<? extends Text, ? extends String> m) {
        try {
            WriteBatch batch = db.createWriteBatch();
            int counter = 0;
            for (Map.Entry<? extends Text, ? extends String> e : m
                    .entrySet()) {
    ...
    @Override
    public Set<java.util.Map.Entry<Text, String>> entrySet() {
        return new MapEntrySet<Text, String>(this, this.keyDeSerFunc,
                this.valDeSerFunc);
    }
