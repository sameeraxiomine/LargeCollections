...
public class ArrayPrimitiveWritableLongMap extends LargeCollection implements   Map<ArrayPrimitiveWritable,Long>, Serializable{
    ...
    public ArrayPrimitiveWritableLongMap() {
        super();
    }
    
    public ArrayPrimitiveWritableLongMap(String dbName) {
        super(dbName);
    }
    
    public ArrayPrimitiveWritableLongMap(String dbPath, String dbName) {
        super(dbPath, dbName);
    }
    
    public ArrayPrimitiveWritableLongMap(String dbPath, String dbName, int cacheSize) {
    ...
    public void optimize() {
        try {
            ...
            for (Entry<ArrayPrimitiveWritable, Long> entry : this.entrySet()) {
    ...
    @Override
    public Long put(ArrayPrimitiveWritable key, Long value) {
        if (key == null)
            return null;
    ...
    @Override
    public void putAll(Map<? extends ArrayPrimitiveWritable, ? extends Long> m) {
        try {
            WriteBatch batch = db.createWriteBatch();
            int counter = 0;
            for (Map.Entry<? extends ArrayPrimitiveWritable, ? extends Long> e : m
                    .entrySet()) {
    ...
    @Override
    public Set<java.util.Map.Entry<ArrayPrimitiveWritable, Long>> entrySet() {
        return new MapEntrySet<ArrayPrimitiveWritable, Long>(this, this.keyDeSerFunc,
                this.valDeSerFunc);
    }
