...
public class DoubleWritableArrayPrimitiveWritableMap extends LargeCollection implements   Map<DoubleWritable,ArrayPrimitiveWritable>, Serializable{
    ...
    public DoubleWritableArrayPrimitiveWritableMap() {
        super();
    }
    
    public DoubleWritableArrayPrimitiveWritableMap(String dbName) {
        super(dbName);
    }
    
    public DoubleWritableArrayPrimitiveWritableMap(String dbPath, String dbName) {
        super(dbPath, dbName);
    }
    
    public DoubleWritableArrayPrimitiveWritableMap(String dbPath, String dbName, int cacheSize) {
    ...
    public void optimize() {
        try {
            ...
            for (Entry<DoubleWritable, ArrayPrimitiveWritable> entry : this.entrySet()) {
    ...
    @Override
    public ArrayPrimitiveWritable put(DoubleWritable key, ArrayPrimitiveWritable value) {
        if (key == null)
            return null;
    ...
    @Override
    public void putAll(Map<? extends DoubleWritable, ? extends ArrayPrimitiveWritable> m) {
        try {
            WriteBatch batch = db.createWriteBatch();
            int counter = 0;
            for (Map.Entry<? extends DoubleWritable, ? extends ArrayPrimitiveWritable> e : m
                    .entrySet()) {
    ...
    @Override
    public Set<java.util.Map.Entry<DoubleWritable, ArrayPrimitiveWritable>> entrySet() {
        return new MapEntrySet<DoubleWritable, ArrayPrimitiveWritable>(this, this.keyDeSerFunc,
                this.valDeSerFunc);
    }
