...
public class LongWritableFloatWritableMap extends LargeCollection implements   Map<LongWritable,FloatWritable>, Serializable{
    ...
    public LongWritableFloatWritableMap() {
        super();
    }
    
    public LongWritableFloatWritableMap(String dbName) {
        super(dbName);
    }
    
    public LongWritableFloatWritableMap(String dbPath, String dbName) {
        super(dbPath, dbName);
    }
    
    public LongWritableFloatWritableMap(String dbPath, String dbName, int cacheSize) {
    ...
    public void optimize() {
        try {
            ...
            for (Entry<LongWritable, FloatWritable> entry : this.entrySet()) {
    ...
    @Override
    public FloatWritable put(LongWritable key, FloatWritable value) {
        if (key == null)
            return null;
    ...
    @Override
    public void putAll(Map<? extends LongWritable, ? extends FloatWritable> m) {
        try {
            WriteBatch batch = db.createWriteBatch();
            int counter = 0;
            for (Map.Entry<? extends LongWritable, ? extends FloatWritable> e : m
                    .entrySet()) {
    ...
    @Override
    public Set<java.util.Map.Entry<LongWritable, FloatWritable>> entrySet() {
        return new MapEntrySet<LongWritable, FloatWritable>(this, this.keyDeSerFunc,
                this.valDeSerFunc);
    }
