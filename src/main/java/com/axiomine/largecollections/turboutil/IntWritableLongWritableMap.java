...
public class IntWritableLongWritableMap extends LargeCollection implements   Map<IntWritable,LongWritable>, Serializable{
    ...
    public IntWritableLongWritableMap() {
        super();
    }
    
    public IntWritableLongWritableMap(String dbName) {
        super(dbName);
    }
    
    public IntWritableLongWritableMap(String dbPath, String dbName) {
        super(dbPath, dbName);
    }
    
    public IntWritableLongWritableMap(String dbPath, String dbName, int cacheSize) {
    ...
    public void optimize() {
        try {
            ...
            for (Entry<IntWritable, LongWritable> entry : this.entrySet()) {
    ...
    @Override
    public LongWritable put(IntWritable key, LongWritable value) {
        if (key == null)
            return null;
    ...
    @Override
    public void putAll(Map<? extends IntWritable, ? extends LongWritable> m) {
        try {
            WriteBatch batch = db.createWriteBatch();
            int counter = 0;
            for (Map.Entry<? extends IntWritable, ? extends LongWritable> e : m
                    .entrySet()) {
    ...
    @Override
    public Set<java.util.Map.Entry<IntWritable, LongWritable>> entrySet() {
        return new MapEntrySet<IntWritable, LongWritable>(this, this.keyDeSerFunc,
                this.valDeSerFunc);
    }
