...
public class CharacterVMap<V> extends LargeCollection implements   Map<Character,V>, Serializable{
    ...
    public CharacterVMap() {
        super();
    }
    
    public CharacterVMap(String dbName) {
        super(dbName);
    }
    
    public CharacterVMap(String dbPath, String dbName) {
        super(dbPath, dbName);
    }
    
    public CharacterVMap(String dbPath, String dbName, int cacheSize) {
