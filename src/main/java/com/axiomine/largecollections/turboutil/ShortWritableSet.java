...
public class ShortWritableSet extends LargeCollection implements Set<ShortWritable>, Serializable {
    ...
    public ShortWritableSet() {
        super();
    }
    
    public ShortWritableSet(String dbName) {
        super(dbName);
    }
    
    public ShortWritableSet(String dbPath,String dbName) {
        super(dbPath, dbName);
    }
    
    public ShortWritableSet(String dbPath,String dbName,int cacheSize) {
        super(dbPath, dbName, cacheSize);
    }
    
    public ShortWritableSet(String dbPath,String dbName,int cacheSize,int bloomFilterSize) {
    ...
    public boolean contains(Object o) {
        if (o != null) {
            if(!this.bloomFilter.mightContain(o))
            {
                ...
                byte[] valBytes = null;
                if (o != null) {
                    ShortWritable t = (ShortWritable) o;
                    byte[] keyBytes = this.tSerFunc.apply((ShortWritable)o);
    ...
    public boolean remove(Object o) {
        ...
        if(this.contains(o)){
            byte[] fullKeyArr = this.tSerFunc.apply((ShortWritable)o);
    ...
    public boolean addAll(Collection<? extends ShortWritable> c) {
        boolean ret = false;
        for(Object o:c){
            boolean rem = this.add((ShortWritable)o);
            ret = rem || ret;
        }
        return ret;
    }
    ...
    public Iterator<ShortWritable> iterator() {
        ...
        return new MapKeyIterator<ShortWritable>(this,this.tDeSerFunc);
    }
