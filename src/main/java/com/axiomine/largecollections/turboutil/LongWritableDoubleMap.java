...
public class LongWritableDoubleMap extends LargeCollection implements   Map<LongWritable,Double>, Serializable{
    ...
    public LongWritableDoubleMap() {
        super();
    }
    
    public LongWritableDoubleMap(String dbName) {
        super(dbName);
    }
    
    public LongWritableDoubleMap(String dbPath, String dbName) {
        super(dbPath, dbName);
    }
    
    public LongWritableDoubleMap(String dbPath, String dbName, int cacheSize) {
    ...
    public void optimize() {
        try {
            ...
            for (Entry<LongWritable, Double> entry : this.entrySet()) {
    ...
    @Override
    public Double put(LongWritable key, Double value) {
        if (key == null)
            return null;
    ...
    @Override
    public void putAll(Map<? extends LongWritable, ? extends Double> m) {
        try {
            WriteBatch batch = db.createWriteBatch();
            int counter = 0;
            for (Map.Entry<? extends LongWritable, ? extends Double> e : m
                    .entrySet()) {
    ...
    @Override
    public Set<java.util.Map.Entry<LongWritable, Double>> entrySet() {
        return new MapEntrySet<LongWritable, Double>(this, this.keyDeSerFunc,
                this.valDeSerFunc);
    }
