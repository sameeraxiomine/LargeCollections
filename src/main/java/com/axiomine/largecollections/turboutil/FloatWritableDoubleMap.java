...
public class FloatWritableDoubleMap extends LargeCollection implements   Map<FloatWritable,Double>, Serializable{
    ...
    public FloatWritableDoubleMap() {
        super();
    }
    
    public FloatWritableDoubleMap(String dbName) {
        super(dbName);
    }
    
    public FloatWritableDoubleMap(String dbPath, String dbName) {
        super(dbPath, dbName);
    }
    
    public FloatWritableDoubleMap(String dbPath, String dbName, int cacheSize) {
    ...
    public void optimize() {
        try {
            ...
            for (Entry<FloatWritable, Double> entry : this.entrySet()) {
    ...
    @Override
    public Double put(FloatWritable key, Double value) {
        if (key == null)
            return null;
    ...
    @Override
    public void putAll(Map<? extends FloatWritable, ? extends Double> m) {
        try {
            WriteBatch batch = db.createWriteBatch();
            int counter = 0;
            for (Map.Entry<? extends FloatWritable, ? extends Double> e : m
                    .entrySet()) {
    ...
    @Override
    public Set<java.util.Map.Entry<FloatWritable, Double>> entrySet() {
        return new MapEntrySet<FloatWritable, Double>(this, this.keyDeSerFunc,
                this.valDeSerFunc);
    }
