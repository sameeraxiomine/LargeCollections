...
public class MapWritableBytesArrayMap extends LargeCollection implements   Map<MapWritable,byte[]>, Serializable{
    ...
    public MapWritableBytesArrayMap() {
        super();
    }
    
    public MapWritableBytesArrayMap(String dbName) {
        super(dbName);
    }
    
    public MapWritableBytesArrayMap(String dbPath, String dbName) {
        super(dbPath, dbName);
    }
    
    public MapWritableBytesArrayMap(String dbPath, String dbName, int cacheSize) {
    ...
    public void optimize() {
        try {
            ...
            for (Entry<MapWritable, byte[]> entry : this.entrySet()) {
    ...
    @Override
    public byte[] put(MapWritable key, byte[] value) {
        if (key == null)
            return null;
    ...
    @Override
    public void putAll(Map<? extends MapWritable, ? extends byte[]> m) {
        try {
            WriteBatch batch = db.createWriteBatch();
            int counter = 0;
            for (Map.Entry<? extends MapWritable, ? extends byte[]> e : m
                    .entrySet()) {
    ...
    @Override
    public Set<java.util.Map.Entry<MapWritable, byte[]>> entrySet() {
        return new MapEntrySet<MapWritable, byte[]>(this, this.keyDeSerFunc,
                this.valDeSerFunc);
    }
