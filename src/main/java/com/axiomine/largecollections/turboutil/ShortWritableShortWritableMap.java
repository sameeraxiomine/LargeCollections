...
public class ShortWritableShortWritableMap extends LargeCollection implements   Map<ShortWritable,ShortWritable>, Serializable{
    ...
    public ShortWritableShortWritableMap() {
        super();
    }
    
    public ShortWritableShortWritableMap(String dbName) {
        super(dbName);
    }
    
    public ShortWritableShortWritableMap(String dbPath, String dbName) {
        super(dbPath, dbName);
    }
    
    public ShortWritableShortWritableMap(String dbPath, String dbName, int cacheSize) {
    ...
    public void optimize() {
        try {
            ...
            for (Entry<ShortWritable, ShortWritable> entry : this.entrySet()) {
    ...
    @Override
    public ShortWritable put(ShortWritable key, ShortWritable value) {
        if (key == null)
            return null;
    ...
    @Override
    public void putAll(Map<? extends ShortWritable, ? extends ShortWritable> m) {
        try {
            WriteBatch batch = db.createWriteBatch();
            int counter = 0;
            for (Map.Entry<? extends ShortWritable, ? extends ShortWritable> e : m
                    .entrySet()) {
    ...
    @Override
    public Set<java.util.Map.Entry<ShortWritable, ShortWritable>> entrySet() {
        return new MapEntrySet<ShortWritable, ShortWritable>(this, this.keyDeSerFunc,
                this.valDeSerFunc);
    }
