...
public class MapWritableFloatWritableMap extends LargeCollection implements   Map<MapWritable,FloatWritable>, Serializable{
    ...
    public MapWritableFloatWritableMap() {
        super();
    }
    
    public MapWritableFloatWritableMap(String dbName) {
        super(dbName);
    }
    
    public MapWritableFloatWritableMap(String dbPath, String dbName) {
        super(dbPath, dbName);
    }
    
    public MapWritableFloatWritableMap(String dbPath, String dbName, int cacheSize) {
    ...
    public void optimize() {
        try {
            ...
            for (Entry<MapWritable, FloatWritable> entry : this.entrySet()) {
    ...
    @Override
    public FloatWritable put(MapWritable key, FloatWritable value) {
        if (key == null)
            return null;
    ...
    @Override
    public void putAll(Map<? extends MapWritable, ? extends FloatWritable> m) {
        try {
            WriteBatch batch = db.createWriteBatch();
            int counter = 0;
            for (Map.Entry<? extends MapWritable, ? extends FloatWritable> e : m
                    .entrySet()) {
    ...
    @Override
    public Set<java.util.Map.Entry<MapWritable, FloatWritable>> entrySet() {
        return new MapEntrySet<MapWritable, FloatWritable>(this, this.keyDeSerFunc,
                this.valDeSerFunc);
    }
