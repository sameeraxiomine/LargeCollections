...
public class LongWritableList extends LargeCollection implements List<LongWritable>, Serializable {
    ...
    public void optimize() {
        try {
            ...
            MapEntryIterator<Integer, LongWritable> iterator = new MapEntryIterator(this, new WritableSerDes.LongWritableDeSerFunction(),tDeSerFunc);
            while(iterator.hasNext()){
                Entry<Integer, LongWritable> entry = iterator.next();
