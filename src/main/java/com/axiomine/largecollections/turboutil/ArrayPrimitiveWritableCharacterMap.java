...
public class ArrayPrimitiveWritableCharacterMap extends LargeCollection implements   Map<ArrayPrimitiveWritable,Character>, Serializable{
    ...
    public ArrayPrimitiveWritableCharacterMap() {
        super();
    }
    
    public ArrayPrimitiveWritableCharacterMap(String dbName) {
        super(dbName);
    }
    
    public ArrayPrimitiveWritableCharacterMap(String dbPath, String dbName) {
        super(dbPath, dbName);
    }
    
    public ArrayPrimitiveWritableCharacterMap(String dbPath, String dbName, int cacheSize) {
    ...
    public void optimize() {
        try {
            ...
            for (Entry<ArrayPrimitiveWritable, Character> entry : this.entrySet()) {
    ...
    @Override
    public Character put(ArrayPrimitiveWritable key, Character value) {
        if (key == null)
            return null;
    ...
    @Override
    public void putAll(Map<? extends ArrayPrimitiveWritable, ? extends Character> m) {
        try {
            WriteBatch batch = db.createWriteBatch();
            int counter = 0;
            for (Map.Entry<? extends ArrayPrimitiveWritable, ? extends Character> e : m
                    .entrySet()) {
    ...
    @Override
    public Set<java.util.Map.Entry<ArrayPrimitiveWritable, Character>> entrySet() {
        return new MapEntrySet<ArrayPrimitiveWritable, Character>(this, this.keyDeSerFunc,
                this.valDeSerFunc);
    }
