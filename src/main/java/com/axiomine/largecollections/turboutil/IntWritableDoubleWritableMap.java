...
public class IntWritableDoubleWritableMap extends LargeCollection implements   Map<IntWritable,DoubleWritable>, Serializable{
    ...
    public IntWritableDoubleWritableMap() {
        super();
    }
    
    public IntWritableDoubleWritableMap(String dbName) {
        super(dbName);
    }
    
    public IntWritableDoubleWritableMap(String dbPath, String dbName) {
        super(dbPath, dbName);
    }
    
    public IntWritableDoubleWritableMap(String dbPath, String dbName, int cacheSize) {
    ...
    public void optimize() {
        try {
            ...
            for (Entry<IntWritable, DoubleWritable> entry : this.entrySet()) {
    ...
    public void putAll(Map<? extends IntWritable, ? extends DoubleWritable> m) {
        try {
            ...
            int counter = 0;
            for (Map.Entry<? extends IntWritable, ? extends DoubleWritable> e : m
                    .entrySet()) {
    ...
    public Set<java.util.Map.Entry<IntWritable, DoubleWritable>> entrySet() {
        return new MapEntrySet<IntWritable, DoubleWritable>(this, this.keyDeSerFunc,
                this.valDeSerFunc);
    }
