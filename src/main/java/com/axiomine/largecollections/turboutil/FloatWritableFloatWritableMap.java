...
public class FloatWritableFloatWritableMap extends LargeCollection implements   Map<FloatWritable,FloatWritable>, Serializable{
    ...
    public FloatWritableFloatWritableMap() {
        super();
    }
    
    public FloatWritableFloatWritableMap(String dbName) {
        super(dbName);
    }
    
    public FloatWritableFloatWritableMap(String dbPath, String dbName) {
        super(dbPath, dbName);
    }
    
    public FloatWritableFloatWritableMap(String dbPath, String dbName, int cacheSize) {
    ...
    public void optimize() {
        try {
            ...
            for (Entry<FloatWritable, FloatWritable> entry : this.entrySet()) {
    ...
    @Override
    public FloatWritable put(FloatWritable key, FloatWritable value) {
        if (key == null)
            return null;
    ...
    @Override
    public void putAll(Map<? extends FloatWritable, ? extends FloatWritable> m) {
        try {
            WriteBatch batch = db.createWriteBatch();
            int counter = 0;
            for (Map.Entry<? extends FloatWritable, ? extends FloatWritable> e : m
                    .entrySet()) {
    ...
    @Override
    public Set<java.util.Map.Entry<FloatWritable, FloatWritable>> entrySet() {
        return new MapEntrySet<FloatWritable, FloatWritable>(this, this.keyDeSerFunc,
                this.valDeSerFunc);
    }
