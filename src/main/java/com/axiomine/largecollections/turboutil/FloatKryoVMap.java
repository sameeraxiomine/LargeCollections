...
public class FloatKryoVMap<V> extends LargeCollection implements   Map<Float,V>, Serializable{
    ...
    public FloatKryoVMap() {
        super();
    }
    
    public FloatKryoVMap(String dbName) {
        super(dbName);
    }
    
    public FloatKryoVMap(String dbPath, String dbName) {
        super(dbPath, dbName);
    }
    
    public FloatKryoVMap(String dbPath, String dbName, int cacheSize) {
